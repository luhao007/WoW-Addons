-- $Id: Data.lua 42 2019-09-04 07:38:10Z arith $
--[[
...
db.AtlasMaps = {
	...
	AuchAuchenaiCrypts = {
		...
		{ WHIT.." 1) "..Atlas:GetBossName("Shirrak the Dead Watcher", 523), 523 },
		{ WHIT.." 2) "..Atlas:GetBossName("Exarch Maladaar", 524), 524 },
	...
	AuchManaTombs = {
		...
		{ WHIT.." 1) "..Atlas:GetBossName("Pandemonius", 534), 534 },
		{ ORNG..INDENT..L["Shadow Lord Xiraxis"]..ALC["L-Parenthesis"]..ALC["Summon"]..ALC["R-Parenthesis"] },
		{ WHIT.." 2) "..Atlas:GetBossName("Tavarok", 535), 535 },
		{ WHIT.." 3) "..Atlas:GetBossName("Nexus-Prince Shaffar", 537), 537 },
		{ ORNG..INDENT..Atlas:GetBossName("Yor", 536)..ALC["L-Parenthesis"]..ALC["Summon"]..ALC["Comma"]..ALC["Heroic"]..ALC["R-Parenthesis"], 536 },
	...
	AuchSethekkHalls = {
		...
		{ BLUE.." A) "..ALC["Entrance"], 10001 },
		{ GREN..INDENT..L["Isfar"] },
		{ WHIT.." 1) "..Atlas:GetBossName("Darkweaver Syth", 541), 541 },
		{ GREN..INDENT..L["Dealer Vijaad"] },
		{ GREN..INDENT..L["Lakka"] },
		{ WHIT.." 2) "..Atlas:GetBossName("Anzu", 542)..ALC["L-Parenthesis"]..ALC["Heroic"]..ALC["R-Parenthesis"], 542 },
		{ GREN..INDENT..L["The Saga of Terokk"] },
		{ WHIT.." 3) "..Atlas:GetBossName("Talon King Ikiss", 543), 543 },
	},
	AuchShadowLabyrinth = {
		...
		{ WHIT.." 1) "..Atlas:GetBossName("Ambassador Hellmaw", 544), 544 },
		{ WHIT.." 2) "..Atlas:GetBossName("Blackheart the Inciter", 545), 545 },
		{ WHIT.." 3) "..Atlas:GetBossName("Grandmaster Vorpil", 546), 546 },
		{ GREN..INDENT..L["The Codex of Blood"] },
		{ WHIT.." 4) "..Atlas:GetBossName("Murmur", 547), 547 },
	...
	BlackTempleStart = {
		...
		{ WHIT.." 1) "..Atlas:GetBossName("High Warlord Naj'entus", 1582), 1582 },
		{ WHIT.." 2) "..Atlas:GetBossName("Supremus", 1583), 1583 },
		{ WHIT.." 3) "..Atlas:GetBossName("Shade of Akama", 1584), 1584 },
	...
	BlackTempleBasement = {
		...
		{ WHIT.." 4) "..Atlas:GetBossName("Gurtogg Bloodboil", 1586), 1586 },
		{ WHIT.." 5) "..Atlas:GetBossName("Reliquary of Souls", 1587), 1587 },
		{ WHIT..INDENT..Atlas:GetBossName("Essence of Suffering", 1587, 1) },
		{ WHIT..INDENT..Atlas:GetBossName("Essence of Desire", 1587, 2) },
		{ WHIT..INDENT..Atlas:GetBossName("Essence of Anger", 1587, 3) },
		{ WHIT.." 6) "..Atlas:GetBossName("Teron Gorefiend", 1585), 1585 },
	},
	BlackTempleTop = {
		...
		{ WHIT.." 7) "..Atlas:GetBossName("Mother Shahraz", 1588), 1588 },
		{ WHIT.." 8) "..Atlas:GetBossName("The Illidari Council", 1589), 1589 },
		{ WHIT..INDENT..Atlas:GetBossName("Gathios the Shatterer", 1589, 1)..ALC["L-Parenthesis"]..Atlas_GetClassName("PALADIN")..ALC["R-Parenthesis"] },
		{ WHIT..INDENT..Atlas:GetBossName("High Nethermancer Zerevor", 1589, 2)..ALC["L-Parenthesis"]..Atlas_GetClassName("MAGE")..ALC["R-Parenthesis"] },
		{ WHIT..INDENT..Atlas:GetBossName("Lady Malande", 1589, 3)..ALC["L-Parenthesis"]..Atlas_GetClassName("PRIEST")..ALC["R-Parenthesis"] },
		{ WHIT..INDENT..Atlas:GetBossName("Veras Darkshadow", 1589, 4)..ALC["L-Parenthesis"]..Atlas_GetClassName("ROGUE")..ALC["R-Parenthesis"] },
		{ WHIT.." 9) "..Atlas:GetBossName("Illidan Stormrage", 1590), 1590 },
	},
	...
	CFRSerpentshrineCavern = {
		...
		{ WHIT.." 1) "..Atlas:GetBossName("Hydross the Unstable", 1567), 1567 },
		{ WHIT.." 2) "..Atlas:GetBossName("The Lurker Below", 1568), 1568 },
		{ WHIT.." 3) "..Atlas:GetBossName("Leotheras the Blind", 1569), 1569 },
		{ WHIT.." 4) "..Atlas:GetBossName("Fathom-Lord Karathress", 1570), 1570 },
		{ GREN..INDENT..L["Seer Olum"] },
		{ WHIT.." 5) "..Atlas:GetBossName("Morogrim Tidewalker", 1571), 1571 },
		{ WHIT.." 6) "..Atlas:GetBossName("Lady Vashj", 1572), 1572 },
	},
	CFRTheSlavePens = {
		...
		{ WHIT.." 1) "..Atlas:GetBossName("Mennu the Betrayer", 570), 570 },
		{ WHIT.." 2) "..Atlas:GetBossName("Rokmar the Crackler", 571), 571 },
		{ WHIT.." 3) "..Atlas:GetBossName("Quagmirran", 572), 572 },
		{ ORNG.." 1) "..Atlas:GetBossName("Ahune")..ALC["L-Parenthesis"]..ALC["Midsummer Festival"]..ALC["R-Parenthesis"], 10002 },
	...
	CFRTheSteamvault = {
		...
		{ WHIT.." 1) "..Atlas:GetBossName("Hydromancer Thespia", 573), 573 },
		{ GREN..INDENT..L["Main Chambers Access Panel"] },
		{ WHIT.." 2) "..Atlas:GetBossName("Mekgineer Steamrigger", 574), 574 },
		{ GREN..INDENT..L["Main Chambers Access Panel"] },
		{ WHIT.." 3) "..Atlas:GetBossName("Warlord Kalithresh", 575), 575 },
	...
	CFRTheUnderbog = {
		...
		{ GREN..INDENT..L["T'shu"] },
		{ GREN..INDENT..L["Watcher Jhang"] },
		{ WHIT.." 1) "..Atlas:GetBossName("Hungarfen", 576), 576 },
		{ GREN..INDENT..L["The Underspore"] },
		{ WHIT.." 2) "..Atlas:GetBossName("Ghaz'an", 577), 577 },
		{ WHIT.." 3) "..Atlas:GetBossName("Swamplord Musel'ek", 578), 578 },
		{ WHIT..INDENT..Atlas:GetBossName("Claw") },
		{ WHIT.." 4) "..Atlas:GetBossName("The Black Stalker", 579), 579 },
	...
	CoTBlackMorass = {
		...
		{ WHIT..INDENT..ALC["Wave 6"]..ALC["Colon"]..Atlas:GetBossName("Chrono Lord Deja", 552), 552 },
		{ WHIT..INDENT..ALC["Wave 12"]..ALC["Colon"]..Atlas:GetBossName("Temporus", 553), 553 },
		{ WHIT..INDENT..ALC["Wave 18"]..ALC["Colon"]..Atlas:GetBossName("Aeonus", 554), 554 },
		{ GREN.." 1') "..BZ["The Dark Portal"], 10003 },
		{ GREN..INDENT..Atlas:GetBossName("Medivh") },
	},
	CoTHyjalEnt = {
	...
	CoTHyjal = {
		...
		{ WHIT.." 1) "..Atlas:GetBossName("Rage Winterchill", 1577), 1577 },
		{ WHIT.." 2) "..Atlas:GetBossName("Anetheron", 1578), 1578 },
		{ WHIT.." 3) "..Atlas:GetBossName("Kaz'rogal", 1579), 1579 },
		{ WHIT.." 4) "..Atlas:GetBossName("Azgalor", 1580), 1580 },
		{ WHIT.." 5) "..Atlas:GetBossName("Archimonde", 1581), 1581 },
	},
	CoTOldHillsbrad = {
		...
		{ WHIT.." 1) "..Atlas:GetBossName("Lieutenant Drake", 538), 538 },
		{ GREN.." 1') "..L["Thrall"]..ALC["L-Parenthesis"]..ALC["Lower"]..ALC["R-Parenthesis"], 10005 },
		{ WHIT.." 2) "..Atlas:GetBossName("Captain Skarloc", 539), 539 },
		...
		{ WHIT.." 3) "..Atlas:GetBossName("Epoch Hunter", 540), 540 },
		...
		{ "" },
		{ ORNG..BZ["Southshore"] },
		{ GREN..INDENT..Atlas:GetBossName("Kel'Thuzad") },
		...
		{ GREN..INDENT..Atlas:GetBossName("Tirion Fordring") },
		{ GREN..INDENT..Atlas:GetBossName("Arcanist Doan") },
	...
	GruulsLair = {
		...
		{ WHIT..INDENT..Atlas:GetBossName("Kiggler the Crazed", 1564, 2)..ALC["L-Parenthesis"]..Atlas_GetClassName("SHAMAN")..ALC["R-Parenthesis"] },
		{ WHIT..INDENT..Atlas:GetBossName("Blindeye the Seer", 1564, 3)..ALC["L-Parenthesis"]..Atlas_GetClassName("PRIEST")..ALC["R-Parenthesis"] },
		{ WHIT..INDENT..Atlas:GetBossName("Olm the Summoner", 1564, 4)..ALC["L-Parenthesis"]..Atlas_GetClassName("WARLOCK")..ALC["R-Parenthesis"] },
		{ WHIT..INDENT..Atlas:GetBossName("Krosh Firehand", 1564, 5)..ALC["L-Parenthesis"]..Atlas_GetClassName("MAGE")..ALC["R-Parenthesis"] },
		{ WHIT.." 2) "..Atlas:GetBossName("Gruul the Dragonkiller", 1565), 1565 },
	},
	HellfireCitadelEnt = {
	...
	HCBloodFurnace = {
		...
		{ WHIT.." 1) "..Atlas:GetBossName("The Maker", 555), 555 },
		{ WHIT.." 2) "..Atlas:GetBossName("Broggok", 556), 556 },
		{ WHIT.." 3) "..Atlas:GetBossName("Keli'dan the Breaker", 557), 557 },
	},
	HCHellfireRamparts = {
		...
		{ WHIT.." 1) "..Atlas:GetBossName("Watchkeeper Gargolmar", 527), 527 },
		{ WHIT.." 2) "..Atlas:GetBossName("Omor the Unscarred", 528), 528 },
		{ WHIT.." 3) "..Atlas:GetBossName("Vazruden the Herald", 529), 529 },
		{ WHIT..INDENT..Atlas:GetBossName("Nazan") },
	...
	HCTheShatteredHalls = {
		...
		{ GREN..INDENT..L["Caza'rez"]..ALC["L-Parenthesis"]..FACTION_HORDE..ALC["R-Parenthesis"] },
		{ GREN..INDENT..L["Stone Guard Stok'ton"]..ALC["L-Parenthesis"]..FACTION_HORDE..ALC["R-Parenthesis"] },
		{ WHIT.." 1) "..Atlas:GetBossName("Grand Warlock Nethekurse", 566), 566 },
		{ WHIT.." 2) "..Atlas:GetBossName("Blood Guard Porung", 728)..ALC["L-Parenthesis"]..ALC["Heroic"]..ALC["R-Parenthesis"], 728 },
		{ WHIT.." 3) "..Atlas:GetBossName("Warbringer O'mrogg", 568), 568 },
		{ WHIT.." 4) "..Atlas:GetBossName("Warchief Kargath Bladefist", 569), 569 },
...
--    [799] = { mapFile = "Karazhan", [1] = 350, [2] = 351, [3] = 352, [4] = 353, [5] = 354, [6] = 355, [7] = 356, [8] = 357, [9] = 358, [10] = 359, [11] = 360, [12] = 361, [13] = 362, [14] = 363, [15] = 364, [16] = 365, [17] = 366},
	KarazhanStart = {
		...
		{ WHIT.." 1) "..Atlas:GetBossName("Attumen the Huntsman", 1553), 1553 },
		{ WHIT..INDENT..Atlas:GetBossName("Midnight", 1553, 2) },
		{ WHIT.." 2) "..Atlas:GetBossName("Moroes", 1554), 1554 },
		...
		{ WHIT.." 3) "..Atlas:GetBossName("Maiden of Virtue", 1555), 1555 },
		{ WHIT.." 4) "..Atlas:GetBossName("Opera Hall", 1556), 1556 },
		{ ORNG..INDENT..L["Red Riding Hood"]..ALC["L-Parenthesis"]..ALC["Random"]..ALC["R-Parenthesis"] },
		{ WHIT..INDENT..INDENT..Atlas:GetBossName("The Big Bad Wolf") },
		{ ORNG..INDENT..L["Wizard of Oz"]..ALC["L-Parenthesis"]..ALC["Random"]..ALC["R-Parenthesis"] },
		{ WHIT..INDENT..INDENT..Atlas:GetBossName("Dorothee") },
		{ WHIT..INDENT..INDENT..Atlas:GetBossName("Tito") },
		{ WHIT..INDENT..INDENT..Atlas:GetBossName("Strawman") },
		{ WHIT..INDENT..INDENT..Atlas:GetBossName("Tinhead") },
		{ WHIT..INDENT..INDENT..Atlas:GetBossName("Roar") },
		{ WHIT..INDENT..INDENT..Atlas:GetBossName("The Crone", 1556, 4) },
		{ ORNG..INDENT..Atlas:GetBossName("Romulo & Julianne")..ALC["L-Parenthesis"]..ALC["Random"]..ALC["R-Parenthesis"] },
		{ WHIT..INDENT..INDENT..Atlas:GetBossName("Romulo", 1556, 2) },
		{ WHIT..INDENT..INDENT..Atlas:GetBossName("Julianne", 1556, 3) },
		{ WHIT.." 5 ) "..Atlas:GetBossName("Nightbane")..ALC["L-Parenthesis"]..ALC["Summon"]..ALC["R-Parenthesis"], 10018 },
		{ GREN..INDENT..L["The Master's Terrace"] },
		{ ORNG.." 1) "..Atlas:GetBossName("Servant Quarters", 1552), 1552 },
		{ ORNG..INDENT..Atlas:GetBossName("Rokad the Ravager", 1552, 1)..ALC["L-Parenthesis"]..ALC["Rare"]..ALC["Comma"]..ALC["Random"]..ALC["R-Parenthesis"] },
		{ ORNG..INDENT..Atlas:GetBossName("Shadikith the Glider", 1552, 2)..ALC["L-Parenthesis"]..ALC["Rare"]..ALC["Comma"]..ALC["Random"]..ALC["R-Parenthesis"] },
		{ ORNG..INDENT..Atlas:GetBossName("Hyakiss the Lurker", 1552, 3)..ALC["L-Parenthesis"]..ALC["Rare"]..ALC["Comma"]..ALC["Random"]..ALC["R-Parenthesis"] },
	...
	KarazhanEnd = {
		...
		{ BLUE.." K) "..L["Ramp to Guardian's Library"]..ALC["L-Parenthesis"]..Atlas:GetBossName("Shade of Aran")..ALC["R-Parenthesis"], 10003 },
		{ BLUE.." L) "..L["Mysterious Bookshelf"]..ALC["L-Parenthesis"]..Atlas:GetBossName("Terestian Illhoof")..ALC["R-Parenthesis"], 10004 },
		{ BLUE.." M) "..L["Ramp up to the Celestial Watch"]..ALC["L-Parenthesis"]..Atlas:GetBossName("Netherspite")..ALC["R-Parenthesis"], 10005 },
		{ BLUE..INDENT..L["Ramp down to the Gamesman's Hall"]..ALC["L-Parenthesis"]..Atlas:GetBossName("Chess Event", 1764)..ALC["R-Parenthesis"], 1764 },
		{ BLUE.." N) "..L["Ramp to Medivh's Chamber"], 10006 },
		{ BLUE.." O) "..L["Spiral Stairs to Netherspace"]..ALC["L-Parenthesis"]..Atlas:GetBossName("Prince Malchezaar")..ALC["R-Parenthesis"], 10007 },
		{ WHIT.." 7) "..Atlas:GetBossName("The Curator", 1557), 1557 },
		{ WHIT.." 8) "..Atlas:GetBossName("Terestian Illhoof", 1560), 1560 },
		{ WHIT..INDENT..Atlas:GetBossName("Kil'rek")..ALC["L-Parenthesis"]..ALC["Imp"]..ALC["R-Parenthesis"] },
		{ WHIT.." 9) "..Atlas:GetBossName("Shade of Aran", 1559), 1559 },
		{ WHIT.."10) "..Atlas:GetBossName("Netherspite", 1561), 1561 },
		{ WHIT.."11) "..Atlas:GetBossName("Chess Event", 1562), 1562 },
		{ GREN..INDENT..Atlas:GetBossName("Dust Covered Chest") },
		{ WHIT.."12) "..Atlas:GetBossName("Prince Malchezaar", 1563), 1563 },
	...
	MagistersTerrace = {
		...
		{ WHIT.." 1) "..Atlas:GetBossName("Selin Fireheart", 530), 530 },
		{ GREN..INDENT..L["Fel Crystals"] },
		{ WHIT.." 2) "..Atlas:GetBossName("Vexallus", 531), 531 },
		{ WHIT.." 3) "..Atlas:GetBossName("Priestess Delrissa", 532)..ALC["L-Parenthesis"]..ALC["Lower"]..ALC["R-Parenthesis"], 532 },
		...
		{ WHIT.." 4) "..Atlas:GetBossName("Kael'thas Sunstrider", 533), 533 },
		{ GREN.." 1') "..L["Tyrith"], 10003 },
		{ GREN.." 2') "..L["Scrying Orb"], 10004 },
		{ GREN..INDENT..Atlas:GetBossName("Kalecgos") },
	},
	SunwellPlateau = {
		...
		{ WHIT..INDENT..Atlas:GetBossName("Sathrovarr the Corruptor", 1591, 2) },
		{ WHIT.." 2) "..Atlas:GetBossName("Brutallus", 1592), 1592 },
		{ WHIT..INDENT..Atlas:GetBossName("Felmyst", 1593), 1593 },
		{ GREN..INDENT..L["Madrigosa"] },
		{ WHIT.." 3) "..Atlas:GetBossName("The Eredar Twins", 1594)..ALC["L-Parenthesis"]..ALC["Lower"]..ALC["R-Parenthesis"], 1594 },
		{ WHIT..INDENT..Atlas:GetBossName("Grand Warlock Alythess", 1594, 1)..ALC["L-Parenthesis"]..ALC["Lower"]..ALC["R-Parenthesis"] },
		{ WHIT..INDENT..Atlas:GetBossName("Lady Sacrolash", 1594, 2)..ALC["L-Parenthesis"]..ALC["Lower"]..ALC["R-Parenthesis"] },
		{ WHIT..INDENT..Atlas:GetBossName("M'uru", 1595, 1)..ALC["L-Parenthesis"]..ALC["Upper"]..ALC["R-Parenthesis"], 1595 },
		{ WHIT..INDENT..Atlas:GetBossName("Entropius", 1595, 2)..ALC["L-Parenthesis"]..ALC["Upper"]..ALC["R-Parenthesis"] },
		{ WHIT.." 4) "..Atlas:GetBossName("Kil'jaeden", 1596), 1596 },
	},
	TempestKeepEnt = {
	...
	TempestKeepArcatraz = {
		...
		{ BLUE.." A) "..ALC["Entrance"], 10001 },
		{ WHIT.." 1) "..Atlas:GetBossName("Zereketh the Unbound", 548), 548 },
		{ WHIT.." 2) "..Atlas:GetBossName("Dalliah the Doomsayer", 549), 549 },
		{ WHIT.." 3) "..Atlas:GetBossName("Wrath-Scryer Soccothrates", 550), 550 },
		{ WHIT.." 4) "..Atlas:GetBossName("Harbinger Skyriss", 551), 551 },
		{ WHIT..INDENT..Atlas:GetBossName("Warden Mellichar") },
	...
	TempestKeepBotanica = {
		...
		{ WHIT.." 1) "..Atlas:GetBossName("Commander Sarannis", 558), 558 },
		{ WHIT.." 2) "..Atlas:GetBossName("High Botanist Freywinn", 559), 559 },
		{ WHIT.." 3) "..Atlas:GetBossName("Thorngrin the Tender", 560), 560 },
		{ WHIT.." 4) "..Atlas:GetBossName("Laj", 561), 561 },
		{ WHIT.." 5) "..Atlas:GetBossName("Warp Splinter", 562), 562 },
	},
	TempestKeepMechanar = {
		...
		{ BLUE.." A) "..ALC["Entrance"], 10001 },
		{ BLUE.." B) "..ALC["Exit"], 10002 },
		{ WHIT.." 1) "..Atlas:GetBossName("Gatewatcher Gyro-Kill"), 10003 },
		{ WHIT.." 2) "..Atlas:GetBossName("Gatewatcher Iron-Hand"), 10004 },
		{ WHIT.." 3) "..Atlas:GetBossName("Mechano-Lord Capacitus", 563)..ALC["L-Parenthesis"]..ALC["Wanders"]..ALC["R-Parenthesis"], 563 },
		{ GREN..INDENT..L["Overcharged Manacell"] },
		{ WHIT.." 4) "..Atlas:GetBossName("Nethermancer Sepethrea", 564), 564 },
		{ WHIT.." 5) "..Atlas:GetBossName("Pathaleon the Calculator", 565), 565 },
