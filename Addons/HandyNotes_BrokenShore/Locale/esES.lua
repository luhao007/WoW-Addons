-- $Id: esES.lua 52 2017-05-14 13:29:33Z arith $
...
L["Show ramp to the higher ground. This could be useful before you can fly!"] = [=[Mostrar rampa al terreno más alto. ¡Esto podría ser útil si todavía no puedes volar!
]=]
