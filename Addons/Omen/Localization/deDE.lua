...
L["Attach to minimap"] = "An der Minikarten anbringen"
...
L["Causes the entire game world to shake momentarily. This option only works if nameplates are turned off."] = "Lässt die Spielwelt für einen kurzen Moment beben. Diese Option funktioniert nur, wenn Namensplaketten deaktiviert sind."
...
L["Help File"] = "Hilfe"
L["Hide minimap/FuBar icon"] = "Minikarten-/FuBar-Symbol anzeigen/verstecken"
...
L["HUNTER"] = "Jäger"
L["Ignore Player Pets"] = "Spielerbegleiter ignorieren"
...
L["OMEN_SLASH_DESC"] = "Diese Knöpfe bewirken dasselbe wie die Slashkommandos beim Befehl /omen"
...
L["Profiles"] = "Profile"
L["Pull Aggro Bar Color"] = "Farbe der Leiste 'Aggro ziehen'"
L["Right"] = "Rechts"
...
L["Show minimap button"] = "Minikartensymbol zeigen"
...
L["Show Omen when you are in a 5-man party"] = "Zeige Omen wenn ich einer 5-Mann-Gruppe bin"
...
L["Show Pull Aggro Bar"] = "'Leiste Aggro ziehen' anzeigen"
L["Show text"] = "Text zeigen"
L["Show the Omen minimap button"] = "Zeige das Omen-Minikartensymbol"
...
L["SHOW_CLASSES_DESC"] = "Zeigt die Omen-Bedrohungsbalken für folgende Klassen. Die Klassen hier betreffen alljene Leute in Eurer Gruppe/Schlachtzug mit Ausnahme der Option 'Nicht in der Gruppe'."
...
L["The background color for players under the effects of Fade, Mirror Image, Tricks of the Trade and Misdirection"] = "Die Hintergrundfarbe für Spieler unter dem Effekt von Verblassen, Spiegelbilder, Schurkenhandel und Irreführung"
L["The background color for your Pull Aggro bar"] = "Die Hintergrundfarbe für Leiste 'Aggro ziehen'"
...
L["Toggle Focus"] = "Fokus ein-/ausschalten"
L["Toggle Omen"] = "Omen ein-/ausblenden"
L["TPS"] = "BPS"
L["TPS Window"] = "BPS Fenster"
L["TPS_WINDOW_DESC"] = "Die Berechnung der Bedrohung pro Sekunde (BPS) basiert auf einem, in Echtzeit gestaffelten Fenster der letzten X Sekunden"
