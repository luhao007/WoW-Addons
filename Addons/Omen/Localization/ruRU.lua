...
L["The background color for players under the effects of Fade, Mirror Image, Tricks of the Trade and Misdirection"] = "Цвет фона для игроков под эффектами Уход в тень, Зеркальное изображение, Маленькие хитрости и Перенаправление"
