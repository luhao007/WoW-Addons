...
L["STRING_GUILDDAMAGERANK_SHOWRANK"] = "Afficher le rang dans la guilde"
...
L["STRING_OPTIONS_INSTANCE_COLOR_DESC"] = "Changez la couleur et la transparence de cette fenêtre. |cFFFFFF00Important|r : la transparence choisie ici est écrasée par les valeurs d'|cFFFFFF00Auto Transparence|r lorsqu'il est activé. |cFFFFFF00Important|r : la sélection de la couleur de la fenêtre écrase toute personnalisation de la couleur sur la barre d'état."
...
L["STRING_OPTIONS_REALMNAME_DESC"] = "Quand activé, le nom du royaume du personnage n'est pas affiché. |cFFFFFF00Désactivé|r : Benoît-Netherwing |cFFFFFF00Activé|r : Benoît"
...
L["STRING_OPTIONS_ROW_SETTING_ANCHOR"] = "Style :"
...
L["STRING_VERSION_AVAILABLE"] = "une nouvelle version est disponible, téléchargez-la sur Twitch App ou le site Curse."
