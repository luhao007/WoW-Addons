...
L["STRING_OPTIONS_OVERALL_ALL_DESC"] = "所有戰鬥記錄都要加入到整體資料中。"
L["STRING_OPTIONS_OVERALL_ANCHOR"] = "整體資料:"
L["STRING_OPTIONS_OVERALL_DUNGEONBOSS"] = "地城首領"
L["STRING_OPTIONS_OVERALL_DUNGEONBOSS_DESC"] = "將地城首領的戰鬥記錄加入到整體資料中。"
L["STRING_OPTIONS_OVERALL_DUNGEONCLEAN"] = "地城小怪"
L["STRING_OPTIONS_OVERALL_DUNGEONCLEAN_DESC"] = "將地城小怪的戰鬥記錄加入到整體資料中。"
L["STRING_OPTIONS_OVERALL_LOGOFF"] = "登出時清空"
L["STRING_OPTIONS_OVERALL_LOGOFF_DESC"] = "啟用時，角色登出的時候會自動清空整體資料。"
L["STRING_OPTIONS_OVERALL_MYTHICPLUS"] = [=[開始傳奇+ 時清空
]=]
L["STRING_OPTIONS_OVERALL_MYTHICPLUS_DESC"] = "啟用時，開始進行新的傳奇+ 地城時會自動清空整體資料。"
L["STRING_OPTIONS_OVERALL_NEWBOSS"] = [=[新的團隊首領時清空
]=]
L["STRING_OPTIONS_OVERALL_NEWBOSS_DESC"] = "啟用時，面對不同的團隊首領時會自動清空整體資料。"
L["STRING_OPTIONS_OVERALL_RAIDBOSS"] = "團隊首領"
L["STRING_OPTIONS_OVERALL_RAIDBOSS_DESC"] = "將團隊首領戰的戰鬥記錄加入到整體資料中。"
L["STRING_OPTIONS_OVERALL_RAIDCLEAN"] = "團隊小怪"
L["STRING_OPTIONS_OVERALL_RAIDCLEAN_DESC"] = "將團隊小怪的戰鬥記錄加入到整體資料中。"
...
L["STRING_OPTIONS_PLUGINS_TOOLBAR_ANCHOR"] = "工具列外掛套件"
...
L["STRING_OPTIONS_REPORT_HEALLINKS"] = "助益法術連結"
...
L["STRING_OPTIONS_RT_DEATHS_FIRST"] = "只有第一個"
...
L["STRING_OPTIONS_SAVELOAD_SKINCREATED"] = "已建立外觀。"
...
L["STRING_OPTIONS_TOOLTIPS_ANCHOR_TEXT"] = "滑鼠提示對齊位置"
...
L["STRING_OPTIONS_WALLPAPER_LOAD_TROUBLESHOOT_TEXT"] = [=[如果背景圖顯示成全部都是綠色:

- 重新啟動魔獸遊戲程式。
- 請確認圖片的寬度為 256、高度為 256。
- 檢查圖片是否為 .TGA 格式，並且是以 32位元/像素 的規格儲存。
- 是否在 Interface 資料夾內，例如: C:/Program Files/World of Warcraft/Interface/]=]
...
L["STRING_OPTIONS_WC_CLOSE_DESC"] = [=[關閉目前正在編輯的視窗。

關閉後，視窗會變成非啟動的狀態 (並未刪除)，任何時候都可以使用視窗控制選單來重新打開視窗。

|cFFFFFF00重要:|r 要完全移除視窗，請到 '視窗: 一般' 的地方設定。]=]
...
L["STRING_OPTIONSMENU_PLUGINS"] = "外掛套件管理"
...
L["STRING_OPTIONSMENU_SKIN"] = "選擇外觀"
L["STRING_OPTIONSMENU_SPELLS"] = "自訂法術"
L["STRING_OPTIONSMENU_SPELLS_CONSOLIDATE"] = "合併名稱相同的普通法術"
L["STRING_OPTIONSMENU_TITLEBAR"] = "標題列"
L["STRING_OPTIONSMENU_TITLETEXT"] = "標題列: 文字"
L["STRING_OPTIONSMENU_TOOLTIP"] = "滑鼠提示"
L["STRING_OPTIONSMENU_WALLPAPER"] = "視窗: 背景圖"
