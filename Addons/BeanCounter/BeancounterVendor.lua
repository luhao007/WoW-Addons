--[[
	...
	Revision: $Id: BeancounterVendor.lua 6505 2019-11-02 14:38:37Z none $
...
LibStub("LibRevision"):Set("$URL: BeanCounter/BeancounterVendor.lua $","$Rev: 6505 $","5.1.DEV.", 'auctioneer', 'libs')
