--[[
	...
	Revision: $Id: SelectBox.lua 6474 2019-11-02 14:38:37Z none $
...
LibStub("LibRevision"):Set("$URL: Auc-Advanced/Libs/Configator/SelectBox.lua $","$Rev: 6474 $","5.1.DEV.", 'auctioneer', 'libs')
