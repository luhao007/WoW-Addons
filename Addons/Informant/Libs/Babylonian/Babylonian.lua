--[[
	...
	Version: 8.2.6475 (SwimmingSeadragon)
	Revision: $Id: Babylonian.lua 6475 2019-11-02 14:38:37Z none $
...
LibStub("LibRevision"):Set("$URL: Auc-Advanced/Libs/Babylonian/Babylonian.lua $","$Rev: 6475 $","5.1.DEV.", 'auctioneer', 'libs')
