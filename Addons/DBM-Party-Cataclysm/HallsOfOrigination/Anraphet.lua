...
local timerNemesis			= mod:NewTargetTimer(5, 75603, nil, "Healer", 2, 5, nil, DBM_CORE_L.HEALER_ICON..DBM_CORE_L.MAGIC_ICON)
local timerBubble			= mod:NewCDTimer(15, 77336, nil, nil, nil, 3, nil, DBM_CORE_L.DAMAGE_ICON)
