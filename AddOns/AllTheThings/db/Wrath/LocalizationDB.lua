...
L.EXPAND_DIFFICULTY_CHECKBOX_TOOLTIP = "Enable this option if you want to automatically minimize difficulty headers in the mini list that are not active when you enter a dungeon or raid.\n\nExample: Minimize the Heroic header when in a Normal difficulty dungeon.";
...
L.SOURCE_ID_MISSING = "Please report this Item and where it was acquired to the ATT Discord in #retail-errors!";
...
L.EXPAND_DIFFICULTY_CHECKBOX_TOOLTIP = "Activa esta opción si quieres minimizar automáticamente en la Mini Lista las cabeceras de dificultad que no están activas cuando entras a un calabozo o banda.\n\nEjemplo: Minimiza la cabecera de Heroico en un calabozo de dificultad Normal.";
...
L.PLEASE_REPORT_MESSAGE = "¡Por favor, reporta esto al Discord de ATT en #retail-errors! ¡gracias!";
