...
for key,value in pairs({
	...
	[51] = "|cFFAAFFAAEsto no estuvo disponible hasta Landfall de Mists of Pandaria Classic.|r",
	[52] = "|cFFAAFFAAEsto no estuvo disponible hasta Rise of the Thunder King de Mists of Pandaria Classic.|r",
	[54] = "|cFFAAFFAAEsto no estuvo disponible hasta Siege of Orgrimmar de Mists of Pandaria Classic.|r",
})
do phases[key].description = value; end
end
