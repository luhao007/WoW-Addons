...
local timerDebilitatingCD			= mod:NewNextTimer(20, 161199, nil, nil, nil, 4, nil, DBM_CORE_L.INTERRUPT_ICON, nil, mod:IsTank() and 2, 4)--Every 20 seconds exactly, at least in challenge mode.
