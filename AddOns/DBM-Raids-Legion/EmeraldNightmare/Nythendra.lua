...
local specWarnBreath				= mod:NewSpecialWarningDodgeCount(202977, nil, nil, nil, 2, 2, nil, nil, "breathsoon")
local specWarnVolatileRot			= mod:NewSpecialWarningRun(204463, nil, nil, nil, 3, 2, nil, nil, "runout")
local specWarnVolatileRotSwap		= mod:NewSpecialWarningTaunt(204463, nil, nil, nil, 1, 2, nil, nil, "tauntboss")
local yellVolatileRot				= mod:NewFadesYell(204463)
local specWarnRot					= mod:NewSpecialWarningRun(203096, nil, nil, nil, 1, 2, nil, nil, "runout")
local yellRot						= mod:NewFadesYell(203096)
local specWarnInfestedGround		= mod:NewSpecialWarningMove(203045, nil, nil, nil, 1, 2, nil, nil, "runaway")
local specWarnBurst					= mod:NewSpecialWarningMove(203646, nil, nil, nil, 1, 2, nil, nil, "runaway")
local specWarnInfestedMindYou		= mod:NewSpecialWarningYou(205043, nil, nil, nil, 1, 2, nil, nil, "targetyou")
local yellInfestedMind				= mod:NewYell(205043)
local specWarnInfestedMind			= mod:NewSpecialWarningSwitch(205043, "Dps", nil, nil, 1, 2, nil, nil, "findmc")
local specWarnSpreadInfestation		= mod:NewSpecialWarningInterrupt(205070, "HasInterrupt", nil, nil, 1, 2, nil, nil, "kickcast")
local specWarnInfestedStack			= mod:NewSpecialWarningStack(204504, nil, 7, nil, 2, 1, 6, nil, nil, "stackhigh")
