...
local baseLocale = {
    ...
    ["  /ttpaste list - List the titles of pages that have been saved"] = "  /ttpaste list - Lister les titres des pages enregistrées",
    ...
    ["  /ttpaste save [title] - Save the current contents of the window with the given name"] = "  /ttpaste save [title] - Enregistrer le contenu actuel de la fenêtre sous le nom donné",
    ...
    ["Add several /way commands here and click Paste"] = "Ajouter plusieurs commandes /way ici, puis cliquer sur Coller",
    ...
    ["Auto-close after paste"] = "Fermer automatiquement après le collage",
    ["Auto-close paste window after submitting"] = "Fermer automatiquement la fenêtre de collage après l'envoi",
    ["Automatically hides the paste window after submitting"] = "Masquer automatiquement la fenêtre de collage après l'envoi",
    ["Automatically set a waypoint when I die"] = "Définir automatiquement un point de passage lorsque je meurs",
    ["Automatically set to next closest waypoint"] = "Définir automatiquement le point de passage suivant le plus proche ",
    ...
    ["Clear waypoint distance"] = "Effacer la distance du point de passage",
    ["Clear waypoint from crazy arrow"] = "Effacer le point de passage de la flèche de navigation",
    ["Close"] = "Fermer",
    ...
    ["Disables the crazy taxi arrow for mouse input, allowing all clicks to pass through"] = "Désactiver la prise en charge de la souris pour la flèche de navigation, ce qui permet à tous les clics de passer au travers",
    ...
    ["Enables a floating block that displays your current position in the current zone"] = "Activer un cadre flottant qui affiche votre position actuelle dans la zone en cours",
    ["Enables a menu when right-clicking on a waypoint allowing you to clear or remove waypoints"] = "Activer un menu lorsque vous cliquez avec le bouton droit sur un point de passage, vous permettant d'effacer ou de supprimer des points de passage",
    ["Enables a menu when right-clicking on the waypoint arrow allowing you to clear or remove waypoints"] = "Activer un menu lorsque vous cliquez avec le bouton droit sur la flèche du point de passage, vous permettant d'effacer ou de supprimer des points de passage",
    ["Enables or disables the showing of a minimap button to toggle the paste window."] = "Activer / désactiver l'affichage d'un bouton sur la mini-carte pour basculer vers la fenêtre de collage.",
    ["Enables or disables the showing of an addon-compartment button to toggle the paste window."] = "Activer / désactiver l'affichage d'un bouton dans le compartiment des add-ons pour basculer vers la fenêtre de collage.",
    ["Enables the automatic setting of quest objective waypoints based on which objective is closest to your current location.  This setting WILL override the setting of manual waypoints."] = "Activer le réglage automatique des points de passage des objectifs de quête en fonction de celui le plus proche de votre position actuelle. Ce réglage PRÉVAUDRA sur le réglage des points de passage manuels.",
    ["Enables the setting of waypoints when modified-clicking on quest objectives"] = "Activer le réglage des points de passage lorsque vous cliquez avec le bouton droit sur les objectifs de quête",
    ["Exact color"] = "Couleur exacte",
    ["Export waypoints"] = "Exporter les points de passage",
    ["Font size"] = "Taille de la police",
    ["Found %d possible matches for zone %s.  Please be more specific"] = "%d correspondances possibles trouvées pour la zone %s. Veuillez être plus précis",
    ...
    ["Hiding the TomTom-Paste minimap button"] = "Masquer le bouton de la fenêtre de collage de TomTom sur la mini-carte",
    ["If you have changed the waypoint display settings (minimap, world), this will reset all waypoints to the current options."] = "Si vous avez modifié les paramètres d'affichage des points de passage (mini-carte, monde), cette opération réinitialisera tous les points de passage aux options actuelles.",
    ["If your arrow is covered up by something else, try this to bump it up a layer."] = "Si votre flèche est masquée par un autre élément, essayez ceci pour la faire remonter d'une couche.",
    ["Loaded %d characters from page '%s'"] = "%d caractères chargés depuis la page « %s »",
    ["Lock coordinate block"] = "Verrouiller le cadre des coordonnées",
    ["Lock crazy arrow"] = "Verrouiller la flèche de navigation",
    ...
    ["Middle color"] = "Couleur intermédiaire",
    ["Minimap"] = "Mini-carte",
    ...
    ["Place the arrow in the HIGH strata"] = "Placer la flèche dans la couche haute",
    ["Play a sound when arriving at a waypoint"] = "Jouer un son à l'arrivée à un point de passage",
    ...
    ["Player: %s"] = "Joueur : %s",
    ["Player: ---"] = "Joueur : ---",
    ["Print a /way command when right-clicking the coordinate block"] = "Afficher la commande /way : clic droit sur le cadre des coordonnées",
    ["Prints a version of the /way command that can be shared with others to your chat, when right-clicking the coordinate block"] = "Afficher une version de la commande /way partageable dans le chat : clic droit sur le cadre des coordonnées",
    ["Profile Options"] = "Profils",
    ["Prompt before accepting sent waypoints"] = "Demander une confirmation avant d'accepter les points de passage envoyés",
    ["Provide a LDB data source for the crazy-arrow"] = "Fournir une source de données LDB pour la flèche de navigation",
    ["Provide an LDB data source for coordinates"] = "Fournir une source de données LDB pour les coordonnées",
    ...
    ["Show addon compartment button to open TomTom-Paste window"] = "Afficher le bouton du compartiment supplémentaire pour ouvrir la fenêtre de collage de TomTom",
    ["Show estimated time to arrival"] = "Afficher le temps estimé avant l'arrivée",
    ["Show minimap button to open TomTom-Paste window"] = "Afficher le bouton sur la mini-carte pour ouvrir la fenêtre de collage de TomTom",
    ["Show the distance to the waypoint"] = "Afficher la distance jusqu'au point de passage",
    ["Showing the TomTom-Paste minimap button"] = "Afficher le bouton pour la fenêtre de collage de TomTom sur la mini-carte",
    ...
    ["Shows the distance (in yards) to the waypoint"] = "Affiche la distance (en yards) jusqu'au point de passage",
    ...
    ["Toggle the TomTom Paste Window"] = "Afficher / masquer la fenêtre de collage de TomTom",
    ["TomTom Paste"] = "Fenêtre de collage de TomTom",
    ...
    ["TomTom can display a tooltip containing information about waypoints, when they are moused over.  This setting toggles that functionality"] = "TomTom peut afficher une info-bulle contenant des informations sur les points de passage lorsque vous passez la souris dessus. Ce paramètre permet d'activer ou de désactiver cette fonctionnalité.",
    ...
    ["TomTom/Block"] = "TomTom/Block",
    ["Unknown distance"] = "Distance inconnue",
    ["Unknown waypoint"] = "Point de passage inconnu",
    ["Unlock crazy arrow"] = "Déverrouiller la flèche de navigation",
    ...
    ["|cffffff78TomTom:|r CoordBlock %s visible"] = "|cffffff78TomTom|r : Cadre des coordonnées %s visible",
