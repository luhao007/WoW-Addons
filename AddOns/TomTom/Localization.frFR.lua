...
local baseLocale = {
    ...
    ["Enables or disables the showing of a minimap button to toggle the paste window."] = "Permet d'afficher ou de désactiver un bouton sur la mini-carte pour ouvrir ou fermer la fenêtre de collage.",
    ["Enables or disables the showing of an addon-compartment button to toggle the paste window."] = "Active ou désactive l'affichage d'un bouton de compartiment supplémentaire permettant d'ouvrir ou de fermer la fenêtre de collage.",
    ["Enables the automatic setting of quest objective waypoints based on which objective is closest to your current location.  This setting WILL override the setting of manual waypoints."] = "Activer la définition automatique des points de passage des objectifs de quête en fonction de l'objectif le plus proche de votre position actuelle. Ce paramètre remplacera les points de passage définis manuellement.",
    ...
    ["Open the TomTom Paste window"] = "Ouvrir la fenêtre de collage de TomTom",
