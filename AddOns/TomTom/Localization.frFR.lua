...
local baseLocale = {
    ...
    ["Hiding the TomTom-Paste minimap button"] = "Masquer le bouton TomTom Paste pour la mini-carte",
    ...
    ["Open the TomTom Paste window"] = "Ouvrir la fenêtre TomTom Paste",
    ...
    ["Show addon compartment button to open TomTom-Paste window"] = "Afficher le bouton du compartiment supplémentaire pour ouvrir la fenêtre TomTom Paste",
    ["Show estimated time to arrival"] = "Afficher le temps estimé pour arriver",
