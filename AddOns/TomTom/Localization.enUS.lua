...
local baseLocale = {
    ...
    ["Add several /way commands here and click Paste or press Ctrl+Enter"] = "Add several /way commands here and click Paste or press Ctrl+Enter",
    ...
    ["Auto-close after paste"] = "Auto-close after paste",
    ["Auto-close paste window after submitting"] = "Auto-close paste window after submitting",
    ["Automatically hides the paste window after submitting"] = "Automatically hides the paste window after submitting",
    ...
    ["Enables or disables the showing of a minimap button to toggle the paste window."] = "Enables or disables the showing of a minimap button to toggle the paste window.",
    ["Enables or disables the showing of an addon-compartment button to toggle the paste window."] = "Enables or disables the showing of an addon-compartment button to toggle the paste window.",
    ...
    ["Export waypoints"] = "Export waypoints",
    ["Font size"] = "Font size",
    ...
    ["No map data is available for map #%d."] = "No map data is available for map #%d.",
    ...
    ["Player: %s"] = "Player: %s",
    ["Player: ---"] = "Player: ---",
    ["Print a /way command when right-clicking the coordinate block"] = "Print a /way command when right-clicking the coordinate block",
    ["Prints a version of the /way command that can be shared with others to your chat, when right-clicking the coordinate block"] = "Prints a version of the /way command that can be shared with others to your chat, when right-clicking the coordinate block",
    ...
    ["Show addon compartment button to open TomTom-Paste window"] = "Show addon compartment button to open TomTom-Paste window",
    ["Show estimated time to arrival"] = "Show estimated time to arrival",
    ["Show minimap button to open TomTom-Paste window"] = "Show minimap button to open TomTom-Paste window",
