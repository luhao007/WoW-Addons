...
local baseLocale = {
    ...
    ["Coordinates can be moved from the default location, this setting allows you to control that offset"] = "Ermöglicht es die Koordinaten zu verschieben, um andere Addons nicht zu überlagern.",
    ...
    ["If you have changed the waypoint display settings (minimap, world), this will reset all waypoints to the current options."] = "Wenn die Einstellungen für die Wegpunktanzeige (Minikarte, Welt) geändert wurden, werden hiermit alle Wegpunkte auf die aktuellen Optionen gesetzt.",
    ...
    ["Resets the position of the waypoint arrow if it has been dragged off screen"] = "Setzt die Position zurück.", -- for Waypoint arrow and coordblock used.
    ...
    ["TomTom can display a tooltip containing information about waypoints, when they are moused over.  This setting toggles that functionality"] = "Zeige Tooltips zu den Wegpunkten wenn die Maus sich darüber befindet.",
    ...
    ["|cffffff78/way <x> <y> [desc]|r - Adds a waypoint at x,y with description desc"] = "|cffffff78/way <x> <y> [desc]|r - Fügt einen Wegpunkt bei x,y mit einer Beschreibung hinzu.",
...
addon:RegisterLocale('deDE', baseLocale)
