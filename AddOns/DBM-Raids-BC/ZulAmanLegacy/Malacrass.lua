...
local specWarnBolt			= mod:NewSpecialWarningSpell(43383, nil, nil, nil, 2, 2, nil, nil, "aesoon")
local specWarnHealingWave	= mod:NewSpecialWarningInterrupt(43548, "HasInterrupt", nil, nil, 1, 2, nil, nil, "kickcast")
local specWarnHolyLight		= mod:NewSpecialWarningInterrupt(43451, "HasInterrupt", nil, nil, 1, 2, nil, nil, "kickcast")
local specWarnFlashHeal		= mod:NewSpecialWarningInterrupt(43431, "HasInterrupt", nil, nil, 1, 2, nil, nil, "kickcast")
local specWarnLifebloom		= mod:NewSpecialWarningDispel(43421, "MagicDispeller", nil, nil, 1, 2, nil, nil, "dispelboss")
local specWarnTotem			= mod:NewSpecialWarningSwitch(43436, "Dps", nil, nil, 1, 2, nil, nil, "attacktotem")
local specWarnGTFO			= mod:NewSpecialWarningGTFO(43429, nil, nil, nil, 1, 8, nil, nil, "watchfeet")
