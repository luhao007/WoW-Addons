...
local specWarnEnfeeble			= mod:NewSpecialWarningYou(37277, nil, nil, nil, 3, 2, nil, nil, "targetyou")
local specWarnNova				= mod:NewSpecialWarningRun(30852, "Melee", nil, nil, 4, 2, nil, nil, "justrun")
