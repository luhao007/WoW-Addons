local mod	= DBM:NewMod("Teluur", "DBM-Draenor", 2)
...
local specWarnEntanglement	= mod:NewSpecialWarningDodge(180836, nil, nil, nil, 1, 2, nil, nil, "watchstep")--Dodgable. puts green swirly under random player. traps everyone there after 4 seconds. Target scanning not possible, warn everyone to check feet
