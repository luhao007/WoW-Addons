local mod	= DBM:NewMod("LadyFleshsear", "DBM-Draenor", 2)
...
local specWarnOverwhelmingFlames	= mod:NewSpecialWarningMoveAway(180776, nil, nil, nil, 1, 2, nil, nil, "runout")
local yellOverwhelmingFlames		= mod:NewYell(180776)
local specWarnRainofFireGTFO		= mod:NewSpecialWarningMove(180775, nil, nil, nil, 1, 2, nil, nil, "runaway")
