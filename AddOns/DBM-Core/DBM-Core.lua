...
_G.DBM = DBM
DBM.Revision = parseCurseDate("20250816044208")
DBM.TaintedByTests = false -- Tests may mess with some internal state, you probably don't want to rely on DBM for an important boss fight after running it in test mode

local fakeBWVersion, fakeBWHash = 393, "9e38763"--393.0
local PForceDisable
-- The string that is shown as version
DBM.DisplayVersion = "11.2.9"--Core version
DBM.classicSubVersion = 0
DBM.dungeonSubVersion = 0
DBM.ReleaseRevision = releaseDate(2025, 8, 16) -- the date of the latest stable version that is available, optionally pass hours, minutes, and seconds for multiple releases in one day
...
---@param revision number|string Either a number in the format "202101010000" (year, month, day, hour, minute) or string "20250816044208" to be auto set by packager
