...
local warnGoreboundSpiritSoon		= mod:NewSoonAnnounce(-11020, 3, 187814)
...
local specWarnShadowofDeath			= mod:NewSpecialWarningYouCount(179864, nil, nil, nil, 1, 5, nil, nil, "teleyou")
local specWarnShadowofDeathTank		= mod:NewSpecialWarningTaunt(179864, nil, nil, nil, 1, 2, nil, nil, "tauntboss")
local specWarnTouchofDoom			= mod:NewSpecialWarningRun(179977, nil, nil, nil, 4, 2, nil, nil, "runout")
local yellTouchofDoom				= mod:NewYell(179977)
local specWarnDoomWell				= mod:NewSpecialWarningMove(179995)
local specWarnSharedFate			= mod:NewSpecialWarningMoveTo(179908, nil, nil, nil, 3, 2, nil, nil, "linegather")--Only non rooted player get moveto. rooted player can't do anything.
...
local specWarnHungerforLife			= mod:NewSpecialWarningRun(180148, nil, nil, nil, 4, 2, nil, nil, "justrun")
local specWarnEnragedSpirit			= mod:NewSpecialWarningSwitch(-11378, "-Healer")
local specWarnGoreboundSpirit		= mod:NewSpecialWarningSwitch(-11020, "-Healer")
local specWarnBurning				= mod:NewSpecialWarningStack(185189, nil, 4, nil, nil, nil, nil, nil, nil, "stackhigh")
local specWarnBurningOther			= mod:NewSpecialWarningTaunt(185189, nil, nil, nil, nil, 2, nil, nil, "tauntboss")
local specWarnBellowingShout		= mod:NewSpecialWarningInterrupt(181582, "HasInterrupt", nil, 2, 1, 2, nil, nil, "kickcast")
