local mod	= DBM:NewMod("HellfireCitadelTrash", "DBM-Raids-WoD", 1)
...
local specWarnCrowdControl			= mod:NewSpecialWarningLookAway(189595, nil, nil, nil, 1, 2, nil, nil, "turnaway")
local specWarnSeverSoul				= mod:NewSpecialWarningYou(189533, nil, nil, nil, 1, 2, nil, nil, "changemt")
local specWarnSeverSoulOther		= mod:NewSpecialWarningTaunt(189533, nil, nil, nil, 1, 2, nil, nil, "tauntboss")
local specWarnBadBreathOther		= mod:NewSpecialWarningTaunt(188476, nil, nil, nil, 1, 2)
local specWarnBloodthirster			= mod:NewSpecialWarningSwitch(-11266, "Dps", nil, 2, 1, 12, nil, nil, "attackbloodthirster")
local specWarnRendingHowl			= mod:NewSpecialWarningInterrupt(189612, "HasInterrupt", nil, 2, 1, 2, nil, nil, "kickcast")
