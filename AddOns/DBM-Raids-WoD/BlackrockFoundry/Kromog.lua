...
mod:SetRevision("20230719201531")
...
local specWarnGraspingEarth			= mod:NewSpecialWarningMoveTo(157060, nil, DBM_CORE_L.AUTO_SPEC_WARN_OPTIONS.spell:format(157060), nil, nil, 12)
