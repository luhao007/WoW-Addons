...
local specWarnBomb				= mod:NewSpecialWarningMoveTo(155192, nil, DBM_CORE_L.AUTO_SPEC_WARN_OPTIONS.you:format(155192), nil, 3, 2, nil, nil, "bombrun")
local specWarnBellowsOperator	= mod:NewSpecialWarningSwitch(-9650, "-Healer", nil, 2, nil, 2, nil, nil, "killmob")
...
local specWarnRepair			= mod:NewSpecialWarningInterrupt(155179, "-Healer", nil, nil, nil, 2, nil, nil, "kickcast")
local specWarnRuptureOn			= mod:NewSpecialWarningYou(156932, nil, nil, 2, 3, 2, nil, nil, "runout")
local specWarnRupture			= mod:NewSpecialWarningMove(156932, nil, nil, nil, 1, 2, nil, nil, "runaway")
local yellRupture				= mod:NewYell(156932)
--Phase 2
local specWarnFixate			= mod:NewSpecialWarningYou(155196, nil, nil, nil, 1, 2, nil, nil, "targetyou")
local specWarnMeltYou			= mod:NewSpecialWarningYou(155225, nil, nil, nil, 1, 2, nil, nil, "runout")
local specWarnMelt				= mod:NewSpecialWarningMove(155223, nil, nil, nil, 1, 2, nil, nil, "runaway")
local yellMelt					= mod:NewYell(155223)
local specWarnCauterizeWounds	= mod:NewSpecialWarningInterrupt(155186, "-Healer", nil, nil, 1, 2, nil, nil, "kickcast")
local specWarnPyroclasm			= mod:NewSpecialWarningInterrupt(156937, false, nil, nil, 1, 2, nil, nil, "kickcast")
local specVolatileFire			= mod:NewSpecialWarningMoveAway(176121, nil, nil, nil, 1, 2, nil, nil, "runout")
local specWarnTwoVolatileFire	= mod:NewSpecialWarning("specWarnTwoVolatileFire", nil, nil, nil, 3, nil, nil, nil, nil, nil, "defensive")--A person with double volatile fire is extremely dangerous, they will kill everyone
local yellVolatileFire			= mod:NewYell(176121)
local specWarnShieldsDown		= mod:NewSpecialWarningSwitch(-9655, "Dps", nil, nil, 1, 2, nil, nil, "changetarget")
local specWarnEarthShield		= mod:NewSpecialWarningDispel(155173, "MagicDispeller", nil, nil, 1, 2, nil, nil, "dispelboss")
local specWarnSlagPool			= mod:NewSpecialWarningMove(155743, nil, nil, nil, 1, 8, nil, nil, "runaway")
--Phase 3
local specWarnHeartoftheMountain= mod:NewSpecialWarningSwitch(-10808, "Tank")
local specWarnHeat				= mod:NewSpecialWarningStack(155242, nil, 2, nil, nil, nil, 6, nil, nil, "stackhigh")
local specWarnHeatOther			= mod:NewSpecialWarningTaunt(155242, nil, nil, nil, nil, 2, nil, nil, "tauntboss")
--All
local specWarnBlast				= mod:NewSpecialWarningSoon(155209, nil, nil, nil, 2, 2, nil, nil, "aesoon")
