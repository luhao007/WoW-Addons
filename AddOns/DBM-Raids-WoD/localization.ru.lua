...
L:SetOptionLocalization({
	...
	overrideMarkOfLegion	= "Не позволять лидеру рейда переопределять режим $spell:188514 (рекомендуется только для продвинутых игроков, которые уверены, что их собственные настройки не противоречат намерениям лидеров рейда)"
})
