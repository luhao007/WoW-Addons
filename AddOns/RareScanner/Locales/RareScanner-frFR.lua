...
if AL then
	...
	AL["ALL_ZONES"] = "- TOUT -"
	AL["APPLY_COLLECTIONS_LOOT_FILTERS"] = "Voulez-vous modifier le butin affiché dans la barre de butin et la carte du monde afin qu'il n'affiche que les collections manquantes trouvées ? Ceci remplacera vos filtres de butin actuels (ceci ne s'applique pas aux filtres individuels)."
	...
	AL["CMD_DISABLE_SCANNING_WORLDMAP_VIGNETTES"] = "RareScanner scan des vignettes de la carte du monde désactivée"
	...
	AL["CMD_ENABLE_SCANNING_WORLDMAP_VIGNETTES"] = "RareScanner scan des vignettes de la carte du monde activée"
