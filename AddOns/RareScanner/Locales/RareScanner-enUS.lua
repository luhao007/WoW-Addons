...
AL["CONTAINER_207166"] = "Titan Console"
...
AL["NOTE_222165"] = "In order to start the event you need a [Radiant Echoe]. This item is found inside [Bountifull Cofer]s that appear when you complete a [Bountiful Delve]. You need a [Restored Coffer Key] to unlock these coffers."
AL["NOTE_223143"] = "Push [Lionel] into the water. Then collect 5x[Plump snapcrab]s that you will find running on the sand and feed them to him."
...
AL["NOTE_443318"] = "Talk to [Freysworn Letitia] to get [Crab-Guilding Branch]. You have to use this item with 5x[Pearlescent Shellcrab]s that are scattered around the [Isle of Dorn]. Show the guidance icons to see where to find them, go to the spot and use the item (you don't even have to target the crab)."
...
AL["NOTE_446101"] = "Right under the platform, in a small cavity."
...
AL["NOTE_446404"] = "You need a [Cache Key] to unlock it. In order to get the key, interact with an [Extractor Storage] to get the buff [Unseeming Shift]. While this buff is active, you can find a [Corrupted Memory] beside the treasure. Kill it to obtain the key."
