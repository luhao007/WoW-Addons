...
private.CONTINENT_ZONE_IDS = {
	...
	[2537] = { zonefilter = true, npcfilter = true, id = 16, zones = {2393,2424,2432,2395,2437,2405,2413,2444,2509,2512,2536,2541,2545,2599,2600}, current = { "all" } }; --Quel'Thalas
	...
	[9993] = { zonefilter = true, npcfilter = true, zones = {2302,2310,2312,2347,2249,2250,2251,2259,2269,2277,2301,2302,2310,2347,2348,2396,2420,2453,2502,2505,2506,2510,2504,2525,2528,2522,2535,2545,2547,2585,2594,2633,2635} }; --Delves
}
...
private.SUBZONES_IDS = {
	...
	[2512] = { 2613, 2639, 2642, 2644, 2645 }; --The Coiled Isle
	[2509] = { 2636, 2638 }; --Vaults of Atal'Utek
}
