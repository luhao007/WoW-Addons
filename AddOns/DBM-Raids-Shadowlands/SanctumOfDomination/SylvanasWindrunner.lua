...
mod:RegisterEventsInCombat(
	...
	"SPELL_AURA_APPLIED 347504 347807 347670 349458 348064 347607 350857 348146 351109 351117 351451 353929 357886 357720 353935 348064 356986 358711 358705 351562 358434 351589",
	"SPELL_AURA_APPLIED_DOSE 347807 347607 351672 353929",
	"SPELL_AURA_REMOVED 347504 347807 351109 358711 358705 351562 358434 348064 353929 350857 356986",
...
--			self.vb.arrowIcon = 1
	...
	elseif spellId == 356023 then
		...
		if self:CheckInterruptFilter(args.sourceGUID, false, false) then
			...
			if count < 6 then
				specWarnTerrorOrb:Play("kick"..count.."r")
			else
...
function mod:CHAT_MSG_RAID_BOSS_EMOTE(msg)
	if msg:find("spell:347704") then--Faster than Combat log by 2.5 seconds in phase 1 and doesn't exist in combat log at all in phase 3 because reasons
		...
		if self.vb.phase == 1 or self.vb.phase == 3 then
			...
			if timer and timer > 0 then--Handles P1 and P3, P2 is scheduled via bridges
