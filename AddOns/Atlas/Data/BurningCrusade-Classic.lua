...
db.AtlasMaps = {
	...
	KarazhanStart = {
		...
		{ WHIT.." 4) "..Atlas_GetBossName("Opera Hall") },
		...
		{ ORNG.." 1) "..Atlas_GetBossName("Servant Quarters") },
	...
	KarazhanEnd = {
		...
		{ BLUE..INDENT..L["Ramp down to the Gamesman's Hall"]..ALC["L-Parenthesis"]..Atlas_GetBossName("Chess Event")..ALC["R-Parenthesis"] },
	...
	SunwellPlateau = {
		...
		{ WHIT.." 3) "..Atlas_GetBossName("The Eredar Twins")..ALC["L-Parenthesis"]..ALC["Lower"]..ALC["R-Parenthesis"] },
		...
		{ WHIT..INDENT..Atlas_GetBossName("M'uru")..ALC["L-Parenthesis"]..ALC["Upper"]..ALC["R-Parenthesis"] },
	...
	CoTHyjal = {
		...
		{ "" },
		{ LBLU..ACHIEVEMENTS..ALC["Colon"] },
		{ "The Battle for Mount Hyjal",                                      "ac=695" },
	},
	CoTOldHillsbrad = {
