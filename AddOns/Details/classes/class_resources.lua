...
function atributo_energy:ToolTipRegenRecebido (instancia, numero, barra, keydown)
	...
	for i = 1, #allGeneratorSpells do
		...
		GameCooltip:AddLine(spellName, FormatTooltipNumber (_,  thisGenerator[2]) .. " (|cFFFF5555溢出: " .. FormatTooltipNumber (_,  thisGenerator[3]) .. "|r | " .. _cstr ("%.1f", (thisGenerator[2] / allGenerated) * 100).."%)")
