...
local specWarnSoulreaper			= mod:NewSpecialWarningDefensive(69409, nil, nil, nil, 1, 2, nil, nil, "defensive") --Phase 1+ Ability
local specWarnNecroticPlague		= mod:NewSpecialWarningMoveAway(70337, nil, nil, nil, 1, 2, nil, nil, "runout") --Phase 1+ Ability
local specWarnRagingSpirit			= mod:NewSpecialWarningYou(69200, nil, nil, nil, 1, 2, nil, nil, "targetyou") --Transition Add
local specWarnYouAreValkd			= mod:NewSpecialWarning("SpecWarnYouAreValkd", nil, nil, nil, 1, 2, nil, nil, 71844, nil, "targetyou") --Phase 2+ Ability
...
local specWarnHarvestSoul			= mod:NewSpecialWarningYou(68980, nil, nil, nil, 1, 2, nil, nil, "targetyou") --Phase 3+ Ability
local specWarnInfest				= mod:NewSpecialWarningSpell(70541, "Healer", nil, 2, 2, 2, nil, nil, "healall") --Phase 1+ Ability
local specWarnSoulreaperOtr			= mod:NewSpecialWarningTaunt(69409, nil, nil, nil, 1, 2, nil, nil, "tauntboss") --phase 2+
local specWarnTrap					= mod:NewSpecialWarningYou(73539, nil, nil, nil, 3, 2, nil, nil, "watchstep") --Heroic Ability
local yellTrap						= mod:NewYell(73539)
local specWarnTrapNear				= mod:NewSpecialWarningClose(73539, nil, nil, nil, 3, 2, nil, nil, "watchstep") --Heroic Ability
local specWarnHarvestSouls			= mod:NewSpecialWarningSpell(73654, nil, nil, nil, 1, 2, nil, nil, "phasechange") --Heroic Ability
local specWarnValkyrLow				= mod:NewSpecialWarning("SpecWarnValkyrLow", nil, nil, nil, 1, 2, nil, nil, 71844, nil, "stopattack")
local specWarnGTFO					= mod:NewSpecialWarningGTFO(68983, nil, nil, nil, 1, 8, nil, nil, "watchfeet")
