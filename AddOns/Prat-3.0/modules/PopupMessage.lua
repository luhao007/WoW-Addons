...
L["Adds an alternate name to show in popups."] = "Ajoute un nom alternatif à afficher dans les fenêtres contextuelles."
L["Clear Nickname"] = "Nettoyer le surnom"
L["Clears alternate name to show in popups."] = "Efface le nom alternatif à afficher dans les fenêtres contextuelles."
L["framealpha_desc"] = "Définir la transparence du cadre contextuel lorsqu'il apparaît complètement en fondu."
L["framealpha_name"] = "Transparence des cadres contextuels"
L["Popup"] = "Cadre contextuel"
L["PopupMessage"] = "Message du menu contextuel"
L["Remove Nickname"] = "Supprimer le surnom"
L["Removes an alternate name to show in popups."] = "Supprimer le nom alternatif à afficher dans les fenêtres contextuelles."
L["Set Separately"] = "Afficher séparément"
L["Show All Popups"] = "Afficher toutes les fenêtres contextuelles"
L["Show Popups"] = "Afficher les fenêtres contextuelles"
L["Show Popups for all chat windows."] = "Afficher les fenêtres contextuelles pour toutes les fenêtres de discussion."
L["Show Popups for each window."] = "Afficher les fenêtres contextuelles pour chaque fenêtre."
L["show_desc"] = "Afficher les fenêtres contextuelles pour chaque fenêtre."
L["show_name"] = "Afficher les fenêtres contextuelles"
L["show_perframedesc"] = "Afficher / masquer les fenêtres contextuelles"
L["show_perframename"] = "Afficher les fenêtres contextuelles de ChatFrame%d"
L["showall_desc"] = "Afficher les fenêtres contextuelles pour toutes les fenêtres de discussion."
L["showall_name"] = "Afficher toutes les fenêtres contextuelles"
L["Shows messages in a popup window."] = "Affiche les messages dans une fenêtre contextuelle."
L["Shows messages with your name in a popup."] = "Afficher les messages contenant votre nom dans une fenêtre contextuelle."
L["Toggle setting options separately for each chat window."] = "Activer / désactiver les options de configuration séparément pour chaque fenêtre de chat."
