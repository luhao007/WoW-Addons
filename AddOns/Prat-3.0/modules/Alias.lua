...
L["%s() called with nil argument!"] = "%s() appelé avec un argument nul !"
L["/%s aliased to \"/%s\""] = "/%s alias de \"/%s\""
L["/%s aliased to: /%s"] = "/%s défini comme alias de : /%s"
L["<alias> - remove the alias <alias> (cmd aliases: /delalias, /remalias)"] = "<alias> - supprimer l'alias <alias> (alias de commande : /delalias, /remalias)"
...
L["<keyword> - finds all aliases matching <keyword> (cmd aliases: /findalias)"] = "<mot-clé> - trouve tous les alias correspondant à <mot-clé> (alias de commande : /findalias)"
L["add"] = "ajouter"
...
L["noclobber set - skipping new alias: /%s already expands to /%s"] = "NePasÉcraser activé - ignorer le nouvel alias : /%s est déjà étendu en /%s"
L["Options"] = true
...
L["refusing to alias \"/%s\" to anything in the interests of Not Buggering Everything Up"] = "refuser de créer un alias pour « /%s » vers quoi que ce soit, afin d’éviter de tout casser"
...
L["tried to show value for alias \"%s\" but undefined in module.Aliases!"] = "Tentative d'affichage de la valeur pour l'alias « %s », mais non défini dans module.Aliases !"
L["unalias"] = "Enlever l'alias"
L["verbose"] = "verbeux"
L["warnUser() called with nil argument!"] = "warnUser() appelée avec un argument nil !"
L["warnUser() called with zero length string!"] = "warnUser() appelée avec une chaîne vide !"
