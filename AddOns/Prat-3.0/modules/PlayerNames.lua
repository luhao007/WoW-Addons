...
L["hoverhilight_desc"] = "Surligner les lignes du chat d’un joueur spécifique lors du survol de son « lien joueur »"
L["hoverhilight_name"] = "Surlignage au survol"
...
L["Show Group"] = "Afficher le groupe"
L["Show Level"] = "Afficher le niveau"
L["Show Raid Target Icon"] = "Afficher l'icône de la cible de raid"
L["Square"] = "Crochets"
...
L["Toggle level showing."] = "Afficher / masquer le niveau."
L["Toggle raid group showing."] = "Afficher / masquer le groupe de raid."
L["Toggle showing the raid target icon which is currently on the player."] = "Activer / désactiver l'affichage de l'horodatage pour chaque fenêtre."
...
L["Use toon name for RealID"] = "Utiliser le nom du personnage pour le RealID"
