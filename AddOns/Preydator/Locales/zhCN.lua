...
L["HINT_ADVANCED_NOTES"] = "现有安装将保留当前的保存值。新设置仅在PreydatorDB中缺少键时应用。此面板取代了旧的长格式选项页面，但使用相同的数据库。检查功能会打开内置的可复制报告窗口。"
...
L["Preydator HuntDebug: opened in the built-in report window."] = "Preydator狩猎调试: 已在内置报告窗口中打开。"
L["Preydator HuntDebug: report window unavailable: %s"] = "Preydator狩猎调试: 报告窗口不可用: %s"
...
L["Preydator: Inspect report opened in the built-in report window. This is intentional diagnostic output, not a runtime addon bug."] = "Preydator: 检查报告已在内置报告窗口中打开。这是有意的诊断输出，不是运行时插件错误。"
L["Preydator: report window unavailable: %s"] = "Preydator: 报告窗口不可用: %s"
...
L["Preydator HuntDebug: no hunt snapshot captured yet."] = "Preydator狩猎调试: 尚未捕获狩猎快照。"
L["Preydator HuntDebug: opened in the built-in report window."] = "Preydator狩猎调试: 已在内置报告窗口中打开。"
L["Preydator HuntDebug: report window unavailable: "] = "Preydator狩猎调试: 报告窗口不可用: "
...
L["Preydator: Inspect report opened in the built-in report window. This is intentional diagnostic output, not a runtime addon bug."] = "Preydator: 检查报告已在内置报告窗口中打开。这是有意为之的诊断输出，不是运行时插件错误。"
L["Preydator: report window unavailable: "] = "Preydator: 报告窗口不可用: "
...
L["Preydator: Progress bar force show = %s"] = "Preydator: 进度条强制显示 = %s"
L["Preydator commands: options | show | hide | toggle | mem | debug <on|off|show|clear>"] = "Preydator命令: options | show | hide | toggle | debug <on|off|show|clear> | inspect [bs] | qinspect [questID] [bs] | hinspect [bs] | hinspectcopy [bs]"
L["Preydator: Inspect report opened in the built-in report window (debug module)."] = "Preydator: 检查报告已在内置报告窗口中打开（调试模块）。"
L["Preydator: report window unavailable: "] = "Preydator: 报告窗口不可用: "
