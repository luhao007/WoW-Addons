...
panel.opts = {
	...
	{ "header", L["Targeting Options"]..newIcon, 1 },
	...
	{ "check", "LoadTeamsFromTarget", L["Load Teams From Target Button"]..newIcon, L["When a target is chosen after clicking the Target button above the loaded pets, automatically load any saved team associated with the target."] },
	{ "check", "UseOldTargetMenu", L["Use Old Target Button Menu"]..newIcon, L["When clicking the Target button above the loaded pets, use the old context menu rather than the scrollable list of targets to select from."], nil, true },
	...
	{ "header", L["List Behavior Options"]..newIcon, 14 },
	...
	{ "check", "RememberExpandedLists", L["Remember Expanded Lists"]..newIcon, L["In lists that can expand and collapse, such as Options or Targets, remember what was expanded when logging out or reloading; rather than starting with collapsed lists on login."] },
	{ "check", "CollapseListsOnESC", L["Collapse Lists With ESC Key"]..newIcon, L["When a list that can expand or collapse is on screen, such as Options or Targets, make the ESCape key collapse the list if any part is expanded."], nil, true, true },
	...
	{ "check", "DontConfirmFillQueue", L["Don't Confirm To Fill Queue"]..newIcon, L["Don't ask for confirmation when using the 'Fill Queue' or 'Fill Queue More' menu items in the Queue menu."] },
