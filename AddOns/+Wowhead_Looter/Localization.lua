...
WL_OPTIONS_COMBATLOG = COMBAT_LOG or "Combat Logging";
WL_OPTIONS_COMBATLOG_MODE_DISABLED = ADDON_DISABLED or "Disabled";
WL_OPTIONS_COMBATLOG_MODE_INSTANCE = AGGRO_WARNING_IN_INSTANCE or "In Instances";
WL_OPTIONS_COMBATLOG_MODE_ALWAYS = ALWAYS or "Always";
