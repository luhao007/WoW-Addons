...
function ns.LoadTBCZoneInfo(self)
		...
		if db.activate.ZoneMap then
            ...
            -- Blizz Pois
                ...
                if self.db.profile.activate.RemoveBlizzPOIs then
                    ...
                    if self.faction == "Alliance" or db.activate.EnemyFaction then
                        ...
                        nodes[1943][24734852] = { mnID = 1947, name = "", type = "AIcon", showInZone = true, showOnContinent = false, showOnMinimap = false, TransportName = L["Exodar"] .. " - " .. FACTION_ALLIANCE  .. "\n" .. "\n" .. L["Portal"] .. "\n" .. " => " .. L["Stormwind"] }
                        nodes[1943][34034427] = { mnID = 1947, name = "", type = "PassageLeftL", showInZone = true, showOnContinent = false, showOnMinimap = false, TransportName = L["Exodar"] .. " - " .. FACTION_ALLIANCE  .. "\n" .. "\n" .. L["Portal"] .. "\n" .. " => " .. L["Stormwind"] }
                    end
            ...
            -- Ships
                if self.db.profile.showZoneShips then
                    ...
                    if self.faction == "Alliance" or db.activate.EnemyFaction then
                        ...
                        nodes[1943][20065421] = { mnID = 1439, name = "", type = "AShip", showInZone = true, showOnContinent = false, showOnMinimap = false, TransportName = L["Ship"] .. "\n" .. " => " .. L["Rut'theran"] } --
                        nodes[1438][51938943] = { mnID = 1943, name = "", type = "AShip", showInZone = true, showOnContinent = false, showOnMinimap = false, TransportName = L["Ship"] .. "\n" .. " => " .. L["Azuremyst Isle"] } -- Ship from Booty Bay to Ratchet
            ...
            -- Raids            
                ...
                if self.db.profile.showZoneRaids then
                    ...
                    nodes[1942][82156413] = { mnID = 1942, name = DUNGEON_FLOOR_ZULAMAN1 .. " " .. "[" .. LEVEL .. ": " .. "70]", type = "Raid", showInZone = true, showOnContinent = false, showOnMinimap = false }
                    nodes[1957][44134538] = { mnID = 1957, name = DUNGEON_FLOOR_SUNWELLPLATEAU0 .. " " .. "[" .. LEVEL .. ": " .. "70+]", type = "Raid", showInZone = true, showOnContinent = false, showOnMinimap = false }
            ...
            -- Dungeons
                ...
                if self.db.profile.showZoneDungeons then
                    ...
                    nodes[1957][61243079] = { mnID = 1957, name = L["Magisters' Terrace"] .. " " .. "[" .. LEVEL .. ": " .. "70]", dnID = REQUIRES_LABEL .. " " .. MINIMUM .. " " .. LEVEL .. " " .. "70", type = "Dungeon", showInZone = true, showOnContinent = false, showOnMinimap = false }
            ...
            -- Outland Dungeons
                if self.db.profile.showZoneDungeons then
                    nodes[1952][34306560] = { mnID = 1952, name = L["Auchenai Crypts"] .. " " .. "[" .. LEVEL .. ": " .. "65-67]", type = "Dungeon", showInZone = true, showOnContinent = false, showOnMinimap = false } -- Auchenai Crypts 
                    nodes[1952][39705770] = { mnID = 1952, name = DUNGEON_FLOOR_MANATOMBS1 .. " " .. "[" .. LEVEL .. ": " .. "64-66]", type = "Dungeon", showInZone = true, showOnContinent = false, showOnMinimap = false } -- Mana-Tombs 
                    nodes[1952][44906560] = { mnID = 1952, name = L["Sethekk Halls"] .. " " .. "[" .. LEVEL .. ": " .. "67-69]", type = "Dungeon", showInZone = true, showOnContinent = false, showOnMinimap = false } -- Sethekk Halls 
                    nodes[1952][39607360] = { mnID = 1952, name = DUNGEON_FLOOR_SHADOWLABYRINTH1 .. " " .. "[" .. LEVEL .. ": " .. "69-70]", type = "Dungeon", showInZone = true, showOnContinent = false, showOnMinimap = false } -- Shadow Labyrinth 
                    nodes[1953][71705500] = { mnID = 1953, name = DUNGEON_FLOOR_THEBOTANICA1 .. " " .. "[" .. LEVEL .. ": " .. "70]", type = "Dungeon", showInZone = true, showOnContinent = false, showOnMinimap = false } -- The Botanica 
                    nodes[1953][70606980] = { mnID = 1953, name = DUNGEON_FLOOR_THEMECHANAR1 .. " " .. "[" .. LEVEL .. ": " .. "70]", type = "Dungeon", showInZone = true, showOnContinent = false, showOnMinimap = false } -- The Mechanar  
                    nodes[1953][74405770] = { mnID = 1953, name = L["The Arcatraz"] .. " " .. "[" .. LEVEL .. ": " .. "70]", type = "Dungeon", showInZone = true, showOnContinent = false, showOnMinimap = false } -- The Arcatraz
                    nodes[1944][45985183] = { mnID = 1944, name = DUNGEON_FLOOR_THEBLOODFURNACE1 .. " " .. "[" .. LEVEL .. ": " .. "61-63]", type = "Dungeon", showInZone = true, showOnContinent = false, showOnMinimap = false } -- Blood Furnace 
                    nodes[1944][47575360] = { mnID = 1944, name = DUNGEON_FLOOR_HELLFIRERAMPARTS1 .. " " .. "[" .. LEVEL .. ": " .. "60-62]", type = "Dungeon", showInZone = true, showOnContinent = false, showOnMinimap = false } -- Hellfire Ramoarts
                    nodes[1944][47025203] = { mnID = 1944, name = DUNGEON_FLOOR_THESHATTEREDHALLS1 .. " " .. "[" .. LEVEL .. ": " .. "69-70]", type = "Dungeon", showInZone = true, showOnContinent = false, showOnMinimap = false } -- The Shattered Halls  
                end

            
            -- Outland Raids
                if self.db.profile.showZoneRaids then
                    nodes[1953][73806380] = { mnID = 1953, name = DUNGEON_FLOOR_TEMPESTKEEP1 .. " " .. "[" .. LEVEL .. ": " .. "70]", type = "Raid", showInZone = true, showOnContinent = false, showOnMinimap = false } -- The Eye  
                    nodes[1948][71004660] = { mnID = 1948, name = L["Black Temple"] .. " " .. "[" .. LEVEL .. ": " .. "70]", type = "Raid", showInZone = true, showOnContinent = false, showOnMinimap = false } -- Black Temple 
                    nodes[1949][69302370] = { mnID = 1949, name = DUNGEON_FLOOR_GRUULSLAIR1 .. " " .. "[" .. LEVEL .. ": " .. "70]", type = "Raid", showInZone = true, showOnContinent = false, showOnMinimap = false } -- Gruul's Lairend
                    nodes[1944][46555286] = { mnID = 1944, name = DUNGEON_FLOOR_MAGTHERIDONSLAIR1 .. " " .. "[" .. LEVEL .. ": " .. "70]", type = "Raid", showInZone = true, showOnContinent = false, showOnMinimap = false } -- Hellfire Ramparts, The Blood Furnace, The Shattered Halls, Magtheridon's Lair 
                end
            
            
                -- Outland Multiple
                if self.db.profile.showZoneMultiple then
                    nodes[1946][50104095] = { mnID = 1946, name = "", dnID = DUNGEON_FLOOR_COILFANGRESERVOIR1 .. " " .. "[" .. LEVEL .. ": " .. "70]" .. "\n" .. DUNGEON_FLOOR_THESTEAMVAULT1 .. " " .. "[" .. LEVEL .. ": " .. "68-70]" .. "\n" .. DUNGEON_FLOOR_THESLAVEPENS1 .. " " .. "[" .. LEVEL .. ": " .. "62-64]" .. "\n" .. DUNGEON_FLOOR_THEUNDERBOG1 .. " " .. "[" .. LEVEL .. ": " .. "63-65]", type = "MultipleM", showInZone = true, showOnContinent = false, showOnMinimap = false } -- Slave Pens, The Steamvault, The Underbog, Serpentshrine Cavern
                end
