    ...
    if not db.activate.HideMapNote then
        ...
        -- Kalimdor
            if self.db.profile.showCosmosKalimdor then
                ...
                nodes[946][39007850] = { mnID = 12, id = { 233, 230, 241, 234, 68, 69, 70, 67 }, name = TOOLTIP_BATTLE_PET .. " " .. LFG_TYPE_DUNGEON, type = "Dungeon", showInZone = true } -- Dungeons
                nodes[946][39008300] = { mnID = 12, name = "", type = "Portal", showInZone = true, TransportName = ns.Silithus .. "\n" .. " ==> " .. ns.Zandalar .. "\n" .. " ==> " .. ns.Boralus .. "\n\n" .. ns.CavernsOfTime .. "\n" .. " ==> " .. ns.Orgrimmar .. "\n" .. " ==> " .. ns.Stormwind .. "\n\n" .. ns.Hyjal .. "\n" .. " ==> " .. ns.Orgrimmar .. "\n" .. " ==> " .. ns.Stormwind .. "\n\n" .. ns.Darkshore .. "\n" .. " ==> " .. ns.Zandalar .. "\n" .. " ==> " .. ns.Boralus .. "\n\n" .. "\n" .. ns.Orgrimmar .. " - " .. FACTION_HORDE .. "\n" .. L["Portalroom"] .. "\n" .. " ==> " .. ns.Silvermoon .. "\n" .. " ==> " .. ns.Valdrakken .. "\n" .. " ==> " .. ns.Oribos .. "\n" .. " ==> " .. ns.Azsuna .. "\n" .. " ==> " .. ns.Zuldazar .. "\n" .. " ==> " .. ns.Shattrath .. "\n" .. " ==> " .. ns.Dalaran .. "\n" .. " ==> " .. ns.CavernsOfTime.. "\n" .. " ==> " .. ns.BlastedLands .. "\n" .. " ==> " .. ns.Dornogal .. "\n\n" .. L["Portals"] .. "\n" .. " ==> " .. ns.Hyjal .. "\n" .. " ==> " .. ns.TwilightHighlands .. "\n" .. " ==> " .. ARTIFACT_SHAMAN_TITLECARD_DEEPHOLM .. "\n" .. " ==> " .. ns.Vashjir .. "\n" .. " ==> " .. ns.Uldum .. "\n" .. " ==> " .. DUNGEON_FLOOR_TOLBARADWARLOCKSCENARIO0 .. "\n" .. " ==> " .. DUNGEON_FLOOR_SURAMARRAID3 .. "\n" .. " ==> " .. POSTMASTER_LETTER_THUNDERTOTEM .. "\n\n" .. ns.Darnassus .. " - " .. FACTION_ALLIANCE .. "\n" .. L["Portals"] .. "\n" .. " ==> " .. ns.Ruttheran .. "\n" .. " ==> " .. ns.Exodar .. "\n" .. " ==> " .. ns.HellfirePeninsula .. "\n\n" .. ns.Exodar .. "\n" .. " ==> " .. ns.Stormwind} -- Portals 
                nodes[946][39008750] = { mnID = 75, id = { 187 }, type = "LFR", showInZone = true, name = ns.Auridormi .. "\n" .. L["Registrant"] .. " - " .. RAID_FINDER .. "\n" .. " " } -- LFR
                nodes[946][39009200] = { mnID = 12, name = "", type = "HZeppelin", showInZone = true, TransportName = FACTION_HORDE .. " " .. L["Zeppelin"] .. ":\n\n" .. ns.ThunderBluff .. "\n" .. " ==> " .. ns.Orgrimmar .. "\n\n" .. ns.Durotar .. "\n" .. " ==> " .. ns.TheWakingShores} -- Zeppelin
                nodes[946][39009650] = { mnID = 12, name = "", type = "Ship", showInZone = true, TransportName = FACTION_NEUTRAL .. " " .. L["Ship"].. ":\n" .. ns.Ratchet .. "\n" .. " ==> " .. ns.BootyBay .. "\n\n" .. FACTION_HORDE .. ":\n" .. ns.EchoIsles .. "\n" .. " ==> " .. ns.Zandalar .. "\n\n" .. FACTION_ALLIANCE .. ":\n" .. ns.DustwallowMarsh .. "\n" .. " ==> " .. POSTMASTER_LETTER_WETLANDS} -- Ship
            end
        ...
        if self.db.profile.showCosmosEasternKingdom then
                ...
                nodes[946][42607850] = { mnID = 13, id = { 249, 77, 65, 76, 64, 246, 236, 71, 231, 237, 63, 73, 66, 228, 229, 559, 860, 1197, 239, 311, 316, 238 }, name = TOOLTIP_BATTLE_PET .. " " .. LFG_TYPE_DUNGEON, type = "Dungeon", showInZone = true } -- Dungeons
                nodes[946][42608300] = { mnID = 1978, name = "", type = "Portal", showInZone = true, TransportName = ns.ArathiHighlands .. "\n" .. " ==> " .. ns.Zandalar .. "\n" .. " ==> " .. ns.Boralus .. "\n\n" .. DUNGEON_FLOOR_TOLBARADWARLOCKSCENARIO0 .. "\n" .. " ==> " .. ns.Orgrimmar .. "\n" .. " ==> " .. ns.Stormwind .. "\n\n" .. ns.TwilightHighlands .. "\n" .. " ==> " .. ns.Orgrimmar .. "\n" .. " ==> " .. ns.Stormwind .. "\n\n" .. ns.BlastedLands .. "\n" .. " ==> " .. ns.Orgrimmar .. "\n" .. " ==> " .. ns.Stormwind .. "\n" .. " ==> " .. ns.DarkPortal .. " - " .. ns.Ashran .. "\n\n" .. "\n" .. ns.Undercity .. " - " .. FACTION_HORDE .. "\n" .. " ==> " .. ns.HellfirePeninsula .. "\n\n" .. ns.RuinsofLordaeron  .. " / " .. ns.TirisfalGlades .. "\n" ..  " ==> " .. ns.Orgrimmar .. "\n" .. " ==> " .. ns.Gromgol .. "\n" .. " ==> " .. ns.HowlingFjord .. "\n" .. " ==> " .. ns.Silvermoon .. "\n\n" .. ns.Silvermoon .. "\n" ..  " ==> " .. ns.Orgrimmar .. "\n" .. " ==> " .. ns.RuinsofLordaeron .. "\n" .. " " .. "\n\n" .. ns.Stormwind .. " - " .. FACTION_ALLIANCE .. "\n\n" .. L["Portalroom"] .. "\n" .. " ==> " .. ns.Ashran .. "\n" .. " ==> " .. ns.Valdrakken .. "\n" .. " ==> " .. ns.Boralus .. "\n" .. " ==> " .. ns.Oribos .. "\n" .. " ==> " .. ns.Azsuna .. "\n" .. " ==> " .. ns.Shattrath .. "\n" .. " ==> " .. ns.JadeForest .. "\n" .. " ==> " .. ns.Dalaran .. "\n" .. " ==> " .. ns.CavernsOfTime .. "\n" .. " ==> " .. ns.Exodar .. "\n" ..  " ==> " .. ns.Amirdrassil .. "\n" .. " ==> " .. ns.BlastedLands .. "\n" .. " ==> " .. ns.Dornogal .. "\n\n" .. L["Portals"] .. "\n" .. " ==> " .. ns.Uldum .. "\n" .. " ==> " .. ns.Vashjir .. "\n" .. " ==> " .. ns.Hyjal .. "\n" .. " ==> " .. ARTIFACT_SHAMAN_TITLECARD_DEEPHOLM .. "\n" .. " ==> " .. ns.TwilightHighlands .. "\n" .. " ==> " .. DUNGEON_FLOOR_TOLBARADWARLOCKSCENARIO0 } -- Portals 
                ...
                nodes[946][42609200] = { mnID = 13, name = "", type = "HZeppelin", showInZone = true, TransportName = FACTION_HORDE .. " " .. L["Zeppelin"] .. ":\n\n" .. ns.Gromgol .. "\n" .. " ==> " .. ns.Orgrimmar } -- Zeppelin
                nodes[946][42609650] = { mnID = 13, name = "", type = "Ship", showInZone = true, TransportName = FACTION_ALLIANCE .. " " .. L["Ship"].. ":\n\n" .. ns.Stormwind .. "\n" .. " ==> " .. ns.Boralus .. "\n" .. " ==> " .. ns.TheWakingShores .. "\n" .. " ==> " .. POSTMASTER_LETTER_VALIANCEKEEP .. "\n\n" .. POSTMASTER_LETTER_WETLANDS .. "\n" .. " ==> " .. ns.DustwallowMarsh .. "\n" .. " ==> " .. ns.HowlingFjord .. "\n\n" .. FACTION_NEUTRAL .. ":\n\n" .. ns.BootyBay .. "\n" .. " ==> " .. ns.Ratchet } -- Ship 
            end
        ...
        -- Northrend
            if self.db.profile.showCosmosNorthrend then
                ...
                nodes[946][46208300] = { mnID = 113, name = "", type = "Portal", showInZone = true, TransportName = ns.Dalaran .. " " .. L["Portals"] .. "\n" .. " ==> " .. ns.Orgrimmar .. "\n" .. " ==> " .. ns.Stormwind .. "\n\n" .. ns.Wintergrasp .. " " .. L["Portal"] .. "\n" .. " ==> " .. ns.Dalaran } -- Portals 
                nodes[946][46208750] = { mnID = 627, id = { 875, 786, 768, 861, 946 }, type = "LFR", showInZone = true, name = ns.ArchmageTimear .. "\n" .. L["Registrant"] .. " - " .. RAID_FINDER .. "\n" .. " " } -- LFR
                nodes[946][46209200] = { mnID = 114, name = "", type = "HZeppelin", showInZone = true, TransportName = FACTION_HORDE .. " " .. L["Zeppelin"] .. ":\n\n" .. POSTMASTER_LETTER_WARSONGHOLD .. "\n" .. " ==> " .. ns.Orgrimmar } -- Zeppelin
                nodes[946][46209650] = { mnID = 113, name = "", type = "Ship", showInZone = true, TransportName = FACTION_ALLIANCE .. " " .. L["Ship"].. ":\n\n" .. POSTMASTER_LETTER_VALIANCEKEEP .. "\n" .. " ==> " .. ns.Stormwind .. "\n\n" .. ns.HowlingFjord .. "\n" .. " ==> " .. POSTMASTER_LETTER_WETLANDS .. "\n\n" .. FACTION_NEUTRAL .. ":\n\n" .. ns.BoreanTundra .. "\n" .. " ==> " .. POSTMASTER_LETTER_MOAKI .. "\n\n" .. POSTMASTER_LETTER_MOAKI .. "\n" .. " ==> " .. POSTMASTER_LETTER_KAMAGUA .. "\n" .. " ==> " .. ns.BoreanTundra .. "\n\n" .. POSTMASTER_LETTER_KAMAGUA .. "\n" .. " ==> " .. POSTMASTER_LETTER_MOAKI} -- Ship
            end
        ...
        -- Pandaria
            if self.db.profile.showCosmosPandaria then
                ...
                nodes[946][49808300] = { mnID = 424, name = "", type = "Portal", showInZone = true, TransportName = ns.JadeForest .. " " .. L["Portals"]  .. "\n" .. " ==> " .. ns.Orgrimmar .. "\n" .. " ==> " .. ns.Stormwind .. "\n\n" .. ns.ValeOfEternalBlossoms .. " " .. L["Portals"] .. "\n" .. " ==> " .. ns.Orgrimmar .. "\n" .. " ==> " .. ns.Stormwind .. "\n\n" .. ns.ShadoPanGarison .. " " .. L["Portal"] .. "\n" .. " ==> " .. ns.IsleOfThunder .. "\n\n" .. ns.IsleOfThunder .. " " .. L["Portals"] .. "\n" .. " ==> " .. ns.ShadoPanGarison } -- Portals 
                nodes[946][49808750] = { mnID = 390, id = { 317, 330, 362, 320 }, type = "LFR", showInZone = true, name = ns.LorewalkerHan .. "\n" .. L["Registrant"] .. " - " .. RAID_FINDER .. "\n" .. " " } -- LFR
            end
        ...
        -- Broken Isles
            if self.db.profile.showCosmosBrokenIsles then
                ...
                nodes[946][53408750] = { mnID = 627, id = { 875, 786, 768, 861, 946 }, type = "LFR", showInZone = true, name = ns.ArchmageTimear .. "\n" .. L["Registrant"] .. " - " .. RAID_FINDER .. "\n" .. " " } -- LFR
            end
        ...
        -- Zandalar
            if self.db.profile.showCosmosZandalar then
                ...
                nodes[946][57008300] = { mnID = 875, name = "", type = "Portal", showInZone = true, TransportName = ns.Dazaralor .. "\n" .. L["Portalroom"] .. "\n" .. " ==> " .. ns.Silvermoon .. "\n" .. " ==> " .. ns.Orgrimmar .. "\n" .. " ==> " .. ns.ThunderBluff .. "\n" .. " ==> " .. ns.Silithus .. "\n" .. " ==> " .. ns.Nazjatar .. "\n\n" .. L["Portals"] .. "\n" .. " ==> " .. ns.ArathiHighlands .. "\n" .. " ==> " .. ns.Darkshore } -- Portals 
                nodes[946][57008750] = { mnID = 1164, id = { 1176, 1031, 1179, 1036 }, type = "LFR", showInZone = true, name = ns.Eppu .. "\n" .. L["Registrant"] .. " - " .. RAID_FINDER .. "\n" .. " " } -- LFR
                nodes[946][57009200] = { mnID = 875, name = "", type = "HShip", showInZone = true, TransportName = FACTION_HORDE .. " " .. L["Ship"].. ":\n\n" .. ns.Zandalar .. "\n" .. " ==> " .. ns.EchoIsles } -- Ship
                nodes[946][57009650] = { mnID = 875, name = "", type = "TravelA", showInZone = true, TransportName = FACTION_ALLIANCE .. " " .. L["Travel"] .. ":\n\n" .. ns.DeshaStormwallow .. "\n" .. " " .. ns.Nazmir .. " ==> " .. ns.Boralus .. "\n\n" .. ns.BarnardTheSmasherBayswort .. "\n" .. " " .. ns.Voldun .. " ==> " .. ns.Boralus .. "\n\n" .. ns.DariaSmithson .. "\n" .. " " .. ns.Zuldazar .. " ==> " .. ns.Boralus } -- Transport
            end
        ...
        -- Kul'Tiras
            if self.db.profile.showCosmosKulTiras then
                ...
                nodes[946][60608300] = { mnID = 876, name = "", type = "Portal", showInZone = true, TransportName = ns.Boralus .. "\n" .. L["Portalroom"] .. "\n" .. " ==> " .. ns.Stormwind .. "\n" .. " ==> " .. ns.Silithus .. "\n" .. " ==> " .. ns.Exodar .. "\n" .. " ==> " .. ns.Ironforge .. "\n\n" .. L["Portals"] .. "\n" .. " ==> " .. ns.ArathiHighlands .. "\n" .. " ==> " .. ns.Darkshore } -- Portals 
                nodes[946][60608750] = { mnID = 1161, id = { 1176, 1031, 1179, 1036 }, type = "LFR", showInZone = true, name = ns.Kiku .. "\n" .. L["Registrant"] .. " - " .. RAID_FINDER .. "\n" .. " " } -- LFR
                nodes[946][61009200] = { mnID = 876, name = "", type = "AShip", showInZone = true, TransportName = FACTION_ALLIANCE .. " " .. L["Ship"].. ":\n\n" .. ns.Boralus .. "\n" .. " ==> " .. ns.Stormwind } -- Ship
                nodes[946][61009650] = { mnID = 876, name = "", type = "TravelH", showInZone = true, TransportName = FACTION_HORDE .. " " .. L["Travel"] .. ":\n\n" .. ns.CaptainKrooz .. " " .. "\n" .. " " .. SPLASH_BATTLEFORAZEROTH_8_2_0_FEATURE1_TITLE .. " ==> " .. ns.Dazaralor .. "\n\n" .. ns.Swellthrasher .. "\n" .. " " .. ns.Drustvar .. " ==> " .. ns.Zuldazar .. "\n\n" .. ns.GrokSeahandler .. "\n" .. " " .. ns.StormsongValley .. " ==> " .. ns.Zuldazar .. "\n\n" .. ns.ErulDawnbrook .. "\n" .. " " .. ns.TiragardeSound .. " ==> " .. ns.Zuldazar } -- Transport
            end
        ...
        -- Dragonflight    
            if self.db.profile.showCosmosDragonIsles then
                ...
                nodes[946][64208300] = { mnID = 1978, name = "", type = "Portal", showInZone = true, TransportName = ns.Valdrakken .. " " .. L["Portals"] .. "\n" .. " ==> " .. ns.EmeraldDream .. "\n" .. " ==> " .. ns.Badlands .. "\n".." ==> " .. ns.Stormwind .. "\n" .. " ==> " .. ns.Orgrimmar .. "\n\n" .. ns.Amirdrassil .. "\n" .. L["Portals"] .. "\n" .. " ==> " .. ns.Stormwind .. "\n" .. " ==> " .. ns.Darkshore .. "\n" .. " ==> " .. ns.Hyjal  .. "\n" .. " ==> " .. POSTMASTER_LETTER_LORLATHIL} -- Portals 
                nodes[946][64609200] = { mnID = 2022, name = "", type = "HZeppelin", showInZone = true, TransportName = FACTION_HORDE .. " " .. L["Zeppelin"] .. ":\n\n" .. ns.TheWakingShores .. "\n" .. " ==> " .. ns.Orgrimmar } -- Zeppelin
                nodes[946][64609650] = { mnID = 2022, name = "", type = "AShip", showInZone = true, TransportName = FACTION_ALLIANCE .. " " .. L["Ship"].. ":\n\n" .. ns.TheWakingShores .. "\n" .. " ==> " .. ns.Stormwind } -- Ship
            end
        ...
        -- The War Within    
            if self.db.profile.showCosmosKhazAlgar then
                ...
                nodes[946][67808300] = { mnID = 2274, name = "", type = "Portal", showInZone = true, TransportName = ns.Dornogal .. " " .. L["Portals"] .. "\n" .. " ==> " .. ns.Stormwind .. "\n" .. " ==> " .. ns.Orgrimmar .. "\n\n" .. L["The Timeways"] .. " " .. L["Portals"] .. "\n" .. " ==> " .. ns.Revendreth .. "\n" .. " ==> " .. ns.Tazavesh } -- Portals 
            end
