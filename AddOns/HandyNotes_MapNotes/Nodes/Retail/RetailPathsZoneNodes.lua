...
ns._currentSourceFile = "RetailPathsZoneNodes.lua"
        ...
        if db.activate.ZoneGeneral then
            ...
            if self.db.profile.showZoneKalimdor then
                ...
                if self.db.profile.showZonePaths then
                    ...
                    nodes[71][25366609] = { name = "", dnID = "|cffffffff" .. L["Path"], mnID = 1527, type = "PathL", showInZone = true, showOnContinent = false, showOnMinimap = false }
                    ...
                    nodes[1527][68612240] = { name = "", dnID = "|cffffffff" .. L["Path"], mnID = 71, type = "PathR", showInZone = true, showOnContinent = false, showOnMinimap = false }
            ...
            if self.db.profile.showZoneEasternKingdom then
                ...
                if self.db.profile.showZonePaths then
                    ...
                    if ns.Addon.db.profile.activate.SwapButtons then -- Swap Button
                        nodes[22][22855825] = { name = "", dnID = "|cffffffff" .. L["Path"] .. "\n" .. KEY_BUTTON2 .. " • " .. ns.TirisfalGlades .. " " .. ZONE .. " " .. ACTION_SPELL_DAMAGE_MASTER .. "\n" .. KEY_BUTTON3 .. " • " .. ns.TirisfalGlades .. " " .. ZONE .. " " .. ACTION_SPELL_CAST_SUCCESS_MASTER, mnID = 18, mnID2 = 2070, type = "PathLO", showInZone = true, showOnContinent = false, showOnMinimap = false }
                        nodes[21][65540646] = { name = "", dnID = "|cffffffff" .. L["Path"] .. "\n" .. KEY_BUTTON2 .. " • " .. ns.TirisfalGlades .. " " .. ZONE .. " " .. ACTION_SPELL_DAMAGE_MASTER .. "\n" .. KEY_BUTTON3 .. " • " .. ns.TirisfalGlades .. " " .. ZONE .. " " .. ACTION_SPELL_CAST_SUCCESS_MASTER, mnID = 18, mnID2 = 2070, type = "PathRO", showInZone = true, showOnContinent = false, showOnMinimap = false }
                        nodes[25][41950592] = { name = "", dnID = "|cffffffff" .. L["Path"] .. "\n" .. KEY_BUTTON2 .. " • " .. ns.TirisfalGlades .. " " .. ZONE .. " " .. ACTION_SPELL_DAMAGE_MASTER .. "\n" .. KEY_BUTTON3 .. " • " .. ns.TirisfalGlades .. " " .. ZONE .. " " .. ACTION_SPELL_CAST_SUCCESS_MASTER, mnID = 18, mnID2 = 2070, type = "PathLO", showInZone = true, showOnContinent = false, showOnMinimap = false }
                    ...
                    nodes[18][62206431] = { name = "", dnID = "|cffffffff" .. L["Entrance"], mnID = 90, type = "PathU", showInZone = true, showOnContinent = false, showOnMinimap = false }
                    nodes[18][51107073] = { name = "", dnID = "|cffffffff" .. L["Entrance"], mnID = 90, type = "PathLU", showInZone = true, showOnContinent = false, showOnMinimap = false }
                    ...
                    nodes[55][68711872] = { name = "", dnID = "|cffffffff" .. L["Path"], mnID = 52, type = "PathLO", showInZone = true, showOnContinent = false, showOnMinimap = false }
            ...
            if self.db.profile.showZoneDraenor then
                ...
                if self.db.profile.showZonePaths then
                    nodes[525][55407524] = { name = "", dnID = "|cffffffff" .. L["Path"], mnID = 550, type = "PathU", showInZone = true, showOnContinent = false, showOnMinimap = false }
                    nodes[525][49676013] = { name = "", dnID = "|cffffffff" .. L["Entrance"], mnID = 590, type = "PathLU", showInZone = true, showOnContinent = false, showOnMinimap = false }
                    nodes[525][87697265] = { name = "", dnID = "|cffffffff" .. L["Path"], mnID = 543, type = "PathRO", showInZone = true, showOnContinent = false, showOnMinimap = false }
                    nodes[525][86997529] = { name = "", dnID = "|cffffffff" .. L["Path"], mnID = 543, mnID2 = 535, type = "PathRU", showInZone = true, showOnContinent = false, showOnMinimap = false }
                    nodes[543][36717761] = { name = "", dnID = "|cffffffff" .. L["Path"], mnID = 525, type = "PathLU", showInZone = true, showOnContinent = false, showOnMinimap = false }
                    nodes[543][42239401] = { name = "", dnID = "|cffffffff" .. L["Path"], mnID = 535, type = "PathLU", showInZone = true, showOnContinent = false, showOnMinimap = false }
                    nodes[543][48199273] = { name = "", dnID = "|cffffffff" .. L["Path"], type = "PathRU", mnID = 534, showInZone = true, showOnContinent = false, showOnMinimap = false }
                    nodes[534][15634268] = { name = "", dnID = "|cffffffff" .. L["Path"], mnID = 543, type = "PathLO", showInZone = true, showOnContinent = false, showOnMinimap = false }
                    nodes[534][07035272] = { name = "", dnID = "|cffffffff" .. L["Path"], mnID = 535, type = "PathL", showInZone = true, showOnContinent = false, showOnMinimap = false }
                    nodes[535][72130859] = { name = "", dnID = "|cffffffff" .. L["Path"], mnID = 534, type = "PathR", showInZone = true, showOnContinent = false, showOnMinimap = false }
                    nodes[535][66120189] = { name = "", dnID = "|cffffffff" .. L["Path"], mnID = 525, type = "PathO", showInZone = true, showOnContinent = false, showOnMinimap = false }
                    nodes[535][68350202] = { name = "", dnID = "|cffffffff" .. L["Path"], mnID = 543, type = "PathRO", showInZone = true, showOnContinent = false, showOnMinimap = false }
                    nodes[535][57229329] = { name = "", dnID = "|cffffffff" .. L["Path"], mnID = 542, type = "PathU", showInZone = true, showOnContinent = false, showOnMinimap = false }
                    nodes[535][30475779] = { name = "", dnID = "|cffffffff" .. L["Path"], mnID = 550, type = "PathLO", showInZone = true, showOnContinent = false, showOnMinimap = false }
                    nodes[535][84816007] = { name = "", dnID = "|cffffffff" .. L["Path"], mnID = 539, type = "PathRU", showInZone = true, showOnContinent = false, showOnMinimap = false }
                    nodes[535][40429694] = { name = "", dnID = "|cffffffff" .. L["Path"], mnID = 542, type = "PathRU", showInZone = true, showOnContinent = false, showOnMinimap = false }
                    nodes[535][70778113] = { name = "", dnID = "|cffffffff" .. L["Path"], mnID = 542, type = "PathU", showInZone = true, showOnContinent = false, showOnMinimap = false }
                    nodes[539][19391194] = { name = "", dnID = "|cffffffff" .. L["Path"], mnID = 535, type = "PathLO", showInZone = true, showOnContinent = false, showOnMinimap = false }
                    nodes[539][32422372] = { name = "", dnID = "|cffffffff" .. L["Entrance"], mnID = 582, type = "PathO", showInZone = true, showOnContinent = false, showOnMinimap = false }
                    nodes[550][87366633] = { name = "", dnID = "|cffffffff" .. L["Path"], mnID = 535, type = "PathRU", showInZone = true, showOnContinent = false, showOnMinimap = false }
                    nodes[550][87691535] = { name = "", dnID = "|cffffffff" .. L["Path"], mnID = 525, type = "PathO", showInZone = true, showOnContinent = false, showOnMinimap = false }
                    nodes[542][23172214] = { name = "", dnID = "|cffffffff" .. L["Path"], mnID = 535, type = "PathLO", showInZone = true, showOnContinent = false, showOnMinimap = false }
                    nodes[542][36971399] = { name = "", dnID = "|cffffffff" .. L["Path"], mnID = 535, type = "PathLO", showInZone = true, showOnContinent = false, showOnMinimap = false }
                    nodes[542][50630699] = { name = "", dnID = "|cffffffff" .. L["Path"], mnID = 535, type = "PathO", showInZone = true, showOnContinent = false, showOnMinimap = false }
                    nodes[542][62471259] = { name = "", dnID = "|cffffffff" .. L["Path"], mnID = 535, type = "PathLO", showInZone = true, showOnContinent = false, showOnMinimap = false }
                    nodes[542][64112277] = { name = "", dnID = "|cffffffff" .. L["Path"], mnID = 535, mnID2 = 539, type = "PathRO", showInZone = true, showOnContinent = false, showOnMinimap = false }
                    nodes[542][69512694] = { name = "", dnID = "|cffffffff" .. L["Path"], mnID = 539, type = "PathRU", showInZone = true, showOnContinent = false, showOnMinimap = false }
                end
            ...
            if self.db.profile.showZoneBrokenIsles then
                ...
                if self.db.profile.showZonePaths then
                    nodes[630][66691977] = { name = "", dnID = "|cffffffff" .. L["Path"], mnID = 680, type = "PathO", showInZone = true, showOnContinent = false, showOnMinimap = false }
                    nodes[630][52810822] = { name = "", dnID = "|cffffffff" .. L["Path"], mnID = 641, type = "PathO", showInZone = true, showOnContinent = false, showOnMinimap = false }
                    nodes[680][22616344] = { name = "", dnID = "|cffffffff" .. L["Path"], mnID = 630, type = "PathU", showInZone = true, showOnContinent = false, showOnMinimap = false }
                    nodes[680][15542497] = { name = "", dnID = "|cffffffff" .. L["Path"], mnID = 641, type = "PathL", showInZone = true, showOnContinent = false, showOnMinimap = false }
                    nodes[680][65542842] = { name = "", dnID = "|cffffffff" .. L["Path"], mnID = 634, type = "PathO", showInZone = true, showOnContinent = false, showOnMinimap = false }
                    nodes[641][58569047] = { name = "", dnID = "|cffffffff" .. L["Path"], mnID = 630, type = "PathU", showInZone = true, showOnContinent = false, showOnMinimap = false }
                    nodes[641][67666636] = { name = "", dnID = "|cffffffff" .. L["Path"], mnID = 680, type = "PathR", showInZone = true, showOnContinent = false, showOnMinimap = false }
                    nodes[641][68801996] = { name = "", dnID = "|cffffffff" .. L["Path"], mnID = 650, type = "PathRO", showInZone = true, showOnContinent = false, showOnMinimap = false }
                    nodes[650][26406060] = { name = "", dnID = "|cffffffff" .. L["Path"], mnID = 641, type = "PathU", showInZone = true, showOnContinent = false, showOnMinimap = false }
                    nodes[650][58386411] = { name = "", dnID = "|cffffffff" .. L["Path"], mnID = 634, type = "PathRU", showInZone = true, showOnContinent = false, showOnMinimap = false }
                    nodes[634][27023930] = { name = "", dnID = "|cffffffff" .. L["Path"], mnID = 650, type = "PathLO", showInZone = true, showOnContinent = false, showOnMinimap = false }
                    nodes[634][32737787] = { name = "", dnID = "|cffffffff" .. L["Path"], mnID = 680, type = "PathLU", showInZone = true, showOnContinent = false, showOnMinimap = false }
                end
            ...
            if self.db.profile.showZoneZandalar then
                ...
                if self.db.profile.showZonePaths then
                    nodes[862][57921715] = { name = "", dnID = "|cffffffff" .. L["Path"], mnID = 863, type = "PathO", showInZone = true, showOnContinent = false, showOnMinimap = false }
                    nodes[862][53591704] = { name = "", dnID = "|cffffffff" .. L["Path"], mnID = 863, type = "PathO", showInZone = true, showOnContinent = false, showOnMinimap = false }
                    nodes[862][46232046] = { name = "", dnID = "|cffffffff" .. L["Path"], mnID = 863, type = "PathLO", showInZone = true, showOnContinent = false, showOnMinimap = false }
                    nodes[863][28698998] = { name = "", dnID = "|cffffffff" .. L["Path"], mnID = 862, type = "PathRU", showInZone = true, showOnContinent = false, showOnMinimap = false }
                    nodes[863][43368745] = { name = "", dnID = "|cffffffff" .. L["Path"], mnID = 862, type = "PathU", showInZone = true, showOnContinent = false, showOnMinimap = false }
                    nodes[863][50268766] = { name = "", dnID = "|cffffffff" .. L["Path"], mnID = 862, type = "PathU", showInZone = true, showOnContinent = false, showOnMinimap = false }
                    nodes[863][19027147] = { name = "", dnID = "|cffffffff" .. L["Path"], mnID = 864, type = "PathLO", showInZone = true, showOnContinent = false, showOnMinimap = false }
                    nodes[863][24833059] = { name = "", dnID = "|cffffffff" .. L["Path"], mnID = 864, type = "PathLO", showInZone = true, showOnContinent = false, showOnMinimap = false }
                    nodes[863][24173389] = { name = "", dnID = "|cffffffff" .. L["Path"], mnID = 864, type = "PathL", showInZone = true, showOnContinent = false, showOnMinimap = false }
                    nodes[864][59267027] = { name = "", dnID = "|cffffffff" .. L["Path"], mnID = 863, type = "PathRU", showInZone = true, showOnContinent = false, showOnMinimap = false }
                    nodes[864][62095156] = { name = "", dnID = "|cffffffff" .. L["Path"], mnID = 863, type = "PathRU", showInZone = true, showOnContinent = false, showOnMinimap = false }
                    nodes[864][66934132] = { name = "", dnID = "|cffffffff" .. L["Path"], mnID = 863, type = "PathRU", showInZone = true, showOnContinent = false, showOnMinimap = false }
                    nodes[864][62534550] = { name = "", dnID = "|cffffffff" .. L["Path"], mnID = 863, type = "PathR", showInZone = true, showOnContinent = false, showOnMinimap = false }
                end
            ...
            if self.db.profile.showZoneKulTiras then
                ...
                if self.db.profile.showZonePaths then
                    nodes[896][69814141] = { name = "", dnID = "|cffffffff" .. L["Path"], mnID = 895, type = "PathRU", showInZone = true, showOnContinent = false, showOnMinimap = false }
                    nodes[896][60711551] = { name = "", dnID = "|cffffffff" .. L["Path"], mnID = 895, type = "PathRO", showInZone = true, showOnContinent = false, showOnMinimap = false }
                    nodes[895][53055416] = { name = "", dnID = "|cffffffff" .. L["Path"], mnID = 896, type = "PathL", showInZone = true, showOnContinent = false, showOnMinimap = false }
                    nodes[895][43543107] = { name = "", dnID = "|cffffffff" .. L["Path"], mnID = 896, type = "PathLU", showInZone = true, showOnContinent = false, showOnMinimap = false }
                    nodes[895][66350874] = { name = "", dnID = "|cffffffff" .. L["Path"], mnID = 942, type = "PathO", showInZone = true, showOnContinent = false, showOnMinimap = false }
                    nodes[895][93794719] = { name = "", dnID = "|cffffffff" .. L["Path"], mnID = 1169, type = "PathR", showInZone = true, showOnContinent = false, showOnMinimap = false }
                    nodes[1169][08565967] = { name = "", dnID = "|cffffffff" .. L["Path"], mnID = 895, type = "PathL", showInZone = true, showOnContinent = false, showOnMinimap = false }
                    nodes[942][58958917] = { name = "", dnID = "|cffffffff" .. L["Path"], mnID = 895, type = "PathU", showInZone = true, showOnContinent = false, showOnMinimap = false }
                end
            ...
            if self.db.profile.showZoneShadowlands then
                ...
                if self.db.profile.showZonePaths then
                    nodes[1543][63747647] = { name = "", dnID = "|cffffffff" .. L["Path"], mnID = 1961, type = "PathRU", showInZone = true, showOnContinent = false, showOnMinimap = false }
                    nodes[1543][51708980] = { name = "", dnID = "|cffffffff" .. L["Path"], mnID = 1961, type = "PathU", showInZone = true, showOnContinent = false, showOnMinimap = false }
                    nodes[1961][40002586] = { name = "", dnID = "|cffffffff" .. L["Path"], mnID = 1543, type = "PathO", showInZone = true, showOnContinent = false, showOnMinimap = false }
                    nodes[1961][58700950] = { name = "", dnID = "|cffffffff" .. L["Path"], mnID = 1543, type = "PathLO", showInZone = true, showOnContinent = false, showOnMinimap = false }
                end
            ...
            if self.db.profile.showZoneDragonIsles then
                ...
                if self.db.profile.showZonePaths then
                    nodes[2022][48878853] = { name = "", dnID = "|cffffffff" .. L["Path"], mnID = 2023, type = "PathRU", showInZone = true, showOnContinent = false, showOnMinimap = false }
                    nodes[2022][28289215] = { name = "", dnID = "|cffffffff" .. L["Path"], mnID = 2023, type = "PathLU", showInZone = true, showOnContinent = false, showOnMinimap = false }
                    nodes[2023][58802172] = { name = "", dnID = "|cffffffff" .. L["Path"], mnID = 2022, type = "PathL", showInZone = true, showOnContinent = false, showOnMinimap = false }
                    nodes[2023][79971463] = { name = "", dnID = "|cffffffff" .. L["Path"], mnID = 2022, type = "PathO", showInZone = true, showOnContinent = false, showOnMinimap = false }
                    nodes[2023][43426945] = { name = "", dnID = "|cffffffff" .. L["Path"], mnID = 2024, type = "PathU", showInZone = true, showOnContinent = false, showOnMinimap = false }
                    nodes[2023][69907861] = { name = "", dnID = "|cffffffff" .. L["Path"], mnID = 2024, type = "PathU", showInZone = true, showOnContinent = false, showOnMinimap = false }
                    nodes[2024][36452263] = { name = "", dnID = "|cffffffff" .. L["Path"], mnID = 2023, type = "PathO", showInZone = true, showOnContinent = false, showOnMinimap = false }
                    nodes[2024][18041786] = { name = "", dnID = "|cffffffff" .. L["Path"], mnID = 2023, type = "PathO", showInZone = true, showOnContinent = false, showOnMinimap = false }
                end
            ...
            if self.db.profile.showZoneKhazAlgar then
                ...
                if self.db.profile.showZonePaths then
                    ...
                    nodes[2255][66521977] = { name = "", dnID = "|cffffffff" .. L["Path"], mnID = 2214, type = "PathRU", showInZone = true, showOnContinent = false, showOnMinimap = false }
                    nodes[2255][23843044] = { name = "", dnID = "|cffffffff" .. L["Path"], mnID = 2215, type = "PathRO", showInZone = true, showOnContinent = false, showOnMinimap = false }
                    nodes[2256][66521977] = { name = "", dnID = "|cffffffff" .. L["Path"], mnID = 2214, type = "PathRU", showInZone = true, showOnContinent = false, showOnMinimap = false }
                    nodes[2256][23843044] = { name = "", dnID = "|cffffffff" .. L["Path"], mnID = 2215, type = "PathRO", showInZone = true, showOnContinent = false, showOnMinimap = false }
                    --nodes[2255][24722251] = { name = "", dnID = "|cffffffff" .. L["Path"], mnID = 2215, type = "PathLO", showInZone = true, showOnContinent = false, showOnMinimap = false }
                    --nodes[2256][24722251] = { name = "", dnID = "|cffffffff" .. L["Path"], mnID = 2215, type = "PathLO", showInZone = true, showOnContinent = false, showOnMinimap = false }
                    nodes[2215][44348066] = { name = "", dnID = "|cffffffff" .. L["Path"], mnID = 2255, type = "PathRU", showInZone = true, showOnContinent = false, showOnMinimap = false }
                    nodes[2215][76744140] = { name = "", dnID = "|cffffffff" .. L["Path"], mnID = 2214, type = "PathRO", showInZone = true, showOnContinent = false, showOnMinimap = false }
                    nodes[2215][73616016] = { name = "", dnID = "|cffffffff" .. L["Path"], mnID = 2255, type = "PathR", showInZone = true, showOnContinent = false, showOnMinimap = false }
                    --nodes[2255][61840352] = { name = "", dnID = "|cffffffff" .. L["Path"], mnID = 2215, type = "PathO", showInZone = true, showOnContinent = false, showOnMinimap = false }
                    nodes[2255][64891374] = { name = "", dnID = "|cffffffff" .. L["Path"], mnID = 2215, type = "PathO", showInZone = true, showOnContinent = false, showOnMinimap = false }
                    nodes[2255][60028522] = { name = "", dnID = "|cffffffff" .. L["Path"], mnID = 2216, type = "PathL", showInZone = true, showOnContinent = false, showOnMinimap = false }
                    --nodes[2256][61840352] = { name = "", dnID = "|cffffffff" .. L["Path"], mnID = 2215, type = "PathO", showInZone = true, showOnContinent = false, showOnMinimap = false }
                    nodes[2256][64891374] = { name = "", dnID = "|cffffffff" .. L["Path"], mnID = 2215, type = "PathO", showInZone = true, showOnContinent = false, showOnMinimap = false }
                    nodes[2256][60028522] = { name = "", dnID = "|cffffffff" .. L["Path"], mnID = 2216, type = "PathL", showInZone = true, showOnContinent = false, showOnMinimap = false }
                    nodes[2216][76885723] = { name = "", dnID = "|cffffffff" .. L["Path"], mnID = 2255, type = "PathR", showInZone = true, showOnContinent = false, showOnMinimap = false }
                    nodes[2216][72666369] = { name = "", dnID = "|cffffffff" .. L["Path"], mnID = 2213, type = "PathL", showInZone = true, showOnContinent = false, showOnMinimap = false }
                    --nodes[2216][67535605] = { name = "", dnID = "|cffffffff" .. L["Path"], mnID = 2213, type = "PathLO", showInZone = true, showOnContinent = false, showOnMinimap = false }
                    nodes[2213][66865477] = { name = "", dnID = "|cffffffff" .. L["Path"], mnID = 2216, type = "PathRU", showInZone = true, showOnContinent = false, showOnMinimap = false }
                    nodes[2255][40366436] = { name = "", dnID = "|cffffffff" .. L["Path"], mnID = 2213, type = "PathRU", showInZone = true, showOnContinent = false, showOnMinimap = false }
                    nodes[2256][40366436] = { name = "", dnID = "|cffffffff" .. L["Path"], mnID = 2213, type = "PathRU", showInZone = true, showOnContinent = false, showOnMinimap = false }
                    nodes[2213][28621909] = { name = "", dnID = "|cffffffff" .. L["Path"], mnID = 2255, type = "PathO", showInZone = true, showOnContinent = false, showOnMinimap = false }
                    nodes[2216][28621909] = { name = "", dnID = "|cffffffff" .. L["Path"] .. "\n" .. DUNGEON_FLOOR_GILNEAS3, mnID = 2255, type = "PathO", showInZone = true, showOnContinent = false, showOnMinimap = false }
                    nodes[2213][64945345] = { name = "", dnID = "|cffffffff" .. L["Path"], mnID = 2216, type = "PathL", showInZone = true, showOnContinent = false, showOnMinimap = false }
                    nodes[2216][58415322] = { name = "", dnID = "|cffffffff" .. L["Path"], mnID = 2213, type = "PathR", showInZone = true, showOnContinent = false, showOnMinimap = false }
                    nodes[2213][61593935] = { name = "", dnID = "|cffffffff" .. L["Path"], mnID = 2216, type = "PathLO", showInZone = true, showOnContinent = false, showOnMinimap = false }
                    nodes[2216][59943702] = { name = "", dnID = "|cffffffff" .. L["Path"], mnID = 2213, type = "PathRU", showInZone = true, showOnContinent = false, showOnMinimap = false }
                    nodes[2216][51813704] = { name = "", dnID = "|cffffffff" .. L["Path"], mnID = 2213, type = "PathO", showInZone = true, showOnContinent = false, showOnMinimap = false }
                    nodes[2216][62832752] = { name = "", dnID = "|cffffffff" .. L["Path"], mnID = 2213, type = "PathLO", showInZone = true, showOnContinent = false, showOnMinimap = false }
                    nodes[2255][54137232] = { name = "", dnID = "|cffffffff" .. L["Path"], mnID = 2216, type = "PathL", showInZone = true, showOnContinent = false, showOnMinimap = false }
                    nodes[2256][54137232] = { name = "", dnID = "|cffffffff" .. L["Path"], mnID = 2216, type = "PathL", showInZone = true, showOnContinent = false, showOnMinimap = false }
                    --nodes[2216][64692900] = { name = "", dnID = "|cffffffff" .. L["Path"], mnID = 2255, type = "PathLO", showInZone = true, showOnContinent = false, showOnMinimap = false }
                    nodes[2216][65912225] = { name = "", dnID = "|cffffffff" .. L["Path"], mnID = 2255, type = "PathRU", showInZone = true, showOnContinent = false, showOnMinimap = false }
                    nodes[2216][64462144] = { name = "", dnID = "|cffffffff" .. L["Path"], mnID = 2216, type = "PathL", showInZone = true, showOnContinent = false, showOnMinimap = false }
                    nodes[2213][36506205] = { name = "", dnID = "|cffffffff" .. L["Path"], mnID = 2216, type = "PathU", showInZone = true, showOnContinent = false, showOnMinimap = false }
                    nodes[2216][38146103] = { name = "", dnID = "|cffffffff" .. L["Path"], mnID = 2213, type = "PathU", showInZone = true, showOnContinent = false, showOnMinimap = false }
                    nodes[2213][43398893] = { name = "", dnID = "|cffffffff" .. L["Path"], mnID = 2216, type = "PathLO", showInZone = true, showOnContinent = false, showOnMinimap = false }
                    nodes[2216][44506565] = { name = "", dnID = "|cffffffff" .. L["Path"], mnID = 2213, type = "PathU", showInZone = true, showOnContinent = false, showOnMinimap = false }
                    --nodes[2213][46747707] = { name = "", dnID = "|cffffffff" .. L["Path"], mnID = 2213, type = "PathLU", showInZone = true, showOnContinent = false, showOnMinimap = false }
                    nodes[2215][73835929] = { name = "", dnID = "|cffffffff" .. L["Path"], mnID = 2255, type = "PathRO", showInZone = true, showOnContinent = false, showOnMinimap = false }
                    nodes[2248][52915233] = { name = "", dnID = "|cffffffff" .. L["Entrance"], mnID = 2339, type = "PathLO", showInZone = true, showOnContinent = false, showOnMinimap = false }
