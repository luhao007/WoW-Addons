      ...
      if self.db.profile.showZoneQuelThalas then
        ...
        if db.activate.ZoneTransporting then
          ...
          if self.db.profile.showZonePortals then
            ...
            nodes[2576][64687098] = { mnID = 2393, name = "", type = "Portal", questID = 86883, wwwLink = "https://www.wowhead.com/quest=86883/the-frenzied-march", wwwName = BATTLE_PET_SOURCE_2 .. " " .. REQUIRES_LABEL .. " " .. "The Frenzied March", showWWW = true, showInZone = true, showOnContinent = false, showOnMinimap = false }
            ...
            nodes[2405][51637026] = { mnID = 2393, mnID2 = 2413, name = "", questID = 86510, wwwLink = "https://www.wowhead.com/quest=86510/domus-penumbra", wwwName = BATTLE_PET_SOURCE_2 .. " " .. REQUIRES_LABEL .. " " .. "Domus Penumbra", showWWW = true, TransportName = L["Portals"] .. "\n " .. ns.SilvermoonMN .. "\n " .. ns.Harandar, type = "Portal", showInZone = true, showOnContinent = false, showOnMinimap = false }
          
            --neu
            --nodes[2413][75895485] = { mnID = 2395, name = "", type = "Portal", TransportName = ns.FairbreezeVillage, questID = 86899, wwwLink = "https://www.wowhead.com/quest=86899/the-root-cause", wwwName = BATTLE_PET_SOURCE_2 .. " " .. REQUIRES_LABEL .. " " .. "The Root Cause", showWWW = true, showInZone = true, showOnContinent = false, showOnMinimap = false }
          end

          -- Quel'Thalas Portals
          if self.db.profile.showZonePortals and not self.db.profile.showZoneMapNotesIcons then
            nodes[2413][53545571] = { mnID = 2576, name = "", TransportName = L["inside the cave"] .. ":\n" .. TextIconPortalOld:GetIconString() .. " " .. L["Portal"] .. " " .. ns.VoidTempest .. "\n" .. TextIconPortalOld:GetIconString() .. " " .. L["Portal"] .. " " .. ns.SilvermoonMN, type = "Portal", questID = 86883, wwwLink = "https://www.wowhead.com/quest=86883/the-frenzied-march", wwwName = BATTLE_PET_SOURCE_2 .. " " .. REQUIRES_LABEL .. " " .. "The Frenzied March", showWWW = true, showInZone = true, showOnContinent = false, showOnMinimap = false }
          end
