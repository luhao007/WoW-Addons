...
function ns.deleteCharacterSavedVariables() -- delete only active profile
  ...
  local mmButton = _G["MNMiniMapButtonTBCDB"]
...
function ns.deleteALLSavedVariables() -- delete all profiles
  ...
  local wipeTables = { "FogOfWarColorDB", "MNMiniMapButtonTBCDB" }
  for _, svName in ipairs(wipeTables) do
    if type(_G[svName]) == "table" then
      wipe(_G[svName])
    end
...
function MapNotesMiniButton:OnInitialize() --mmb.lua
  self.db = LibStub("AceDB-3.0"):New("MNMiniMapButtonTBCDB", { profile = { minimap = { hide = false, }, }, }) 
...
function Addon:PLAYER_LOGIN()
  ...
  self.db = LibStub("AceDB-3.0"):New("HandyNotes_MapNotesTBCEraDB", ns.defaults)
...
function Addon:PopulateTable()
  ...
  ns.LoadTBCMiniMapInfo(self) -- load nodes\TBC\TBCMiniMapInfo.lua
  ns.LoadTBCZoneInfo(self) -- load nodes\TBC\TBCWorldMapInfo.lua
  ns.LoadTBCContinentInfo(self) -- load nodes\TBC\TBCContinentInfo.lua
  ns.LoadTBCWorldMapInfo(self) -- load nodes\TBC\TBCWorldMapInfo.lua
  ns.LoadTBCZoneFPInfo(self) -- load nodes\TBC\TBCZoneFPInfo.lua
  ns.LoadTBCMinimapFPInfo(self) -- load nodes\TBC\TBCMinimapFPInfo.lua
  ns.LoadTBCZoneGhostInfo(self) -- load nodes\TBC\TBCZoneGhostInfo.lua
  ns.LoadTBCMinimapGhostInfo(self) -- load nodes\TBC\TBCMinimapGhostInfo.lua

  ns.LoadPathsZoneLocationinfo(self)
  ns.LoadPathsMiniMapLocationinfo(self)

  ns.LoadTBCCapitalsLocationinfo(self) -- load nodes\TBC\TBCCapitals.lua
  ns.LoadTBCMinimapCapitalsLocationinfo(self) -- load nodes\TBC\TBCMinimapCapitals.lua
end
