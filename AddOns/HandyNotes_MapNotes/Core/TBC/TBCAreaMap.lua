...
ns.FogOfWarDataTBC = ns.FogOfWarDataTBC or _G.FogOfWarDataTBCGlobal
...
function ns.UpdateAreaMapFogOfWar()
  ...
  local mapData = ns.FogOfWarDataTBC
...
function ns.OpenSharedFogOfWarColorPicker()
  ...
  local function applyColor(nr, ng, nb, na)
    ...
    local fog = ns.FogOfWar or HandyNotes:GetModule("FogOfWarButtonTBC", true)
