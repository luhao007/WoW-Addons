...
-- new
L["to interact with the icon"] = "um mit diesem Symbol zu interagieren"
...
L["permanently hide changelog"] = "Änderungsprotokoll dauerhaft ausblenden"
L["Permanently hides the changelog, not just until the next addon update"] = "Blendet das Änderungsprotokoll dauerhaft aus, nicht nur bis zur nächsten Addon Version"
-- SwapButtons
...
L["Activate MapNotes, all previously enabled icons will be restored on every map"] = "MapNotes aktivieren, alle zuvor aktivierten Symbole werden auf jeder Karte wieder angezeigt"
...
L["Show all Quel'Thalas MapNotes dungeon, raid, portal, zeppelin and ship icons on this map"] = "Alle MapNotes Dungeon-, Raid-, Portal-, Zeppelin- und Schiffssymbole von Quel'Thalas auf dieser Karte anzeigen"
...
L["(on the platform)"] = "(Auf der Plattform)"
L["to the platform"] = "Zur Plattform"
...
L["Feathermoon Stronghold"] = "Feste Feathermoon"
