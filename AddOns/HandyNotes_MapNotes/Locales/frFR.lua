...
L["Activates the information display on the coordinate windows"] = "Active l’affichage des informations sur les fenêtres de coordonnées"
...
L["Activate MapNotes, all previously enabled icons will be restored on every map"] = "Activer MapNotes, toutes les icônes précédemment activées seront à nouveau affichées sur chaque carte"
...
L["Show all Quel'Thalas MapNotes dungeon, raid, portal, zeppelin and ship icons on this map"] = "Afficher toutes les icônes de donjons, raids, portails, zeppelins et navires de MapNotes de Quel’Thalas sur cette carte"
...
L["(on the platform)"] = "(sur la plateforme)"
L["to the platform"] = "Vers la plateforme"
L["(inside building)"] = "(à l'intérieur du bâtiment)"
L["inside the cave"] = "à l'intérieur de la grotte"
L["talk to"] = "parler à"
--10 places
L["Torghast"] = "Tourment"
...
L["Feathermoon Stronghold"] = "Bastion de Pennelune"
