...
-- new
L["to interact with the icon"] = "per interagire con questa icona"
...
L["permanently hide changelog"] = "Nascondi definitivamente il registro delle modifiche"
L["Permanently hides the changelog, not just until the next addon update"] = "Nasconde definitivamente il registro delle modifiche, non solo fino al prossimo aggiornamento dell'addon"
-- SwapButtons
...
L["Activate MapNotes, all previously enabled icons will be restored on every map"] = "Attiva MapNotes, tutte le icone precedentemente abilitate verranno nuovamente mostrate su ogni mappa"
...
L["Show all Quel'Thalas MapNotes dungeon, raid, portal, zeppelin and ship icons on this map"] = "Mostra tutte le icone MapNotes di spedizioni, incursioni, portali, zeppelin e navi di Quel'Thalas su questa mappa"
...
L["(on the platform)"] = "(sulla piattaforma)"
L["to the platform"] = "Alla piattaforma"
L["(inside building)"] = "(all'interno dell'edificio)"
L["inside the cave"] = "all'interno della grotta"
L["talk to"] = "parlare a"
--10 places
L["Torghast"] = "Torgast"
L["Bastion"] = "Bastione"
...
L["Feathermoon Stronghold"] = "Forte di Piumaluna"
