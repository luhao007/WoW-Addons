...
L["Unfortunately, scaling this highlight is not possible, as it has a fixed value set by Blizzard"] = "很遗憾，无法缩放此高亮效果，因为它由暴雪设置为固定值"
L["Allows you to permanently highlight the player's arrow on the world map while the map is open"] = "在世界地图打开期间，允许永久高亮显示玩家箭头"
...
L["Activates the information display on the coordinate windows"] = "在坐标窗口中启用信息显示"
...
L["Activate MapNotes, all previously enabled icons will be restored on every map"] = "启用 MapNotes，之前启用的所有图标将在每张地图上再次显示"
...
L["Show all Quel'Thalas MapNotes dungeon, raid, portal, zeppelin and ship icons on this map"] = "在此地图上显示所有奎尔萨拉斯的 MapNotes 地下城、团队、副本、传送门、飞艇和船只图标"
