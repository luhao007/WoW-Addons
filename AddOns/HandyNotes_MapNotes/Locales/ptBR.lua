...
-- new
L["to interact with the icon"] = "para interagir com este ícone"
...
L["Player arrow highlight"] = "Realçar seta do jogador"
...
L["Unfortunately, scaling this highlight is not possible, as it has a fixed value set by Blizzard"] = "Infelizmente, não é possível redimensionar este realce, pois ele possui um valor fixo definido pela Blizzard"
L["Allows you to permanently highlight the player's arrow on the world map while the map is open"] = "Permite destacar permanentemente a seta do jogador no mapa-múndi enquanto o mapa estiver aberto"
...
L["permanently hide changelog"] = "Ocultar permanentemente o registro de alterações"
L["Permanently hides the changelog, not just until the next addon update"] = "Oculta permanentemente o registro de alterações, não apenas até a próxima atualização do addon"
-- SwapButtons
...
L["Activates the information display on the coordinate windows"] = "Ativa a exibição de informações nas janelas de coordenadas"
...
L["Activate MapNotes, all previously enabled icons will be restored on every map"] = "Ativar MapNotes, todos os ícones previamente ativados serão exibidos novamente em todos os mapas"
...
L["Show all Quel'Thalas MapNotes dungeon, raid, portal, zeppelin and ship icons on this map"] = "Mostrar todos os ícones do MapNotes de masmorras, raides, portais, zepelins e navios de Quel'Thalas neste mapa"
...
L["(on the platform)"] = "(na plataforma)"
L["to the platform"] = "Para a plataforma"
L["(inside building)"] = "(dentro do prédio)"
L["inside the cave"] = "dentro da caverna"
L["talk to"] = "falar com"
--10 places
L["Torghast"] = "Thanator"
L["Bastion"] = "Bastião"
...
L["Feathermoon Stronghold"] = "Bastião Plumaluna"
