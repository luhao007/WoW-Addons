...
-- new
L["to interact with the icon"] = "para interactuar con este icono"
...
L["permanently hide changelog"] = "Ocultar permanentemente el registro de cambios"
L["Permanently hides the changelog, not just until the next addon update"] = "Oculta permanentemente el registro de cambios, no solo hasta la próxima actualización del addon"
-- SwapButtons
...
L["Activate MapNotes, all previously enabled icons will be restored on every map"] = "Activar MapNotes, todos los iconos previamente activados volverán a mostrarse en cada mapa"
...
L["Show all Quel'Thalas MapNotes dungeon, raid, portal, zeppelin and ship icons on this map"] = "Mostrar todos los iconos de MapNotes de mazmorras, bandas, portales, zepelines y barcos de Quel'Thalas en este mapa"
...
L["(on the platform)"] = "(en la plataforma)"
L["to the platform"] = "A la plataforma"
L["(inside building)"] = "(dentro del edificio)"
L["inside the cave"] = "dentro de la cueva"
