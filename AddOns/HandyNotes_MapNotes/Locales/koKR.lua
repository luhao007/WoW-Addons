...
L["Activate MapNotes, all previously enabled icons will be restored on every map"] = "MapNotes 활성화, 이전에 활성화된 모든 아이콘이 모든 지도에 다시 표시됩니다"
...
L["Show all Quel'Thalas MapNotes dungeon, raid, portal, zeppelin and ship icons on this map"] = "이 지도에서 퀠탈라스의 모든 MapNotes 던전, 공격대, 차원문, 비행선 및 선박 아이콘 표시"
...
L["(on the platform)"] = "(플랫폼 위에)"
L["to the platform"] = "플랫폼으로"
