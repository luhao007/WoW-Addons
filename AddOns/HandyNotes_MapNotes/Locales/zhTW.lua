...
-- new
L["to interact with the icon"] = "與此圖示互動"
...
L["permanently hide changelog"] = "永久隱藏更新日誌"
L["Permanently hides the changelog, not just until the next addon update"] = "永久隱藏更新日誌，而不僅僅是直到下次插件更新"
-- SwapButtons
...
L["Activate MapNotes, all previously enabled icons will be restored on every map"] = "啟用 MapNotes，先前啟用的所有圖示將再次顯示在每張地圖上"
...
L["Show all Quel'Thalas MapNotes dungeon, raid, portal, zeppelin and ship icons on this map"] = "在此地圖上顯示所有奎爾薩拉斯的 MapNotes 地城、團隊、傳送門、飛艇與船隻圖示"
