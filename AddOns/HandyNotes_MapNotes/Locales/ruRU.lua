...
-- new
L["to interact with the icon"] = "чтобы взаимодействовать с этим значком"
...
L["permanently hide changelog"] = "Навсегда скрыть журнал изменений"
L["Permanently hides the changelog, not just until the next addon update"] = "Навсегда скрывает журнал изменений, а не только до следующего обновления аддона"
-- SwapButtons
...
L["Activate MapNotes, all previously enabled icons will be restored on every map"] = "Активировать MapNotes, все ранее включённые значки снова будут отображаться на каждой карте"
...
L["Show all Quel'Thalas MapNotes dungeon, raid, portal, zeppelin and ship icons on this map"] = "Показать на этой карте все значки MapNotes подземелий, рейдов, порталов, дирижаблей и кораблей Кель’Таласа"
...
L["(on the platform)"] = "(на платформе)"
L["to the platform"] = "К платформе"
L["(inside building)"] = "(внутри здания)"
L["inside the cave"] = "внутри пещеры"
...
L["Feathermoon Stronghold"] = "Крепость Оперённой Луны"
