...
D["Creatures_1"]:SetAfterUpdate("Vignette Info", CreaturesVignetteInfo_AfterUpdate)
D["Creatures_2"]:SetAfterUpdate("Vignette Info", CreaturesVignetteInfo_AfterUpdate)
