...
T.Affinities = {} do
	local ht, hp = [[0ò‚Ñ⁄Òv.TÍËÜGóıT%?†W«ÿŒrT√pçxŒ®ºhÎ‡ÃÁÛÖÒ∏≤<œô≥8Un)\zÒ™2∏M|¶®Æ«#ê.◊c7∞§Â∆¬¢† ÄÚO—10›]ë¿ÒŒñï˛¸õ∫\}ëÿ‚	˚‰ó-ªó∫Ω¨∞0H√¨0µ(2Ï*?∞hò∆jÀÉòıê¨üﬁÑñÔ’')^jÎïÄÙhÓôR“ñ#˘Iƒm	J\‰>Íä6∫≈;ß∆z∑ÛT≠ıcÕÑÇ1ãL¡πpt◊C∫E#"I1ÙAHíétî5(bdDìÅ‚…úÔdI'"2öQD¡:–H(ëÑ$¬:àE8".AŒGsëVòBqA‹E©q÷÷QC"∂sZŒsíkybE°[–•ëßtÜ≈Qe2NRm!7…3Hi5®Cêóh9‚QƒíFó$-&˜–à:ŒBIY‰IÃÑaﬁ√"$CW±Ó#»y&4a"∂0èäÜ&Lj…25/C‹¬1.cZ≈»é:”J,£(Ù9r”≠é9ó=9‹x–Ò!√…íaˆEú&ô¶2"	% QÑôëK"Ùƒë3„'=sñÿûìK‰zI3$«éöDÈåÃ¥@âJ»g|¥JNˆ@ÙL(¶jYﬂ≠0|Ñ∞ü§”$t#ñD.3Q‹Ç Ùc‘ÂÕÆ$‰Ñ¢g"˛óïàˇˇˇ I]], [[((≠hÆ(nipØqj¨krgolms]]
...
T.InterestPool = {
	...
	{214, 104, 275,  3, s={B+9, 3, 7200, 824, 11, 3, 10, 10}}, -- A Way Out
	{334, 104, 250,  3, s={B+10, 3, 36000, 824, 12, 1, 2, 2}}, -- Mogor's Dilemma
	{213, 104, 250,  3, s={B+8, 3, 7200, 824, 11, 1, 2, 8}}, -- Fired Up
	{269, 104, 225,  3, s={615, 2, 14400, 824, 20, 1, 6, 10}}, -- Griefing with the Enemy
	{268, 103, 225,  3, s={615, 2, 14400, 824, 22, 2, 3, 7}}, -- Who's the Boss?
	{212, 107, 225,  3, s={B+7, 3, 6750, 824, 15, 1, 2, 10}}, -- Cat Scratch Fever
	{288, 107, 200, 35, s={B+10, 3, 21600, 824, 14, 2, 6, 8, 9}}, -- The Golden Halls of Skyreach
	{211, 107, 200,  3, s={B+6, 3, 6750, 824, 19, 1, 3, 10}}, -- Peace unto You
	{210, 105, 175,  3, s={B+5, 3, 5400, 824, 14, 4, 8, 10}}, -- Flock Together
	{133, 101, 175,  3, s={B+10, 2, 21600, 824, 18, 3, 8}}, -- Elemental Territory
	{132, 107, 175,  3, s={B+10, 2, 21600, 824, 15, 4, 6}}, -- The Basilisk's Stare
	{209, 105, 150,  3, s={B+4, 3, 5400, 824, 11, 1, 3, 10}}, -- Lending a Hand
	{208, 103, 125,  3, s={B+3, 3, 5400, 824, 12, 6, 6, 7}}, -- Elements of Surprise
	{207, 103, 110,  3, s={B+2, 3, 5400, 824, 20, 1, 2, 9}}, -- Environmental Hazard
	{289, 106, 100, 35, s={B+10, 2, 21600, 824, 26, 1, 2}}, -- Profitable Machinations
	{287, 103, 100, 35, s={B+10, 2, 21600, 824, 22, 2, 6}}, -- Blackrock Munitions
	{286, 103, 100, 35, s={B+10, 2, 21600, 824, 11, 2, 9}}, -- Lost in the Foundry
	{285, 106, 100, 35, s={B+10, 2, 21600, 824, 20, 7, 8}}, -- The One True Brambleking
	{284, 101, 100, 35, s={B+10, 2, 21600, 824, 23, 4, 8}}, -- Ug'lok the Incompetent
