...
L["TITAN_PANEL_SLASH_RESET_0"] = LIGHTYELLOW_FONT_COLOR_CODE.."Usage: |r|cffffffff/titan {reset | reset tipfont/tipalpha/panelscale/spacing/all}|r";
L["TITAN_PANEL_SLASH_RESET_1"] = " - "..LIGHTYELLOW_FONT_COLOR_CODE.."reset: |r|cffffffffResets "..TITAN_PANEL.." profile being used to default values/position.|r";
