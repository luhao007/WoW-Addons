...
local DefaultDB = {
    ...
    PaperDollItemLevelOutsideString = true,
...
local frame = CreateFrame("Frame", "TinyInspectReforged", UIParent)
...
if Settings and Settings.RegisterCanvasLayoutCategory then
    ...
    frame.categoryID = category:GetID() -- for OpenToCategory use
else
...
function SlashCmdList.TinyInspect(msg, editbox)
    ...
    if (Settings and Settings.RegisterCanvasLayoutCategory) then
        local settingsCategoryID = _G["TinyInspectReforged"].categoryID
