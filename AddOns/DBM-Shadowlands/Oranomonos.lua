...
local specWarnImplant						= mod:NewSpecialWarningStack(338852, nil, 18, nil, nil, 1, 6, nil, nil, "stackhigh")
local specWarnImplantTaunt					= mod:NewSpecialWarningTaunt(338852, nil, nil, nil, 1, 2, nil, nil, "tauntboss")
local specWarnRegrowth						= mod:NewSpecialWarningInterrupt(338857, "HasInterrupt", nil, nil, 1, 2, nil, nil, "kickcast")
local specWarnDirgeoftheFallenSanctum		= mod:NewSpecialWarningSpell(338856, nil, nil, nil, 2, 2, nil, nil, "aesoon")
local specWarnSeedsofSorrow					= mod:NewSpecialWarningRun(338855, nil, nil, nil, 4, 2, nil, nil, "justrun")
