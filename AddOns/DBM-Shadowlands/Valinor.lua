...
local specWarnUnleashedAnima				= mod:NewSpecialWarningDodge(327274, nil, nil, nil, 2, 2, nil, nil, "watchstep")
local specWarnMarkofPenitence				= mod:NewSpecialWarningStack(327255, nil, 3, nil, nil, 1, 6, nil, nil, "stackhigh")
local specWarnMarkofPenitenceTaunt			= mod:NewSpecialWarningTaunt(327255, nil, nil, nil, 1, 2, nil, nil, "tauntboss")
local specWarnLysoniasCall					= mod:NewSpecialWarningYou(339278, nil, nil, nil, 1, 2, nil, nil, "targetyou")
local specWarnChargedAnimaBlast				= mod:NewSpecialWarningMoveAway(327262, nil, nil, nil, 3, 2, nil, nil, "runout")
local specWarnChargedAnimaBlastNear			= mod:NewSpecialWarningClose(327262, nil, nil, nil, 3, 2, nil, nil, "runaway")
