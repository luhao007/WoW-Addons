...
local specWarnOrbs			= mod:NewSpecialWarning("SpecWarnOrbs", nil, nil, nil, 2, 2, nil, nil, 92852, nil, "watchorb")
local specWarnOrbOnYou		= mod:NewSpecialWarning("SpecWarnAggroOnYou", nil, nil, nil, 3, 5, nil, nil, 92852, nil, "orbrun")
local specWarnBreath		= mod:NewSpecialWarningSpell(90125, nil, nil, nil, 2, 2, nil, nil, "breathsoon")
local specWarnEggShield		= mod:NewSpecialWarningSpell(87654, "Ranged", nil, nil, 1, 2, nil, nil, "stopattack")
local specWarnEggWeaken		= mod:NewSpecialWarningSwitch(-3238, "Ranged", nil, nil, 1, 2, nil, nil, "targetchange")
local specWarnIndomitable	= mod:NewSpecialWarningDispel(90045, "RemoveEnrage", nil, nil, 1, 2, nil, nil, "enrage")
