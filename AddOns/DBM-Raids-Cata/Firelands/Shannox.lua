...
local specWarnSpear				= mod:NewSpecialWarningSpell(100002, false, nil, nil, 1, 2, nil, nil, "runaway")
local specWarnRage				= mod:NewSpecialWarningDefensive(100415, nil, nil, nil, 1, 2, nil, nil, "defensive")
local specWarnFaceRage			= mod:NewSpecialWarningTarget(99947, false, nil, nil, 1, 2, nil, nil, "healfull")
local specWarnImmTrap			= mod:NewSpecialWarningMove(99839, nil, nil, nil, 1, 2, nil, nil, "runaway")
local specWarnImmTrapNear		= mod:NewSpecialWarningClose(99839, nil, nil, nil, 1, 2, nil, nil, "runaway")
local yellImmoTrap				= mod:NewShortYell(99839)
local specWarnCrystalTrap		= mod:NewSpecialWarningMove(99836, nil, nil, nil, 3, 2, nil, nil, "runaway")
local specWarnCrystalTrapNear	= mod:NewSpecialWarningClose(99836, nil, nil, nil, 1, 2, nil, nil, "runaway")
local yellCrystalTrap			= mod:NewShortYell(99836)
local specWarnTears				= mod:NewSpecialWarningStack(99937, "Tank", 8, nil, nil, 1, 6, nil, nil, "stackhigh")
