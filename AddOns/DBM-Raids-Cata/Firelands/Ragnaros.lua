...
local specWarnMagmaTrap		= mod:NewSpecialWarningMove(98164, nil, nil, nil, 1, 2, nil, nil, "runaway")
...
local specWarnBlazingHeat	= mod:NewSpecialWarningYou(100460, nil, nil, nil, 1, 2, nil, nil, "targetyou")--Debuff on you
local yellBlazingHeat		= mod:NewYell(100460)
local specWarnMoltenSeed	= mod:NewSpecialWarningDodge(98495, nil, nil, nil, 2, 2, nil, nil, "watchstep")
local specWarnEngulfing		= mod:NewSpecialWarningMove(99171, nil, nil, nil, 1, 2, nil, nil, "watchstep")
local specWarnMeteor		= mod:NewSpecialWarningMove(99268, nil, nil, nil, 1, 2, nil, nil, "targetyou")--Spawning on you
...
local specWarnWorldofFlames	= mod:NewSpecialWarningDodge(100171, nil, nil, nil, 2, 2, nil, nil, "watchstep")
...
local specWarnSuperheated	= mod:NewSpecialWarningStack(100593, true, 12, nil, nil, 1, 6, nil, nil, "stackhigh")
local specWarnGTFO			= mod:NewSpecialWarningGTFO(98870, nil, nil, nil, 1, 8, nil, nil, "watchfeet")
