...
local specWarnFieroblast	= mod:NewSpecialWarningInterrupt(100094, "HasInterrupt", nil, nil, 1, 2, nil, nil, "kickcast")
local specWarnMoltenArmor	= mod:NewSpecialWarningStack(99532, nil, 4, nil, nil, 1, 6, nil, nil, "stackhigh")
local specWarnDruidLeap		= mod:NewSpecialWarningYou(99629, nil, nil, nil, 1, 2, nil, nil, "targetyou")
local yelldruidLeap			= mod:NewYell(99629)
local specWarnDruidLeapNear	= mod:NewSpecialWarningClose(99629, nil, nil, nil, 1, 2, nil, nil, "runaway")
local specWarnEarthQuake	= mod:NewSpecialWarningCast(100724, "SpellCaster", nil, nil, 1, 2, nil, nil, "stopcast")
local specWarnLava			= mod:NewSpecialWarningMove(99510, nil, nil, nil, 1, 2, nil, nil, "watchfeet")
