...
local specWarnSearingFlame	= mod:NewSpecialWarningCount(77840, nil, nil, nil, 2, 2, nil, nil, "aesoon")
local specWarnSonarPulse	= mod:NewSpecialWarningDodge(77672, nil, nil, nil, 2, 2, nil, nil, "watchstep")
local specWarnTracking		= mod:NewSpecialWarningRun(78092, nil, nil, nil, 4, 2, nil, nil, "runout")
local specWarnPestered		= mod:NewSpecialWarningYou(92685, nil, nil, nil, 1, 2, nil, nil, "targetyou")
local yellPestered			= mod:NewYell(92685)
local specWarnObnoxious		= mod:NewSpecialWarningInterrupt(92677, "HasInterrupt", nil, nil, 1, 2, nil, nil, "kickcast")
local specWarnAddTargetable	= mod:NewSpecialWarningSwitch(92677, "Ranged", nil, nil, 1, 2, nil, nil, "killmob")
