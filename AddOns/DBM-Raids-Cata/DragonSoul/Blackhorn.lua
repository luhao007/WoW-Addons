...
local specWarnHarpoon				= mod:NewSpecialWarningTarget(108038, false, nil, nil, 1, 2, nil, nil, "targetchange")
local specWarnTwilightOnslaught		= mod:NewSpecialWarningSoakCount(107588, nil, nil, nil, 2, 2, nil, nil, "helpsoak")
local specWarnSapper				= mod:NewSpecialWarningSwitch(-4200, "Dps", nil, nil, 1, 2, nil, nil, "killmob")
local specWarnDeckFireCast			= mod:NewSpecialWarningDodge(110095, false, nil, nil, 2, 2, nil, nil, "watchstep")
local specWarnGTFO					= mod:NewSpecialWarningGTFO(110095, nil, nil, nil, 1, 8, nil, nil, "watchfeet")
local specWarnElites				= mod:NewSpecialWarning("SpecWarnElites", "Tank", nil, nil, 1, 2, nil, nil, nil, nil, "targetchange")
local specWarnShockwave				= mod:NewSpecialWarningYou(108046, nil, nil, nil, 1, 2, nil, nil, "targetyou")
local specWarnShockwaveOther		= mod:NewSpecialWarningTarget(108046, false, nil, nil, 2, 2, nil, nil, "shockwave")
local yellShockwave					= mod:NewYell(108046)
local specWarnSunder				= mod:NewSpecialWarningStack(108043, nil, 3, nil, nil, 1, 6, nil, nil, "stackhigh")
local specWarnSunderOther			= mod:NewSpecialWarningTaunt(108043, nil, nil, nil, 1, 2, nil, nil, "tauntboss")
