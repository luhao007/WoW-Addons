...
local specWarnOozes			= mod:NewSpecialWarningSpell(-3978, nil, nil, nil, 1, 2, nil, nil, "targetchange")
local specWarnVoidBolt		= mod:NewSpecialWarningStack(104849, nil, 2, nil, nil, 1, 6, nil, nil, "stackhigh")
local specWarnVoidBoltOther	= mod:NewSpecialWarningTaunt(104849, nil, nil, nil, 1, 2, nil, nil, "tauntboss")
local specWarnManaVoid		= mod:NewSpecialWarningSpell(105530, "ManaUser", nil, nil, 1, 2, nil, nil, "stopcast")
local specWarnPurple		= mod:NewSpecialWarningSpell(104896, "Tank|Healer", nil, nil, 1, 2, nil, nil, "specialsoon")
