...
mod:SetRevision("20260525233133")
...
local specWarnTerror				= mod:NewSpecialWarningSwitch(-4117, nil, nil, nil, 1, 2, nil, nil, "targetchange")--Same as fragments.
local specWarnShrapnel				= mod:NewSpecialWarningYou(106794, nil, nil, nil, 1, 2, nil, nil, "targetyou")
local specWarnParasite				= mod:NewSpecialWarningYou(108649, nil, nil, nil, 1, 2)
local specWarnParasiteDPS			= mod:NewSpecialWarningSpell(-4347, "Dps", nil, nil, 1, 2, nil, nil, "killmob")--many raid teams using kalecgos buff. they do not target switch to parasite
local yellParasite					= mod:NewYell(108649)
local specWarnCongealingBlood		= mod:NewSpecialWarningSwitch(-4350, "Dps", nil, nil, 1, 2, nil, nil, "killmob")--15%, 10%, 5% on heroic. spellid is 109089.
local specWarnTetanus				= mod:NewSpecialWarningStack(106730, nil, 4, nil, nil, 1, 6, nil, nil, "stackhigh")
local specWarnTetanusOther			= mod:NewSpecialWarningTaunt(106730, nil, nil, nil, 1, 2, nil, nil, "tauntboss")
