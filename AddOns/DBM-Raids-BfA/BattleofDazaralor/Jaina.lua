...
local warnCorsairSoon					= mod:NewSoonAnnounce(-19690, 2, "2261243", nil, nil, nil, nil, 7)
local warnCorsair						= mod:NewTargetAnnounce(-19690, 3, "2261243", nil, nil, nil, nil, 7)
...
--General
local specWarnFreezingBlood				= mod:NewSpecialWarningMoveTo(289387, false, nil, 3, 1, 2, nil, nil, "gathershare")
local yellFreezingBlood					= mod:NewFadesYell(289387, L.Freezing, true, 2, "YELL")
local specWarnChillingStack				= mod:NewSpecialWarningStack(287993, nil, 12, nil, nil, 1, 6, nil, nil, "stackhigh")
--Stage One: Burning Seas
local specWarnIceShard					= mod:NewSpecialWarningTaunt(285253, false, nil, nil, 1, 2)
local specWarnMarkedTarget				= mod:NewSpecialWarningRun(288038, nil, nil, nil, 4, 2, nil, nil, "justrun")
...
local specWarnAvalanche					= mod:NewSpecialWarningYouPos(285254, nil, nil, nil, 1, 2, nil, nil, "runout")
local yellAvalanche						= mod:NewPosYell(285254)
local specWarnAvalancheTaunt			= mod:NewSpecialWarningTaunt(287565, nil, nil, nil, 1, 2, nil, nil, "tauntboss")
local specWarGraspofFrost				= mod:NewSpecialWarningDispel(287626, "Healer", nil, 3, 1, 2, nil, nil, "helpdispel")
local specWarnFreezingBlast				= mod:NewSpecialWarningDodge(285177, "Tank", nil, nil, 2, 2, nil, nil, "shockwave")
local specWarnRingofIce					= mod:NewSpecialWarningRunCount(285459, nil, nil, nil, 4, 2, nil, nil, "justrun")
--Stage Two: Frozen Wrath
local specWarnIceBlockTaunt				= mod:NewSpecialWarningTaunt(287490, nil, nil, nil, 3, 2, nil, nil, "tauntboss")
local specWarnGTFO						= mod:NewSpecialWarningGTFO(288297, nil, nil, nil, 1, 8, nil, nil, "watchfeet")
local specWarnBroadside					= mod:NewSpecialWarningMoveAwayCount(288212, nil, nil, nil, 1, 2, nil, nil, "targetyou")--NewSpecialWarningYouPos
local yellBroadside						= mod:NewPosYell(288212)
local yellBroadsideFades				= mod:NewIconFadesYell(288212)
local specWarnSiegebreaker				= mod:NewSpecialWarningMoveAwayCount(288374, nil, nil, nil, 3, 2, nil, nil, "runout")
...
local specWarnHandofFrost				= mod:NewSpecialWarningYou(288412, nil, nil, nil, 1, 2, nil, nil, "targetyou")
local yellHandofFrost					= mod:NewYell(288412)
local specWarnHandofFrostNear			= mod:NewSpecialWarningClose(288412, nil, nil, nil, 1, 2, nil, nil, "watchstep")
local specWarnGlacialRay				= mod:NewSpecialWarningDodgeCount(288345, nil, nil, nil, 2, 2, nil, nil, "watchstep")
local specWarnIcefall					= mod:NewSpecialWarningDodgeCount(288475, nil, nil, nil, 2, 2, nil, nil, "watchstep")
--Intermission 2
local specWarnHeartofFrost				= mod:NewSpecialWarningMoveAway(289220, nil, nil, nil, 1, 2, nil, nil, "runout")
local yellHeartofFrost					= mod:NewYell(289220)
local specWarnWaterBoltVolley			= mod:NewSpecialWarningInterruptCount(290084, "HasInterrupt", nil, nil, 1, 2, nil, nil, "kick2r")
--Stage Three:
local specWarnOrbofFrost				= mod:NewSpecialWarningCount(288619, nil, nil, nil, 2, 2, nil, nil, "watchorb")
local specWarnPrismaticImage			= mod:NewSpecialWarningSwitchCount(288747, nil, nil, 2, 1, 2, nil, nil, "killmob")
...
local timerCorsairCD					= mod:NewCDTimer(60.4, -19690, nil, nil, nil, 1, "2261243")
