local mod	= DBM:NewMod(2351, "DBM-Raids-BfA", 2, 1179)
...
mod:RegisterEventsInCombat(
	...
	"SPELL_CAST_SUCCESS 298242 298103 298156 305057 295779",
	"SPELL_SUMMON 298465",
...
local specWarnDesensitizingSting			= mod:NewSpecialWarningStack(298156, nil, 9, nil, nil, 1, 6, nil, nil, "stackhigh")
local specWarnDesensitizingStingTaunt		= mod:NewSpecialWarningTaunt(298156, nil, nil, nil, 1, 2, nil, nil, "tauntboss")
local specWarnDribblingIchor				= mod:NewSpecialWarningCount(298103, nil, nil, nil, 2, 2, nil, nil, "mobsoon")
local specWarnCallofTender					= mod:NewSpecialWarningSwitchCount(305057, "Tank", nil, nil, 1, 2, 4, nil, "killmob")
local specWarnIncubationFluid				= mod:NewSpecialWarningMoveAway(298306, nil, nil, nil, 1, 2, nil, nil, "targetyou")
local specWarnArcingCurrent					= mod:NewSpecialWarningCount(295825, nil, nil, nil, 2, 2, nil, nil, "targetyou")
...
local specWarnAquaLance						= mod:NewSpecialWarningMoveAway(295779, nil, nil, nil, 1, 2, nil, nil, "targetyou")
local yellAquaLance							= mod:NewYell(295779)
local yellAquaLanceFades					= mod:NewShortFadesYell(295779)
local specWarnConductivePulse				= mod:NewSpecialWarningInterrupt(295822, "HasInterrupt", nil, nil, 3, 2, nil, nil, "kickcast")
...
function mod:OnCombatStart(delay)
	...
	timerIncubationFluidCD:Start(17.6-delay)
	timerDribblingIchorCD:Start(27.5-delay, 1)
	timerArcingCurrentCD:Start(38.4-delay, 1)
