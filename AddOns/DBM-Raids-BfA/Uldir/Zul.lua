...
local specWarnPitofDespair				= mod:NewSpecialWarningDispel(273434, "RemoveCurse", nil, nil, 1, 2, nil, nil, "helpdispel")
...
local specWarnCallofCrawg				= mod:NewSpecialWarningSwitch(-18541, "-Healer", nil, nil, 1, 2, nil, nil, "killmob")
local specWarnCallofHexer				= mod:NewSpecialWarningSwitch(-18540, "-Healer", nil, nil, 1, 2, nil, nil, "killmob")
local specWarnCallofCrusher				= mod:NewSpecialWarningSwitch(-18539, "-Healer", nil, nil, 1, 2, nil, nil, "killmob")
...
local specWarnRupturingBloodEdge		= mod:NewSpecialWarningMoveTo(274358, nil, nil, nil, 1, 7, nil, nil, "runtoedge")
...
local specWarnDeathwishNear				= mod:NewSpecialWarningClose(274271, nil, nil, nil, 1, 2, nil, nil, "runaway")
