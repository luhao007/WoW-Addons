-- $Id: Atlas_Transportation.lua 137 2022-02-13 08:57:29Z arithmandar $
--[[
...
elseif (WoWClassicTBC) then
	...
	db.maps = {
		...
		TransAllianceWest = {
			...
			{ WHIT.."50) "..BZ["The Shrine of Aessina"] },
		...
		TransHordeWest = {
			...
			{ WHIT.."53) "..BZ["The Shrine of Aessina"] },
...
--			{ INDENT..GREY.."  -> "..BZ["Karazhan"]..ALC["Comma"]..BZ["Deadwind Pass"]..ALC["Comma"]..BZ["Eastern Kingdoms"] },
	...
	--		{ LBLU..QUESTS_LABEL },
		...
		TransMaldraxxus = {
			...
			{ NUTL.." 5) "..BZ["Renounced Bastille"], 10005 },
			{ NUTL.." 6) "..BZ["Bleak Redoubt"], 10006 },
			{ NUTL.." 7) "..BZ["Plague Watch"], 10007 },
		},
		TransRevendreth = {
