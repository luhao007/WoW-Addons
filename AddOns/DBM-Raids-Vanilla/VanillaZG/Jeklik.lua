...
mod:SetRevision("20260710163059")
...
local timerSonicBurst	= mod:NewBuffFadesTimer(10, 23918, nil, nil, nil, 5, nil, DBM_COMMON_L.MAGIC_ICON)
local timerScream		= mod:NewBuffFadesTimer(4, 22884, nil, nil, nil, 3)
