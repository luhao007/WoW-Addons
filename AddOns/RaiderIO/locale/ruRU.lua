...
L["RAIDERIO_MP_BASE_SCORE"] = "[Raider.IO] Основной М+ рейтинг"
...
L["SHOW_BEST_SEASON_DESC"] = "В заголовке подсказки отображается лучший результат игрока за сезон в М+ режиме. Если результат получен в предыдущем сезоне, то название сезона будет указано в заголовке всплывающей подсказки."
...
L["SHOW_CLIENT_GUILD_BEST_DESC"] = "Включает отображение 5 лучших прохождений Вашей гильдии (за текущий сезон или неделю) на вкладке Эпохальные подземелья в окне Поиск группы."
