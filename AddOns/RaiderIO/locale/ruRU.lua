-- Generated from CurseForge on Sat Aug 15 08:10:45 UTC 2026
...
L["ALLOW_IN_LFD"] = "Разрешить во фрейме 'Поиск подземелий'"
L["ALLOW_IN_LFD_CLASSIC"] = "Разрешить в поиске групп"
L["ALLOW_IN_LFD_CLASSIC_DESC"] = "Нажмите ПКМ на группы или кандидатов в поиске групп, чтобы скопировать ссылку профиля Raider.IO"
...
L["ALLOW_ON_PLAYER_UNITS"] = "Разрешить на фреймах персонажей"
...
L["API_INVALID_DATABASE"] = "|cffFF0000Предупреждение!|r Обнаружена недопустимая база данных RaiderIO в |cffffffff%s|r. Пожалуйста, обновите все регионы и фракции в клиенте RaiderIO или переустановите дополнение вручную."
...
L["BEST_FOR_DUNGEON"] = "Лучший результат для данного подземелья"
...
L["BUILDS_DUNGEON_BRACKET_10-99"] = "Уровень M+ 10 и выше"
L["BUILDS_DUNGEON_BRACKET_15-99"] = "Уровень M+ 15 и выше"
L["BUILDS_DUNGEON_BRACKET_20-99"] = "Уровень M+ 20 и выше"
L["BUILDS_DUNGEON_BRACKET_6-9"] = "Уровни M+ с 6-го по 9-й"
L["BUILDS_DUNGEONS"] = "М+"
L["BUILDS_DUNGEONS_ALL"] = "Все подземелья"
L["BUILDS_DUNGEONS_SPECIFIC"] = "%s (%s)"
L["BUILDS_ENCOUNTER_DIFFICULY_all"] = "Любая сложность"
L["BUILDS_ENCOUNTER_DIFFICULY_heroic"] = "Героическая"
L["BUILDS_ENCOUNTER_DIFFICULY_mythic"] = "Эпохальная"
L["BUILDS_ENCOUNTER_DIFFICULY_normal"] = "Обычная"
L["BUILDS_PROFILE_ACTIVE_LOADOUT_TITLE"] = "Этот комплект снаряжения активен"
L["BUILDS_PROFILE_ALTERNATE"] = "Альтернативный"
L["BUILDS_PROFILE_COPY_COMPARELINK_ACTION_TITLE"] = "Скопировать ссылку для сравнения"
L["BUILDS_PROFILE_COPY_COMPARELINK_POPUP_TITLE"] = "Скопировать ссылку для сравнения комплектов снаряжения на Raider.IO:"
L["BUILDS_PROFILE_COPY_LOADOUT_ACTION_TITLE"] = "Экспорт комплекта снаряжения"
L["BUILDS_PROFILE_COPY_LOADOUT_LINK_ACTION_TITLE"] = "Скопировать ссылку на снаряжение"
L["BUILDS_PROFILE_COPY_LOADOUT_LINK_POPUP_TITLE"] = "Скопировать ссылку на комплекты снаряжения Raider.IO:"
L["BUILDS_PROFILE_COPY_LOADOUT_POPUP_TITLE"] = "Скопировать строку комплекта снаряжения:"
L["BUILDS_PROFILE_ERROR_CREATING_LOADOUT"] = "Не удалось создать комплект снаряжения. Если у Вас нет места для дополнительных комплектов, пожалуйста, освободите место."
L["BUILDS_PROFILE_FAILED_IMPORTING_BUILD"] = "Не удалось импортировать сборку."
L["BUILDS_PROFILE_HERO_FORMAT"] = "%s (%s)"
L["BUILDS_PROFILE_IMPORTED_BUILD_TO_LOADOUT"] = "Сборка импортирована как '%s'."
L["BUILDS_PROFILE_LOAD_LOADOUT_ACTION_TITLE"] = "Загрузить"
L["BUILDS_PROFILE_LOADOUT_IS_ALREADY_ACTIVE"] = "Ваш текущий комплект снаряжения соответствует этой сборке."
L["BUILDS_PROFILE_LOADOUT_NAME"] = "[Raider.IO] Сборка"
L["BUILDS_PROFILE_NO_DATA"] = "Мурлоки не смогли найти ничего полезного для отображения здесь. Попробуйте изменить фильтры."
L["BUILDS_PROFILE_RECOMMENDED"] = "Рекомендуется"
L["BUILDS_PROFILE_SHOW_JOURNALFRAME_BUTTON"] = "Показывать кнопку фрейма журнала подземелий"
L["BUILDS_PROFILE_SHOW_JOURNALFRAME_BUTTON_DESC"] = "Включите, чтобы отображать кнопку быстрого доступа в окне журнала подземелий."
L["BUILDS_PROFILE_SHOW_TALENTFRAME_BUTTON"] = "Показывать кнопку окна талантов"
L["BUILDS_PROFILE_SHOW_TALENTFRAME_BUTTON_DESC"] = "Включите, чтобы отображать кнопку быстрого доступа в окне талантов."
L["BUILDS_PROFILE_STATS_FORMAT"] = "%s дерева героев (%s, %s %s)"
L["BUILDS_PROFILE_STATS_SUFFIX_KILLS"] = "убийств"
L["BUILDS_PROFILE_STATS_SUFFIX_RUNS"] = "прохождения"
L["BUILDS_PROFILE_SWITCHING_TO_EXISTING_LOADOUT"] = "Переключение на '%s'."
L["BUILDS_PROFILE_SWITCHING_TO_LOADOUT"] = "Переключение на '%s'."
L["BUILDS_PROFILE_UNABLE_TO_DELETE_LOADOUT"] = "Не удалось удалить старый комплект снаряжения '%s'. Пожалуйста, попробуйте еще раз или удалите его вручную."
L["BUILDS_PROFILE_UPDATED_BUILD_TO_LOADOUT"] = "Обновлено '%s' с новыми талантами."
L["BUILDS_RAIDS"] = "Рейд"
L["BUILDS_RAIDS_ENCOUNTERS_ALL"] = "%s: Все сражения"
L["BUILDS_SPEED_all"] = "Любая скорость"
L["BUILDS_SPEED_fast"] = "Быстрые убийства (топ 20%)"
L["BUILDS_SPEED_median"] = "Средние убийства (средние 20%)"
L["BUILDS_TITLE"] = "Сборки талантов"
L["BUILDS_TITLE_FULL"] = "[Raider.IO] Сборки талантов"
L["BUILDS_WEAPON_1"] = "Два одноручных"
L["BUILDS_WEAPON_2"] = "Два двуручных"
L["BUILDS_WEAPON_3"] = "Двуручное"
L["BUILDS_WEAPON_4"] = "Одноручное + щит"
L["BUILDS_WEAPON_5"] = "Одноручное + оффхенд"
L["BUILDS_WEAPON_6"] = "Одноручное"
L["BUILDS_WEAPON_all"] = "Все виды оружия"
L["CANCEL"] = "Отмена"
L["CHANGES_REQUIRES_UI_RELOAD"] = "Ваши изменения сохранены, но для их активации необходимо перезагрузить интерфейс. Хотите сделать это сейчас?"
L["CHARACTER_LF_GUILD_MPLUS"] = "Ищу гильдию для подземелий М+"
L["CHARACTER_LF_GUILD_MPLUS_WITH_SCORE"] = "Ищу гильдию для подземелий М+"
L["CHARACTER_LF_GUILD_PVP"] = "Ищу PvP гильдию"
L["CHARACTER_LF_GUILD_RAID_DEFAULT"] = "Ищу гильдию для рейдов"
L["CHARACTER_LF_GUILD_RAID_HEROIC"] = "Ищу гильдию для героических рейдов"
L["CHARACTER_LF_GUILD_RAID_MYTHIC"] = "Ищу гильдию для эпохальных рейдов"
L["CHARACTER_LF_GUILD_RAID_NORMAL"] = "Ищу гильдию для обычных рейдов"
L["CHARACTER_LF_GUILD_SOCIAL"] = "Ищу социальную гильдию"
L["CHARACTER_LF_TEAM_MPLUS_DEFAULT"] = "Ищу команду для подземелий М+"
L["CHARACTER_LF_TEAM_MPLUS_WITH_SCORE"] = "Ищу команду для подземелий М+ (%d+)"
...
L["DB_MODULES_HEADER_MYTHIC_PLUS"] = "Подземелья М+"
...
L["DISABLE_DROPDOWN_MENU_BUTTON"] = "Отключить выпадающее меню юнита (временное исправление)"
L["DISABLE_DROPDOWN_MENU_BUTTON_DESC"] = "Это временное исправление для текущей проблемы с системой выпадающих меню. Отмечать этот пункт нужно только в том случае, если Вы сталкиваетесь с ошибками при использовании выпадающего меню для установки фокуса, рейдовой метки или при использовании окна сообщества во время боя с боссом. Эта опция будет удалена в будущем, когда Blizzard исправит основные причины проблемы."
...
L["DUNGEON_SHORT_NAME_AOF"] = "Алтарь Клыков"
...
L["DUNGEON_SHORT_NAME_BV"] = "Слепящая долина"
...
L["DUNGEON_SHORT_NAME_DON"] = "Берлога Налоракка"
...
L["DUNGEON_SHORT_NAME_MC"] = "Пещеры Маисара"
...
L["DUNGEON_SHORT_NAME_MR"] = "Закоулок душегубов"
L["DUNGEON_SHORT_NAME_MT"] = "Терраса Магистров"
...
L["DUNGEON_SHORT_NAME_SR"] = "Небесный Путь"
...
L["DUNGEON_SHORT_NAME_VSA"] = "Арена Шрама Бездны"
L["DUNGEON_SHORT_NAME_WM"] = "Усадьба Уэйкрестов"
L["DUNGEON_SHORT_NAME_WORK"] = "Мехагон: Мастерская"
L["DUNGEON_SHORT_NAME_WS"] = "Шпили Ветрокрылых"
L["DUNGEON_SHORT_NAME_YARD"] = "Мехагон: Свалка"
L["ENABLE_AUTO_FRAME_POSITION"] = "Автоматически позиционировать фрейм профиля Raider.IO"
...
L["ENABLE_LFG_EXPORT_BUTTON"] = "Показывать кнопку экспорта группы во фрейме 'Поиск групп'"
L["ENABLE_LFG_EXPORT_BUTTON_DESC"] = "В нижней части фрейма 'Поиск групп' отображается кнопка с изображением лупы, при нажатии на которую экспортируется текущая группа и очередь кандидатов, которых Вы можете скопировать и вставить на сайт Raider.IO, чтобы просмотреть профили всех участников."
...
L["ENABLE_NO_SCORE_COLORS_DESC"] = "Отключает раскраску результатов. Все результаты будут отображены белым цветом."
L["ENABLE_RAIDERIO_CLIENT_ENHANCEMENTS"] = "Расширенные функции клиента Raider.IO"
L["ENABLE_RAIDERIO_CLIENT_ENHANCEMENTS_DESC"] = "Включение этой функции позволит Вам просматривать подробные данные профиля Raider.IO, загруженные из клиента Raider.IO для Ваших персонажей."
...
L["ENABLE_SIMPLE_SCORE_COLORS"] = "Использовать простые цвета очков M+"
...
L["EXPORTJSON_COPY_TEXT"] = "Скопируйте текст и вставьте его в любое место на странице |cff00C8FFhttps://raider.io|r, чтобы найти всех игроков."
...
L["GUILD_BEST_WEEKLY"] = "Гильдия: Лучший результат недели"
L["GUILD_LF_MPLUS_DEFAULT"] = "Набор игроков для подземелий М+"
L["GUILD_LF_MPLUS_WITH_SCORE"] = "Набор %d+ игроков в подземелья М+"
L["GUILD_LF_PVP"] = "Набор PvP игроков"
L["GUILD_LF_RAID_DEFAULT"] = "Набор игроков для рейдов"
L["GUILD_LF_RAID_HEROIC"] = "Набор игроков для героических рейдов"
L["GUILD_LF_RAID_MYTHIC"] = "Набор игроков для эпохальных рейдов"
L["GUILD_LF_RAID_NORMAL"] = "Набор игроков для обычных рейдов"
L["GUILD_LF_SOCIAL"] = "Набор социальных игроков"
L["HEALER"] = "Лекарь"
...
L["MINIMAP_SHORTCUT_HELP_OPEN_MENU"] = "Меню"
...
L["MINIMAP_SHORTCUT_MENU_BUILDS"] = "Выбрать сборку"
L["MINIMAP_SHORTCUT_MENU_COPY_BUILD"] = "Скопировать ссылку"
...
L["MODULE_CHINA"] = "Китай"
L["MODULE_EUROPE"] = "Европа"
L["MODULE_KOREA"] = "Корея"
L["MODULE_TAIWAN"] = "Тайвань"
L["MY_PROFILE_TITLE"] = "Профиль Raider.IO"
L["MYTHIC_PLUS_DB_MODULES"] = "Модули базы данных подземелий М+"
...
L["OUTDATED_DATABASE"] = "Данные получены %d дней назад"
L["OUTDATED_DATABASE_HOURS"] = "Данные обновлены %d часов назад"
L["OUTDATED_DOWNLOAD_LINK"] = "Скачать: |cffffbd0a%s|r"
L["OUTDATED_EXPIRED_ALERT"] = "|cffFFFFFF%s|r использует устаревшие данные. Пожалуйста, обновите сейчас, чтобы увидеть наиболее точные данные: |cffFFFFFF%s|r"
...
L["PREVIOUS_SCORE"] = "Результат предыдущего сезона (%s):"
...
L["RAID_BOSS_DR_1"] = "Химерий Неприснившийся Бог"
...
L["RAID_BOSS_FSOD_5"] = "Раздиратель душ Дормацайн"
L["RAID_BOSS_FSOD_6"] = "Кузнец боли Разнал"
...
L["RAID_BOSS_MQD_1"] = "Бело'рен Дитя Ал'ара"
L["RAID_BOSS_MQD_2"] = "Торжество Полуночи"
...
L["RAID_BOSS_SOO_1"] = "Глубиний"
L["RAID_BOSS_SOO_10"] = "Пандарийские трофеи"
L["RAID_BOSS_SOO_11"] = "Ток Кровожадный"
L["RAID_BOSS_SOO_12"] = "Мастер осады Черноплавс"
L["RAID_BOSS_SOO_13"] = "Идеалы клакси"
L["RAID_BOSS_SOO_14"] = "Гаррош Адский Крик"
L["RAID_BOSS_SOO_2"] = "Павшие защитники"
L["RAID_BOSS_SOO_3"] = "Норусхен"
L["RAID_BOSS_SOO_4"] = "Ша Гордыни"
L["RAID_BOSS_SOO_5"] = "Галакрас"
L["RAID_BOSS_SOO_6"] = "Железный исполин"
L["RAID_BOSS_SOO_7"] = "Кор'кронские темные шаманы"
L["RAID_BOSS_SOO_8"] = "Генерал Назгрим"
L["RAID_BOSS_SOO_9"] = "Малкорок"
L["RAID_BOSS_ToES_1"] = "Вечные защитники"
L["RAID_BOSS_TOES_1"] = "Защитник Каолань"
...
L["RAID_BOSS_ToES_4"] = "Ша Страха"
L["RAID_BOSS_TOT_1"] = "Джин'рок Разрушитель"
L["RAID_BOSS_TOT_10"] = "Кон Железный"
L["RAID_BOSS_TOT_11"] = "Небесные сестры"
L["RAID_BOSS_TOT_12"] = "Лэй Шэнь"
L["RAID_BOSS_TOT_13"] = "Ра-ден"
L["RAID_BOSS_TOT_2"] = "Хорридон"
L["RAID_BOSS_TOT_3"] = "Совет старейшин"
L["RAID_BOSS_TOT_4"] = "Тортос"
L["RAID_BOSS_TOT_5"] = "Мегера"
L["RAID_BOSS_TOT_6"] = "Цзи-Кунь"
L["RAID_BOSS_TOT_7"] = "Дуруму Позабытый"
L["RAID_BOSS_TOT_8"] = "Изначалий"
L["RAID_BOSS_TOT_9"] = "Темный Анимус"
L["RAID_BOSS_TOTFW_1"] = "Конклав ветра"
L["RAID_BOSS_TOTFW_2"] = "Ал'акир"
L["RAID_BOSS_VA_1"] = "Нек'зали Душительница Душ"
L["RAID_BOSS_VA_2"] = "Погребенные стражи"
L["RAID_BOSS_VA_3"] = "Потерявшиеся исследователи"
L["RAID_BOSS_VA_4"] = "Вашник Тлетворный"
L["RAID_BOSS_VA_5"] = "Ссзорак"
L["RAID_BOSS_VA_6"] = "Два Клыка"
L["RAID_BOSS_VA_7"] = "Спиральный алтарь"
L["RAID_BOSS_VA_8"] = "Ула'тек"
...
L["RAID_BOSS_VS_2"] = "Ненасытникус"
L["RAID_BOSS_VS_3"] = "Павший король Салхадаар"
...
L["RAID_BOSS_VS_DR_MQD_6"] = "Аллерия Ветрокрылая"
...
L["SHOW_AVERAGE_PLAYER_SCORE_INFO_DESC"] = "Показывает среднее количество очков по версии Raider.IO у персонажей, прошедших подземелье М+ вовремя. Это видно в подсказках ключа и подсказках игрока в поиске подземелий."
L["SHOW_BEST_MAINS_SCORE"] = "Показывать рейтинг М+ основного персонажа из лучшего сезона"
L["SHOW_BEST_MAINS_SCORE_DESC"] = "Отображает во всплывающей подсказке лучший результат игрока в M+ за сезон и прогресс в рейдах основного персонажа. Игрок должен быть зарегистрирован на Raider.IO и указать персонажа как основного."
L["SHOW_BEST_RUN"] = "Показывать в заголовке лучшее пройденное подземелье М+"
L["SHOW_BEST_RUN_DESC"] = "Показывать в подсказке лучшее пройденное подземелье М+ игрока в текущем сезоне."
L["SHOW_BEST_SEASON"] = "Показывать в заголовке лучший результат сезона М+"
L["SHOW_BEST_SEASON_DESC"] = "В заголовке подсказки отображается лучший результат игрока за сезон в режиме М+. Если результат получен в предыдущем сезоне, то название сезона будет указано в заголовке всплывающей подсказки."
...
L["SHOW_CLIENT_GUILD_BEST_DESC"] = "Включает отображение 5 лучших прохождений Вашей гильдии (за текущий сезон или неделю) во вкладке 'Эпохальные подземелья' в окне 'Поиск группы'."
...
L["SHOW_KEYSTONE_INFO"] = "Показывать рекомендуемый счет Raider.IO для ключей"
...
L["SHOW_MY_WARBAND_SCORE"] = "Показать мой собственный результат М+ Отрядов"
L["SHOW_MY_WARBAND_SCORE_DESC"] = "Отображает в подсказке собственные результаты M+ Отрядов."
...
L["SHOW_OTHER_WARBAND_SCORE"] = "Показать другие результаты М+ Отрядов"
L["SHOW_OTHER_WARBAND_SCORE_DESC"] = "Отображает в подсказке результаты M+ Отрядов другого игрока."
...
L["SHOW_SCORE_IN_COMBAT_DESC"] = "Отключите эту функцию, чтобы минимизировать влияние на производительность при наведении курсора на игроков во время боя."
...
L["TANK"] = "Танк"
L["TEAM_LF_MPLUS_DEFAULT"] = "Набор игроков для подземелий М+"
L["TEAM_LF_MPLUS_WITH_SCORE"] = "Набор %d+ игроков для подземелий М+"
...
L["WARBAND_BEST_SCORE_BEST_SEASON"] = "Лучший рейтинг М+ отряда (%s)"
L["WARBAND_SCORE"] = "Рейтинг отряда М+"
L["WARNING_DEBUG_MODE_ENABLE"] = "|cffFFFFFF%s|r Режим отладки включен. Вы можете отключить его, написав команду |cffFFFFFF/raiderio debug|r."
L["WARNING_LOCK_POSITION_FRAME_AUTO"] = "Raider.IO: Сначала необходимо отключить автоматическое позиционирование в профиле Raider.IO."
L["WARNING_RWF_MODE_ENABLE"] = "|cffFFFFFF%s|r Включен режим 'Гонка за первых в мире'. Вы можете отключить его, написав команду |cffFFFFFF/raiderio rwf|r."
