...
Amr.DiscBeltItemIds = Amr.Serializer.DiscBeltItemIds
Amr.DiscBeltSpellIds = Amr.Serializer.DiscBeltSpellIds
Amr.GetCachedSpell = Amr.Serializer.GetCachedSpell
Amr.AbortLoadSpells = Amr.Serializer.AbortLoadSpells
Amr.LoadSpells = Amr.Serializer.LoadSpells
...
Amr.InstanceIdsOrdered = { 2810, 2769, 2657 }
