...
L["Exclude all grey armor and weapons"] = "Исключить всю серую броню и оружие"
...
L["Exclude uncollected grey armor and weapons"] = "Исключить несобранные серые доспехи и оружие"
...
L["Exclude all grey armor and weapons"] = "Exclure toutes les armures et armes grises"
...
L["Exclude uncollected grey armor and weapons"] = "Exclure les armures et armes grises non récupérées"
...
L["If checked, grey armor and weapons that you have not collected the appearance from will not be sold.|n|nUse this setting if you plan to collect transmog appearances from grey armor and weapons."] = "Si coché, les armures et armes grises dont vous n'avez pas collecté l'apparence ne seront pas vendues.|n|nUtilisez ce paramètre si vous prévoyez de collecter des apparences de transmogrification à partir d'armures et d'armes grises."
L["If checked, grey armor and weapons will not be sold.|n|nUse this setting if you plan to sell grey armor and weapons in the auction house."] = "Si coché, les armures et armes grises ne seront pas vendues.|n|nUtilisez ce paramètre si vous envisagez de vendre des armures et armes grises dans l'hôtel des ventes."
