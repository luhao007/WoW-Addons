...
Create.PIGaddQuickBut(5,{
	Open=function()
		return PIGIsHardcore() and C_Engraving and C_Engraving.IsEngravingEnabled() and PIGA["QuickBut"]["Open"] and PIGA["QuickBut"]["Rune"]
	end,
	Icon=134419,
	fun=function(AutoRune,QuickButUI)
