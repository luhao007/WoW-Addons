...
function BusinessInfo.Admin(StatsInfo)
	...
	fujiF:HookScript("OnShow", function(self)
		...
		fujiF.gengxin_List_Hide(self.Admin_Hide.Scroll);
	end)
	function fujiF.add_uifun()
		...
		function fujiF.gengxin_List_Hide(self)
			if not fujiF:IsVisible() then return end
			for id = 1, hang_NUM, 1 do
		...
		fujiF.Admin_Hide.Scroll:SetScript("OnVerticalScroll", function(self, offset)
		    FauxScrollFrame_OnVerticalScroll(self, offset, hang_Height, fujiF.gengxin_List_Hide)
		end)
		...
		function fujiF.caozuoshuaxin(ly,name)
			...
			fujiF.gengxin_List_Hide(fujiF.Admin_Hide.Scroll);
		end
	end
end
