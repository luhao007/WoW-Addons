...
Lockit.UI_SETTING_IN_DELVE_WIDGET_DISPLAY_RULE_OPTION_CUSTOM_NAME = "Пользовательские"
Lockit.UI_SETTING_IN_DELVE_WIDGET_DISPLAY_RULE_OPTION_CUSTOM_DESCRIPTION = "Виджет можно свободно перемещать по экрану. |cnGREEN_FONT_COLOR:ПКМ|r и перетащите виджет, чтобы переместить его."
Lockit.UI_SETTING_IN_DELVE_WIDGET_LAYOUT_NAME = "Расположение кнопок"
Lockit.UI_SETTING_IN_DELVE_WIDGET_LAYOUT_TOOLTIP = "Как расположены кнопки виджета."
Lockit.UI_SETTING_IN_DELVE_WIDGET_LAYOUT_OPTION_VERTICAL_NAME = "Вертикальный макет"
...
Lockit.UI_SETTING_TOOLTIP_EXTENSION_TOOLTIP = "Отображение дополнительной информации во всплывающих подсказках (например, был ли на этой неделе получен предмет |cnIQ4:Клад участника вылазки|r)."
...
Lockit.UI_SETTING_LOGS_NAME = "Включить журналы отладки"
