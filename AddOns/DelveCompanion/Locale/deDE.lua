...
Lockit.UI_DELVE_INSTANCE_BUTTON_TOOLTIP_CLEAR_MPE = "Verwende MapPinEnhanced um den Wegpunkt zu entfernen."
...
Lockit.UI_SETTING_WAYPOINT_TRACKING_OPTION_MPE_DESCRIPTION = "verwende MapPinEnhanced Wegpunkte"
Lockit.UI_SETTING_IN_DELVE_WIDGET_CONTROL_NAME = "Widget in Tiefen"
Lockit.UI_SETTING_IN_DELVE_WIDGET_CONTROL_TOOLTIP = "Aktiviert ein Widget, welches innerhalb einer Tiefe angezeigt wird. Es stellt einen Schnellzugriff auf Items zur Verfügung, die in den Tiefen verwendet werden können."
Lockit.UI_SETTING_IN_DELVE_WIDGET_DISPLAY_RULE_NAME = "Anzeigeposition"
Lockit.UI_SETTING_IN_DELVE_WIDGET_DISPLAY_RULE_TOOLTIP = "Legt fest, wo das Widget angezeigt werden soll."
Lockit.UI_SETTING_IN_DELVE_WIDGET_DISPLAY_RULE_OPTION_LEFT_NAME = "Linke Seite"
Lockit.UI_SETTING_IN_DELVE_WIDGET_DISPLAY_RULE_OPTION_LEFT_DESCRIPTION = "Das Widgeht wird auf der linkem Seite der Zielverfolgung angezeigt."
Lockit.UI_SETTING_IN_DELVE_WIDGET_DISPLAY_RULE_OPTION_RIGHT_NAME = "Rechte Seite"
Lockit.UI_SETTING_IN_DELVE_WIDGET_DISPLAY_RULE_OPTION_RIGHT_DESCRIPTION = "Das Widgeht wird auf der rechten Seite der Zielverfolgung angezeigt."
Lockit.UI_SETTING_IN_DELVE_WIDGET_DISPLAY_RULE_OPTION_CUSTOM_NAME = "Benutzerdefiniert"
Lockit.UI_SETTING_IN_DELVE_WIDGET_DISPLAY_RULE_OPTION_CUSTOM_DESCRIPTION = "Das Widget kann frei auf dem Bildschirm bewegt werden. |cnGREEN_FONT_COLOR:Rechts-Klick|r und ziehen, um das Widget zu verschieben."
Lockit.UI_SETTING_IN_DELVE_WIDGET_LAYOUT_NAME = "Anordnung der Schaltflächen"
Lockit.UI_SETTING_IN_DELVE_WIDGET_LAYOUT_TOOLTIP = "Legt fest, wie die Schaltflächen im Widget angeordnet werden."
Lockit.UI_SETTING_IN_DELVE_WIDGET_LAYOUT_OPTION_VERTICAL_NAME = "Vertikale Anordnung"
...
Lockit.UI_SETTING_LOGS_NAME = "Debugmeldungen aktivieren"
