...
Lockit.UI_COMPARTMENT_DESCRIPTION_LEFT_CLICK = "|cnGREEN_FONT_COLOR:左键|r 打开当前赛季地下堡面板。"
...
Lockit.UI_SETTING_TOOLTIP_EXTENSION_TOOLTIP = "在提示信息中显示额外信息（例如，本周是否已获得|cnIQ4:奖赏地图|r）。"
