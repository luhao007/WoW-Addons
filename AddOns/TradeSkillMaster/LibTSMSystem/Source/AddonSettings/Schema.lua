...
function Schema.Get()
	...
	return Settings.NewSchema(133, 10)
		...
		:EnterScope("factionrealm")
			...
			:LeaveNamespace()
			:EnterNamespace("auctioningOptions")
				:If(LibTSMSystem.IsVanillaClassic() or LibTSMSystem.IsBCClassic())
					:AddTable("whitelist", {}, 133)
				:EndIf()
			:LeaveNamespace()
