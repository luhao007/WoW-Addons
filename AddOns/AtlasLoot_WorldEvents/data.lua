	...
	items = {
		{ --TrialOfStyle
			...
			[NORMAL_DIFF] = {
				...
				{ 14,  242457, [PRICE_EXTRA_ITTYPE] = "styletoken:60" }, -- Ensemble: Sepia Sweatsuit
				{ 15,  257972, [PRICE_EXTRA_ITTYPE] = "styletoken:60" }, -- Ensemble: Sorcerer's Sepia Garb
				{ 17,  202295, [PRICE_EXTRA_ITTYPE] = "styletoken:50" }, -- Anointed Crusader's Claymore
				{ 18,  190686, [PRICE_EXTRA_ITTYPE] = "styletoken:50" }, -- Anetheron's Edge
				{ 19,  202301, [PRICE_EXTRA_ITTYPE] = "styletoken:50" }, -- Focalized Mana Accelerator
				{ 20,  202300, [PRICE_EXTRA_ITTYPE] = "styletoken:50" }, -- Zealot's Prayer Staff
				{ 21,  202297, [PRICE_EXTRA_ITTYPE] = "styletoken:50" }, -- Jade Arcus
				{ 22,  202296, [PRICE_EXTRA_ITTYPE] = "styletoken:50" }, -- Deathmantle Ripper
				{ 23,  190429, [PRICE_EXTRA_ITTYPE] = "styletoken:15" }, -- Clasp of Ursine Rage
				{ 24,  190888, [PRICE_EXTRA_ITTYPE] = "styletoken:15" }, -- Embrace of the Great Dark Beyond
				{ 25,  190858, [PRICE_EXTRA_ITTYPE] = "styletoken:15" }, -- Girdle of Chilled Embers
				{ 26,  190830, [PRICE_EXTRA_ITTYPE] = "styletoken:15" }, -- Mad Thief's Boots
				{ 27,  190803, [PRICE_EXTRA_ITTYPE] = "styletoken:15" }, -- Lost Acolyte's Boots
				{ 28,  190697, [PRICE_EXTRA_ITTYPE] = "styletoken:15" }, -- Boots of a Broken World
				{ 29,  190673, [PRICE_EXTRA_ITTYPE] = "styletoken:15" }, -- Waistguard of the Infernal Eye
				{ 30,  190544, [PRICE_EXTRA_ITTYPE] = "styletoken:15" }, -- Ultramafic Girdle
				{ 101, 190202, [PRICE_EXTRA_ITTYPE] = "styletoken:15" }, -- Scoundrel's Missing Boots
				{ 102, 190167, [PRICE_EXTRA_ITTYPE] = "styletoken:15" }, -- Vault Stalker's Greaves
				{ 103, 190064, [PRICE_EXTRA_ITTYPE] = "styletoken:15" }, -- Ymirjar Berserker's Girdle
				{ 104, 189870, [PRICE_EXTRA_ITTYPE] = "styletoken:15" }, -- Arcanofire Wrap
				{ 105, 188249, [PRICE_EXTRA_ITTYPE] = "styletoken:15" }, -- Freezing Footguards
				{ 106, 188248, [PRICE_EXTRA_ITTYPE] = "styletoken:15" }, -- Searing Stompers
				{ 107, 202303, [PRICE_EXTRA_ITTYPE] = "styletoken:25" }, -- Crimson Beanie
				{ 108, 202304, [PRICE_EXTRA_ITTYPE] = "styletoken:25" }, -- Green Beanie
				{ 109, 202298, [PRICE_EXTRA_ITTYPE] = "styletoken:25" }, -- Trader's Bicorne
				{ 110, 202308, [PRICE_EXTRA_ITTYPE] = "styletoken:25" }, -- Alley Skulker's Bandana
				{ 111, 202307, [PRICE_EXTRA_ITTYPE] = "styletoken:25" }, -- Well-Worn Tricorne
				{ 112, 202306, [PRICE_EXTRA_ITTYPE] = "styletoken:25" }, -- Dread Captain's Chapeau
				{ 113, 202305, [PRICE_EXTRA_ITTYPE] = "styletoken:25" }, -- Stevedore's Skullcap
				{ 114, 213518, [PRICE_EXTRA_ITTYPE] = "styletoken:25" }, -- Classic Sepia Tabard
				{ 115, 213441, [PRICE_EXTRA_ITTYPE] = "styletoken:25" }, -- Earth Mother's Sepia Gloves
				{ 116, 210850, [PRICE_EXTRA_ITTYPE] = "styletoken:25" }, -- Trader's Sepia Sarong
				{ 117, 212626, [PRICE_EXTRA_ITTYPE] = "styletoken:25" }, -- Dueler's Sepia Shoulder Cape
				{ 118, 213433, [PRICE_EXTRA_ITTYPE] = "styletoken:25" }, -- Duelist's Ivy Doublet
				{ 119, 213437, [PRICE_EXTRA_ITTYPE] = "styletoken:25" }, -- Duelist's Marble Doublet
				{ 120, 213435, [PRICE_EXTRA_ITTYPE] = "styletoken:25" }, -- Duelist's Crimson Doublet
				{ 121, 213434, [PRICE_EXTRA_ITTYPE] = "styletoken:25" }, -- Duelist's Royal Doublet
				{ 122, 213432, [PRICE_EXTRA_ITTYPE] = "styletoken:25" }, -- Duelist's Cedar Doublet
				{ 123, 213431, [PRICE_EXTRA_ITTYPE] = "styletoken:25" }, -- Duelist's Navy Doublet
				{ 124, 213430, [PRICE_EXTRA_ITTYPE] = "styletoken:25" }, -- Duelist's Midnight Doublet
				{ 125, 188244, [PRICE_EXTRA_ITTYPE] = "styletoken:10" }, -- Virulent Gravetreaders
				{ 126, 188243, [PRICE_EXTRA_ITTYPE] = "styletoken:10" }, -- Shadow-Stitched Stalkers
				{ 127, 188237, [PRICE_EXTRA_ITTYPE] = "styletoken:7" }, -- Conjuror's Slippers
				{ 128, 188236, [PRICE_EXTRA_ITTYPE] = "styletoken:7" }, -- Patroller's Footwear
				{ 129, 151116, [PRICE_EXTRA_ITTYPE] = "styletoken:1" }, -- Fashionable Undershirt
				{ 130, 235021, [PRICE_EXTRA_ITTYPE] = "styletoken:25" }, -- Vigilante's Sepia Mask
				{ 201, 230035, [PRICE_EXTRA_ITTYPE] = "styletoken:25" }, -- Prowler's Sepia Shoulder Cape
				{ 202, 260415, [PRICE_EXTRA_ITTYPE] = "styletoken:50" }, -- Silver Chainkini
				{ 203, 233137, [PRICE_EXTRA_ITTYPE] = "styletoken:50" }, -- Long Sepia War Skirt and Leg Wraps
				{ 204, 233120, [PRICE_EXTRA_ITTYPE] = "styletoken:50" }, -- Short Sepia War Skirt and Leg Wraps
				{ 205, 233098, [PRICE_EXTRA_ITTYPE] = "styletoken:25" }, -- Long Sepia War Skirt
				{ 206, 233081, [PRICE_EXTRA_ITTYPE] = "styletoken:25" }, -- Short Sepia War Skirt
				{ 207, 233154, [PRICE_EXTRA_ITTYPE] = "styletoken:25" }, -- Banded Sepia War Wraps
				{ 208, 237242, [PRICE_EXTRA_ITTYPE] = "styletoken:15" }, -- Banded Snowy War Legwraps
				{ 209, 237253, [PRICE_EXTRA_ITTYPE] = "styletoken:15" }, -- Banded Cloudy War Legwraps
				{ 210, 237257, [PRICE_EXTRA_ITTYPE] = "styletoken:15" }, -- Banded Grassy War Legwraps
				{ 211, 237256, [PRICE_EXTRA_ITTYPE] = "styletoken:15" }, -- Banded Crimson War Legwraps
				{ 212, 237255, [PRICE_EXTRA_ITTYPE] = "styletoken:15" }, -- Banded Midnight War Legwraps
				{ 213, 237254, [PRICE_EXTRA_ITTYPE] = "styletoken:15" }, -- Banded Azure War Legwraps
				{ 214, 237252, [PRICE_EXTRA_ITTYPE] = "styletoken:15" }, -- Banded Deep War Legwraps
				{ 215, 237251, [PRICE_EXTRA_ITTYPE] = "styletoken:15" }, -- Banded Camo War Legwraps
				{ 216, 237250, [PRICE_EXTRA_ITTYPE] = "styletoken:15" }, -- Banded Brick War Legwraps
				{ 217, 237249, [PRICE_EXTRA_ITTYPE] = "styletoken:15" }, -- Banded Lively War Legwraps
				{ 218, 237248, [PRICE_EXTRA_ITTYPE] = "styletoken:15" }, -- Banded Faded War Legwraps
				{ 219, 237247, [PRICE_EXTRA_ITTYPE] = "styletoken:15" }, -- Banded Carrot War Legwraps
				{ 220, 237246, [PRICE_EXTRA_ITTYPE] = "styletoken:15" }, -- Banded Rosy War Legwraps
				{ 221, 237245, [PRICE_EXTRA_ITTYPE] = "styletoken:15" }, -- Banded Plum War Legwraps
				{ 222, 237244, [PRICE_EXTRA_ITTYPE] = "styletoken:15" }, -- Banded Violet War Legwraps
				{ 223, 237243, [PRICE_EXTRA_ITTYPE] = "styletoken:15" }, -- Banded Aquatic War Legwraps
				{ 224, 237241, [PRICE_EXTRA_ITTYPE] = "styletoken:15" }, -- Banded Sunny War Legwraps
				{ 225, 237240, [PRICE_EXTRA_ITTYPE] = "styletoken:15" }, -- Banded Sepia War Legwraps
				{ 226, 233171, [PRICE_EXTRA_ITTYPE] = "styletoken:15" }, -- Banded Sepia War Slippers
				{ 227, 252712, [PRICE_EXTRA_ITTYPE] = "styletoken:25" }, -- Sepia Winter Toque
				{ 228, 262821, [PRICE_EXTRA_ITTYPE] = "styletoken:25" }, -- Sepia Dunecloth Skirt
				{ 229, 262839, [PRICE_EXTRA_ITTYPE] = "styletoken:15" }, -- Sepia Dunecloth Belt
				{ 230, 262857, [PRICE_EXTRA_ITTYPE] = "styletoken:25" }, -- Sepia Dunecloth Vest
				{ 301, 156863, [PRICE_EXTRA_ITTYPE] = "styletoken:50" }, -- Trial of Style Spotlight
				{ 302, 156864, [PRICE_EXTRA_ITTYPE] = "styletoken:50" }, -- Trial of Style Flames
				{ 303, 156862, [PRICE_EXTRA_ITTYPE] = "styletoken:100" }, -- Trial of Style Dance Floor
				{ 304, 164378, [PRICE_EXTRA_ITTYPE] = "styletoken:100" }, -- Letter from an Admirer
			},
		},
	}
}
