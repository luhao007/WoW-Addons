...
V =
    ...
    or C == "esMX" and { -- 17/21 (80%)
      ...
      "Completada hace %s", z, "Termina en:", "Gran éxito", z, "Misión Fallida", "Historial de Misión", "Éxito de Misión", "No hay grupos adecuados", "Los resultados de las misiones completadas serán grabadas y mostradas aquí.",
      z,
    }
    or C == "frFR" and { -- 20/21 (95%)
      ...
      "Terminé il y a %s", z, "Expire dans:", "Grandiose Succès", "En Groupe:", "Mission Échouée", "Historique des Missions", "Mission Accomplie", "Aucun groupe adapté.", "L'historique des précédentes missions terminées sera enregistré et affiché ici.",
      "Envoyer en mission",
    }
    or C == "itIT" and { -- 20/21 (95%)
      ...
      "Completato %s fa", z, "Scade tra:", "Grande successo", "Nel gruppo provvisorio:", "Fallimento della missione", "Storia della missione", "Missione compiuta", "Nessun gruppo fattibile.", "I risultati delle missioni completate verranno registrati e visualizzati qui.",
      "Invia i gruppi provvisori",
    }
    or C == "koKR" and { -- 20/21 (95%)
      ...
      "%s 전 완료됨", z, "만료:", "위대한 성공", "임시 그룹", "임무 실패", "임무 기록", "임무 성공", "생존 가능 그룹 없음", "완료한 임무 결과를 이곳에서 확인 가능",
      "임시 그룹 보내기",
    }
    or C == "ruRU" and { -- 21/21 (100%)
      ...
      "Завершено %s назад", "Давно завершено", "Заканчивается через", "Грандиозный  успех", "В пробной группе:", "Миссия провалена", "История миссий", "Миссия  выполнена", "Нет возможных групп", "Результаты выполненных миссий будут записаны и отображены здесь.",
      "Отправить пробные группы",
    }
    or C == "zhCN" and { -- 21/21 (100%)
      "%d |4任务:任务; 可派遣", "%d |4任务:任务; 已完成", "%d |4任务:任务; 进行中", "%d |4任务:任务; 持续中...", "%d |4队伍:队伍; 持续中...", "花费：%s", "额外拾取", "清除所有预设队列", "点击完成", "一键完成",
      "%s 前", "早就完成啦", "有效期：", "大获全胜", "预设队列中：", "任务失败", "任务记录", "任务完成", "暂无可用队列", "这里显示已完成的任务记录。",
      "分配预设队列",
    }
    or C == "zhTW" and { -- 20/21 (95%)
      "%d |4任務:任務; 可用", "%d |4任務:任務; 完成", "%d |4任務:任務; 進行中", "%d |4任務:任務; 剩餘...", "%d |4隊伍:隊伍; 剩餘...", "基本任務花費: %s", "額外擲骰獎勵", "清除所有隊伍分派", "點擊以完成", "完成全部",
      "已在 %s 前完成", z, "過期於:", "大獲全勝", "在分派隊伍中:", "任務失敗", "任務歷史紀錄", "任務成功", "沒有可行的隊伍。", "已完成任務的結果將被記錄並顯示在此處。",
      "派發分配隊伍",
    } or nil
...
K = V and {
      ...
      "Completed %s ago", "Completed long ago", "Expires in:", "Grand Success", "In Tentative Group:", "Mission Failure", "Mission History", "Mission Success", "No viable groups.", "Results of completed missions will be recorded and displayed here.",
